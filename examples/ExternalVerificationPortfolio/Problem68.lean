...
endpoint of Erdős #68.  Neither coordinate proves the required cofinal input:
finite strict-factorial-top misses or finite nonunit-carry computations do not
establish either universally quantified right-hand side below.
