...
Build-output sharing is restricted to the Lean modules in the receipt's keyed
source closure. A focused success does not validate the worker's entire
`.lake/build` directory. Publication and hydration both enforce that scope,
