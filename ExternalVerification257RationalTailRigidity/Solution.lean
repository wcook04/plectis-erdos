...
theorem supportCoeffZeroWindow_length_le_eps_logb_add
  ...
  simpa [SupportCoeffZeroWindow, CoeffZeroWindow, supportCoeff,
    erdosSupportSeries,
    Erdos249257.SupportCoeffZeroWindow,
    Erdos249257.CoeffZeroWindow,
    Erdos249257.supportCoeff,
    Erdos249257.erdosSupportSeries] using
      Erdos249257.supportCoeffZeroWindow_length_le_eps_logb_add
        A hA p c v hv (by
          simpa [erdosSupportSeries,
            Erdos249257.erdosSupportSeries] using hvalue) ε hε
...
theorem one_div_oddOrder_le_reciprocalMass_of_support_fraction
  ...
  simpa [reciprocalSupportTerm, reciprocalMass, oddDoublingOrder,
    erdosSupportSeries,
    Erdos249257.reciprocalSupportTerm,
    Erdos249257.reciprocalMass,
    Erdos249257.oddDoublingOrder,
    Erdos249257.erdosSupportSeries] using
      Erdos249257.one_div_oddOrder_le_reciprocalMass_of_support_fraction
        A hA (by
          simpa [reciprocalSupportTerm,
            Erdos249257.reciprocalSupportTerm] using hsum)
        p c hv hvodd hpv (by
          simpa [erdosSupportSeries,
            Erdos249257.erdosSupportSeries] using hvalue)
...
theorem dyadic_support_fraction_reciprocalMass_diverges_or_gt_one
  ...
  simpa [reciprocalSupportTerm, reciprocalMass, erdosSupportSeries,
    ...
    Erdos249257.reciprocalMass,
    Erdos249257.erdosSupportSeries] using
      Erdos249257.dyadic_support_fraction_reciprocalMass_diverges_or_gt_one
        A hAinf p c (by
          simpa [erdosSupportSeries,
            Erdos249257.erdosSupportSeries] using hvalue)
