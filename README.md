...
| **verified finite instance** | Lean checks a diagonal certificate at every `t ≤ 82`. This finite band does not prove successful cases beyond every fixed cutoff. |
...
|---|---:|
| Lean modules | 653 |
| Formal results and supporting lemmas | 11,784 |
