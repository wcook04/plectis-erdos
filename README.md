...
Prime-specific producer open. #251 gives unbounded prime gaps and an exact
...
- [**#251: prime-gap dyadic tails**](erdos-251-prime-gap-dyadic-series.pdf) — [tail/classifier](ErdosProblems/Erdos251/PrimeGapDyadicTail.lean): cofinal nonintegral-shift equivalence; rationality iff one positive shift is eventually integral; [coefficient no-go](ExternalVerification/Challenge.lean#L309): finite carry identity coexists with nonperiodic synthetic coefficients and actual prime gaps; coefficient nonperiodicity alone is no irrationality proof. No infinite limit, stream identification, or prime-specific producer; #251 open.
