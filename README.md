...
- [**#257: reciprocal Mersenne subseries**](erdos-257-mersenne-support-subseries.pdf) — [tails](Erdos249257/RationalSupportCarrySkeleton.lean): positive/recursive; [two-adic band](Erdos249257/HalfGreedyTwoThirdsBand.lean) excludes odd 1,3,5 (sharp at 7); [composite dilation](Erdos249257/CompositeDilationDefect.lean): foreign budget zero for prime support; arbitrary defects lack bounds/selector; [pairwise-coprime](Erdos249257/CertificateKernel.lean): adaptive CRT gives irrationality for infinite pairwise-coprime `A` with summable reciprocal mass; [positive-skip](ExternalVerification/Challenge.lean#L438) would give `1/2` from unproved cofinal skips; [seam iff](ExternalVerification/Challenge.lean#L443) has no witness. Universal #257 remains open.
- [**#269: three-prime running lcms**](erdos-269-three-prime-running-lcm.pdf) — [weighted-phase consumer](ExternalVerification/Challenge.lean#L484) exposes a carry as finite residue plus uncontrolled integral coboundary under `B>0` and the displayed recurrence (source [WeightedPhaseCarry](ErdosProblems/Erdos269/WeightedPhaseCarry.lean#L109)); finite realised span needs explicit finite-dimensional factorisation. No finite-state quotient or irrationality follows; open.
