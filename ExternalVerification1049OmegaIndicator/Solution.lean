...
theorem omegaWeight_indicator (x : ℝ) (hx0 : 0 ≤ x) (hx1 : x < 1) :
  ...
  have h := ErdosProblems.Erdos1049.PaperR7.omega_indicator x hx0 hx1
  simpa [omegaWeight, InOmegaSupport,
    ErdosProblems.Erdos1049.PaperR7.omegaWeight,
    ErdosProblems.Erdos1049.PaperR7.InOmegaSupport] using h
