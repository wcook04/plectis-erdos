#!/usr/bin/env python3
"""Exact replay and packet checks for the 2026-08-26 #1041 coevolution octuple."""
...
OUT_ROOT = Path("/Users/willcook/Downloads/erdos1041_frontier_coevolution_octuple_20260826")
...
def main() -> int:
    ...
    result = {
        "schema": "erdos1041_frontier_coevolution_octuple_check_v1",
        "status": "pass",
    ...
    if args.json:
        ...
        print("PASS: eight governed packet manifests and source combinations")
        if args.require_built:
            print("PASS: eight flat built packet folders at declared file ceilings")
    return 0
