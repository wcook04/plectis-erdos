#!/usr/bin/env python3
"""Exact replay and lineage checks for the 2026-08-26 #1041 successor nonet."""
...
PACKET_DIR = ROOT / "docs/formal_math/type_b_packets/erdos1041_frontier_coevolution_nonet_2026_08_26"
OUT_ROOT = Path("/Users/willcook/Downloads/erdos1041_frontier_coevolution_nonet_20260826")
PREDECESSOR_DIR = ROOT / "docs/formal_math/type_b_packets/erdos1041_frontier_coevolution_octuple_2026_08_26"
RETURN_INTAKE = ROOT / "state/formal_math/type_b_return_batches/erdos1041_20260826_return_stream_01/intake.json"
PREDECESSOR_PORTFOLIO_SHA256 = "18f257bb59a57ee04d3f02478939efa98179ab1e5e171e6663597306f08f8138"
PREDECESSOR_VALIDATION_SHA256 = "980d53668cca61f728f9e9cc78b29056ea62f85f407432a5b15431fb5f4b1d7c"
...
def check_lineage() -> dict[str, object]:
    ...
    return {
        "lifecycle": "new_successor_after_dispatched_predecessor",
        "operator_confirmed_predecessor_dispatched": True,
        "sha256": checked,
    }
...
def check_manifests(require_built: bool) -> dict[str, object]:
    ...
    for path in manifests:
        ...
        assert lineage["lifecycle"] == "new_successor_after_dispatched_predecessor"
        assert lineage["operator_confirmed_predecessor_dispatched"] is True
...
def main() -> int:
    ...
    result = {
        "schema": "erdos1041_frontier_coevolution_nonet_check_v1",
        "status": "pass",
