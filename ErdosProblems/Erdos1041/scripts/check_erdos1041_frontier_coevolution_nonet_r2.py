#!/usr/bin/env python3
"""Exact replay and lineage checks for the #1041 successor nonet revision 2."""
...
PACKET_DIR = ROOT / "docs/formal_math/type_b_packets/erdos1041_frontier_coevolution_nonet_r2_2026_08_26"
OUT_ROOT = Path("/Users/willcook/Downloads/erdos1041_frontier_coevolution_nonet_r2_20260826")
PREDECESSOR_DIR = ROOT / "docs/formal_math/type_b_packets/erdos1041_frontier_coevolution_nonet_2026_08_26"
RETURN_INTAKE = ROOT / "state/formal_math/type_b_return_batches/erdos1041_20260826_return_stream_01/intake.json"
PREDECESSOR_PORTFOLIO_SHA256 = "1837f9cb220819d2f8bb2074288b00c5627cb1d8b791849be66606545cd0a859"
...
def main() -> int:
    ...
    result = {
        "schema": "erdos1041_frontier_coevolution_nonet_r2_check_v1",
        "status": "pass",
