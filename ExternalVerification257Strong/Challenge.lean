...
/-! Self-contained trusted challenge vocabulary for the stronger #257 support
and repair results. Only the three theorem declarations below have intentional holes. -/
