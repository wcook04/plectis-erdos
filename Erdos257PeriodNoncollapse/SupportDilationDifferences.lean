...
namespace Erdos257PeriodNoncollapse.SupportDilationDifferences
...
def supportTwoThree : Set ℕ := Erdos257PeriodNoncollapse.support23

theorem dilationDifference_supportTwoThree_fixture :
    dilationDifference 2 (supportCoeffInt supportTwoThree) 3 = 1 := by
  change (supportCoeff Erdos257PeriodNoncollapse.support23 6 : ℤ) -
    supportCoeff Erdos257PeriodNoncollapse.support23 3 = 1
  rw [Erdos257PeriodNoncollapse.supportCoeff_support23_eq_residue
      (n := 6) (by norm_num),
    Erdos257PeriodNoncollapse.supportCoeff_support23_eq_residue
      (n := 3) (by norm_num)]
  norm_num [Erdos257PeriodNoncollapse.supportCoeff23Residue]
...
end Erdos257PeriodNoncollapse.SupportDilationDifferences
