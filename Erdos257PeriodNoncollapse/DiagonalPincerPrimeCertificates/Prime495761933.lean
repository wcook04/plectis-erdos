...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime123940483
...
theorem prime_lucas_495761933 : Nat.Prime 495761933 := by
  have hfermat : (2 : ZMod 495761933) ^ (495761933 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (2 : ZMod 495761933) ^ ((495761933 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (2 : ZMod 495761933) ^ ((495761933 - 1) / 123940483) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
