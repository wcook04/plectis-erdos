...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime262886497
...
theorem prime_lucas_1577318983 : Nat.Prime 1577318983 := by
  have hfermat : (3 : ZMod 1577318983) ^ (1577318983 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (3 : ZMod 1577318983) ^ ((1577318983 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (3 : ZMod 1577318983) ^ ((1577318983 - 1) / 3) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_2 : (3 : ZMod 1577318983) ^ ((1577318983 - 1) / 262886497) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
