...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime120872598173
...
theorem prime_lucas_241745196347 : Nat.Prime 241745196347 := by
  have hfermat : (2 : ZMod 241745196347) ^ (241745196347 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (2 : ZMod 241745196347) ^ ((241745196347 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (2 : ZMod 241745196347) ^ ((241745196347 - 1) / 120872598173) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
