...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime16731745181
...
theorem prime_lucas_33463490363 : Nat.Prime 33463490363 := by
  have hfermat : (2 : ZMod 33463490363) ^ (33463490363 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (2 : ZMod 33463490363) ^ ((33463490363 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (2 : ZMod 33463490363) ^ ((33463490363 - 1) / 16731745181) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
