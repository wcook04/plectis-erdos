...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime3376178933
...
theorem prime_lucas_6752357867 : Nat.Prime 6752357867 := by
  have hfermat : (2 : ZMod 6752357867) ^ (6752357867 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (2 : ZMod 6752357867) ^ ((6752357867 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (2 : ZMod 6752357867) ^ ((6752357867 - 1) / 3376178933) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
