...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime382775276171
...
theorem prime_lucas_3062202209369 : Nat.Prime 3062202209369 := by
  have hfermat : (3 : ZMod 3062202209369) ^ (3062202209369 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (3 : ZMod 3062202209369) ^ ((3062202209369 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (3 : ZMod 3062202209369) ^ ((3062202209369 - 1) / 382775276171) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
