...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime126278983
...
theorem prime_lucas_3030695593 : Nat.Prime 3030695593 := by
  have hfermat : (5 : ZMod 3030695593) ^ (3030695593 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (5 : ZMod 3030695593) ^ ((3030695593 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (5 : ZMod 3030695593) ^ ((3030695593 - 1) / 3) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_2 : (5 : ZMod 3030695593) ^ ((3030695593 - 1) / 126278983) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
