...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime271504657
...
theorem prime_lucas_48327828947 : Nat.Prime 48327828947 := by
  have hfermat : (2 : ZMod 48327828947) ^ (48327828947 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (2 : ZMod 48327828947) ^ ((48327828947 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (2 : ZMod 48327828947) ^ ((48327828947 - 1) / 89) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_2 : (2 : ZMod 48327828947) ^ ((48327828947 - 1) / 271504657) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
