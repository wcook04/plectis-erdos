...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime30218149543
...
theorem prime_lucas_120872598173 : Nat.Prime 120872598173 := by
  have hfermat : (2 : ZMod 120872598173) ^ (120872598173 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (2 : ZMod 120872598173) ^ ((120872598173 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (2 : ZMod 120872598173) ^ ((120872598173 - 1) / 30218149543) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
