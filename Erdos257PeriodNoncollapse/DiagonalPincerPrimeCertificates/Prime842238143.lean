...
import Erdos257PeriodNoncollapse.DiagonalPincerPrimeCertificates.Prime421119071
...
theorem prime_lucas_842238143 : Nat.Prime 842238143 := by
  have hfermat : (5 : ZMod 842238143) ^ (842238143 - 1) = 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_eq_one_iff]
    decide +kernel
  have hfactor_0 : (5 : ZMod 842238143) ^ ((842238143 - 1) / 2) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
  have hfactor_1 : (5 : ZMod 842238143) ^ ((842238143 - 1) / 421119071) ≠ 1 := by
    rw [← binaryPow_eq_pow, binaryPow_zmod, natCast_zmod_ne_one_iff]
    decide +kernel
