...
namespace Erdos257PeriodNoncollapse.SuffixCylinderTwoSheet
...
theorem hasSuffixCylinderAt_take
  ...
  refine ⟨pfx, ?_⟩
  intro k hk hkS
  simpa [Erdos257PeriodNoncollapse.SuffixCylinderTwoSheet.SelectedHalfWindow.take]
...
end Erdos257PeriodNoncollapse.SuffixCylinderTwoSheet
