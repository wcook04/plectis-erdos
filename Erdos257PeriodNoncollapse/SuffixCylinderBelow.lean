...
namespace Erdos257PeriodNoncollapse.SuffixCylinderBelow
...
theorem SelectedHalfWindow.word_stepTailExplicit
    ...
    (hcoeff : ∀ k (hk : 1 ≤ k) (hkR : k ≤ R), δ < k →
      supportCoeff (wordSupport (W.word k hk hkR)) (N + 1) = C)
    (q : ℕ) (hq : 1 ≤ q) (hqS : q ≤ S) :
    (Erdos257PeriodNoncollapse.SuffixCylinderBelow.SelectedHalfWindow.stepTailExplicit
...
noncomputable def CylinderStage.feedbackAdvanceCrossingBelow
  ...
  have hcyl' : HasSuffixCylinderAt W'
    ...
    constructor
    · rw [Erdos257PeriodNoncollapse.SuffixCylinderBelow.SelectedHalfWindow.word_stepTailExplicit]
...
end Erdos257PeriodNoncollapse.SuffixCylinderBelow
