...
namespace Erdos257PeriodNoncollapse.HalfDivisorUnitDrop
...
theorem supportCoeff_extend_true_eq_false_add_one_at_double
  ...
  simp only [if_true]
  apply Erdos257PeriodNoncollapse.HalfCylinderFiniteShadow.supportCoeff_insert_divisor
...
end Erdos257PeriodNoncollapse.HalfDivisorUnitDrop
