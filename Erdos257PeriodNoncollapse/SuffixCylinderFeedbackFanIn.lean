...
import Erdos257PeriodNoncollapse.SuffixCylinderBelow

/-!
# Exact feedback fan-in: advance or one certified in-strip hole
-/

namespace Erdos257PeriodNoncollapse.SuffixCylinderFeedbackFanIn
...
theorem CylinderStage.feedbackAdvance_or_protectedSeam_inStrip
  ...
  · left
    exact ⟨(Erdos257PeriodNoncollapse.SuffixCylinderGlobalProducer.CylinderStage.promoteLow
...
end Erdos257PeriodNoncollapse.SuffixCylinderFeedbackFanIn
