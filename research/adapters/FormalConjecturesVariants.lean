...
(Erdős 1968 stated this all-base form and printed only the pairwise-coprime
case; the proof authority is `Erdos249257.irrational_erdosSupportSeries_of_summable_reciprocal`). -/
