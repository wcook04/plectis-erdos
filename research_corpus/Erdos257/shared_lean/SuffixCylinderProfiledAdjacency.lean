import Erdos257PeriodNoncollapse.SuffixCylinderProfiledGap
...
open Erdos257PeriodNoncollapse.FixedCoeffRewindPhase
...
namespace Erdos257PeriodNoncollapse.SuffixCylinderProfiledAdjacency
...
theorem supportCoeff_wordSupport_extendHalfWord_eq
  ...
  | true =>
      ...
      simp only [if_true]
      exact
        Erdos257PeriodNoncollapse.HalfCylinderIntegerGreedy.supportCoeff_insert_eq_add_indicator
          (wordSupport w) hnew
...
end Erdos257PeriodNoncollapse.SuffixCylinderProfiledAdjacency
