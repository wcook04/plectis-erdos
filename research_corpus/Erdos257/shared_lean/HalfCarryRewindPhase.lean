...
namespace Erdos257PeriodNoncollapse.FixedCoeffRewindPhase
...
theorem supportCoeff_eq_prefix_add_currentBit
  ...
  rw [hcoeff]
  split_ifs with hnA
  · exact Erdos257PeriodNoncollapse.HalfCylinderFiniteShadow.supportCoeff_insert_self
      P hnpos hnP
  · rfl
...
end Erdos257PeriodNoncollapse.FixedCoeffRewindPhase
