# Erdős #257 research corpus (source-current snapshot)
...
- `problem/`: `ErdosProblems/Erdos257/` (research_packet.json is the non-claims ledger: target, exact results, negative results, open producers, claim ceiling)
...
Erdos Problem #257. This corpus is published for cross-problem reachback; the fleet has no desk launching from it. See problem/research_packet.json for the target statement and the frontier.
