...
```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_dyadic_windows.py \
  ...
  --assert-packet \
  --output source-provenance://private-authoring-project/receipts/erdos269_dyadic_window_receipt.json
```
...
`source-provenance://private-authoring-project/receipts/erdos269_residue_delay_five_nogo_receipt.json`.
...
```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_affine_cylinders.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_affine_cylinders.py --check
```

The output is
`source-provenance://private-authoring-project/receipts/erdos269_affine_cylinder_depth_receipt.json`.
...
`source-provenance://private-authoring-project/receipts/erdos269_farey_band_receipt.json`;
generate or replay it with

```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_farey_band.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_farey_band.py --check
```
...
```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_block_mass_identity.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_block_mass_identity.py --check
```
...
```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_ordered_tail_recurrence.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_ordered_tail_recurrence.py --check
```
...
```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_integral_tail_escape.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_integral_tail_escape.py --check
```
...
```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_projective_window_pair.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_projective_window_pair.py --check
```
...
```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_projective_quotient_scan.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_projective_quotient_scan.py --check
```
...
```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_integral_branch.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_integral_branch.py --check
```
...
```bash
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_two_adic_rigidity.py --check
```
