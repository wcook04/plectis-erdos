...
```sh
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_integral_tail_gap_descent.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_integral_tail_gap_descent.py --check
```
