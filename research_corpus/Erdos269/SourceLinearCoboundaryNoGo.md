...
```sh
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_source_linear_coboundary.py
./repo-python source-provenance://private-authoring-project/scripts/check_erdos269_source_linear_coboundary.py --check
```
