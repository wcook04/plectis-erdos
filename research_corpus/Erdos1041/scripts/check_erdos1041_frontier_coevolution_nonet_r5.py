#!/usr/bin/env python3
"""Exact replay and lineage checks for the #1041 successor nonet revision 5."""
...
PREDECESSOR_VALIDATION_SHA256 = "119cedac41544a2ecff90992f1fe24b888d5ef1d1bf0955f80bd75f2d7ad8f2f"
...
def check_manifests(require_built: bool) -> dict[str, object]:
    ...
    for path in manifests:
        ...
        if packet_id in {
            ...
            assert "attachment age" in ask_text.lower()
            assert "lifetime" in ask_text.lower()
...
def main() -> int:
    ...
    result = {
        "schema": "erdos1041_frontier_coevolution_nonet_r5_check_v1",
        "status": "pass",
