...
```sh
python3 research_corpus/Erdos1041/scripts/blaschke_power/check_degree8.py
python3 research_corpus/Erdos1041/scripts/blaschke_power/check_high_critical.py
```
