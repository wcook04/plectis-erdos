...
```sh
python3 research_corpus/Erdos1041/scripts/check_erdos1041_low_critical_potential_closure.py --quick
python3 research_corpus/Erdos1041/scripts/check_erdos1041_low_critical_potential_closure.py
```
