...
```sh
python3 research_corpus/Erdos1041/scripts/check_erdos1041_r2_revision_exact_cores.py
cd source-provenance://private-authoring-project && \
  lake env lean research_corpus/Erdos1041/RevisionR2ExactCores.lean
```
