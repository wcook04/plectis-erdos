...
```sh
python3 research_corpus/Erdos1041/scripts/check_erdos1041_polygonal_shortening.py
python3 research_corpus/Erdos1041/scripts/check_erdos1041_pinned_witness_hub_connectors.py
```
