...
Erdős Problem 1041 at source checkpoint `7f2f99c17885e17e23017e4c86d7c034842b107d`. The unrestricted
...
Start with [`STRONGEST_RESULTS.json`](STRONGEST_RESULTS.json). It states the
strongest activated premises and falsifiers, what weaker work they dominate,
their exact hypotheses, their consumers, and their public file locations.
Then use [`CORPUS_MANIFEST.json`](CORPUS_MANIFEST.json) for every published
file and its digest. Route choice is deliberately unrestricted: the map is a
premise floor, not a prescribed proof strategy.
