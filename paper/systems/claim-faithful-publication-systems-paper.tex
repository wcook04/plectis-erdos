...
\newcommand{\repolink}[2]{\href{\repobase/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/#1}{\texttt{#2}}}
...
14 September 2026, the author had not recorded a completed external cold-clone use
or an accepted external contribution.
The 257 lane formalises the classical full-support irrationality theorem, but
not the arbitrary-support question. The degree-seven example due to
\texttt{ani} refutes the total-variation formulation of 1041; correspondence
with the historical curve-length question remains unreviewed. For the other
seven programmes, it does not claim a solution to any of them.
\end{abstract}
...
certificate for Erd\H{o}s Problem 249.  \textbf{Ceiling.} The 1041
...
the formalised classical full-support irrationality theorem, for every integer
base at least two, from the stronger arbitrary-support statement that remains
open. The cross-problem synthesis gives an exact rejection of $189/388$ at the
seventeenth step of a Mersenne greedy test. This disproves a proposed stopping
extrapolation, but finite survival still does not prove membership. Problem 68
has an exact carry-based equivalence
