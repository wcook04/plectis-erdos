...
and its match with the 1958 wording awaits independent review, so the claim
registry keeps all eight original problems open. The system leaves novelty and
significance to experts.
\end{paperresult}
...
All eight problems remain open in the claim registry, and for Problem 1041 the
match between the refuted formal statement and the 1958 wording awaits
independent review. The system records evidence classes and review events;
