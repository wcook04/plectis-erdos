...
2026) and the two designs were developed independently. Prove2Me is the
published reference for statement--proof separation, audited cores, and
read-back auditing as hosted platform mechanisms, and this paper claims no
priority over it. The designs differ in scope. Prove2Me verifies submissions
centrally and its reported completed missions formalise proofs that already
exist. The corpus here is a clone with no service behind it, its endpoints are
open problems, and its records carry failed routes, obstruction theorems, and
claim ceilings alongside proved statements.
