...
Feng et al.\ ran a research agent built on Gemini Deep Think over 700 open
...
Those findings predate this paper and are the empirical case for the
separation it implements.
...
value. Feng et al.\ state the authorship rule directly: mathematics papers
should be authored by humans even when the generated content is correct,
because authorship carries accountability for validity and attribution
\cite{aletheia}. The provenance note on the first page follows that rule. The
...
their results. The paper claims no priority over their taxonomy and reports
no comparison of the two review processes.
