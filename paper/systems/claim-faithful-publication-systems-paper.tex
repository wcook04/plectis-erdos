...
\cite{aletheia,autonomousmath}. The provenance note on the first page follows that rule. The
...
\cite{autonomousmath}. These are baselines for proof interaction,
...
experiments, sources, and failed routes, and its Lean layer is empty. Tao's
