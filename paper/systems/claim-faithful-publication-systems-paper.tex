...
Problem-sized worlds join formal declarations, experiments, sources, failed
mechanisms, and open obligations. Separate graphs record formal dependencies,
mathematical meaning, and public claims. A compiled entry packet states the
endpoint, claim ceiling, omissions, and context-budget overflow. The implemented
architecture connects scoped research changes, checks, and reviewed public
wording without transferring authority between them. The related-work section
compares it with neighbouring systems along stated dimensions and claims no
priority.

Computation supplies finite evidence; Lean verifies that a proof establishes
the formal statement written in the source;
Comparator checks selected propositions and their axiom boundary. These checks
do not establish intended meaning, novelty, importance or external acceptance.

The public Lean repository contains papers, claims, navigation, and release
checks that a fresh clone can inspect. Problem 257 has a Lean-checked
...
papers, and release machinery around eight Erd\H{o}s problem programmes. The
degree-seven counterexample due to
\href{https://www.erdosproblems.com/forum/thread/1041\#post-8861}{\texttt{ani}}
is formalised in Lean here and refutes the Formal Conjectures 1041
Hausdorff path-image claim. Its relation to the 1958 question has not had
independent human review; the other seven target problems remain unresolved here. The repository also contains
intermediate theorems, exact reformulations, conditional reductions, finite
certificates, and no-go results. Private development explains the provenance;
public claims rely only on the published evidence.
