...
\newcommand{\SemanticAuthoredTheoremLike}{150,924}
\newcommand{\SemanticAuthoredInterpreted}{139,818}
\newcommand{\SemanticDirectEvidence}{3,330}
\newcommand{\SemanticContextual}{136,488}
\newcommand{\SemanticStructuralOnly}{11,106}
\newcommand{\SemanticAuthoredPercent}{92.6}
...
The degree-seven example due to \texttt{ani} refutes the total-variation
formulation of 1041; its correspondence with the historical curve-length
question remains unreviewed. The other programmes are not claimed solved.
...
certificate for Problem 249.  \textbf{Ceiling.} The 1041
total-variation formulation is refuted, but its historical correspondence
...
is formalised in Lean here and refutes the total-variation formulation of
Problem 1041. Its correspondence with the historical curve-length question has not had
...
total-variation counterexample as formalised here and leaves historical
