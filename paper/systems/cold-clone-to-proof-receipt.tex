...
that card sit a bounded tour card, a mathematical map of ten programmes, a
...
source links before Lean is built.  Accepted proof probes are issued by the
pinned Lean process and can be replayed byte for byte.  \textbf{Evidence.}
...
problem programmes. The claim registry now covers selected statements from
all eight; a paper's inclusion does not give every statement in it formal
...
pinned Lean process alone supplies probe verdicts. The comparison does not show
that the resulting record improves the agent's research choices.
