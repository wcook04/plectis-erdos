...
\newcommand{\SemanticAuthoredTheoremLike}{150,850}
\newcommand{\SemanticAuthoredInterpreted}{139,818}
\newcommand{\SemanticDirectEvidence}{3,330}
\newcommand{\SemanticContextual}{136,488}
\newcommand{\SemanticStructuralOnly}{11,032}
\newcommand{\SemanticAuthoredPercent}{92.7}
...
formalised in Lean in this repository, refutes the
total-variation formulation of Problem 1041, while correspondence with its
