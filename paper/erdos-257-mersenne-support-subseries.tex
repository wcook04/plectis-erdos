...
to the value, the achievement-set geometry, and the exact status of the
candidate $1/2$: membership would refute \#257, while non-membership would
eliminate only this one candidate.
\end{abstract}
