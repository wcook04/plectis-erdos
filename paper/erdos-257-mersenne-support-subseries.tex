...
\renewcommand{\commit}{e52e55c5db4d2ca965be45f007d25d0586ad4a0e}
\renewcommand{\commitshort}{e52e55c5db4d}
\hypersetup{
...
\item \textbf{Membership of $1/21$ in $\Ach$.}
  Theorem~\ref{res:one-over-twenty-one} proves that the proposed
  rank-$\ge2$ representation cannot terminate.  The primitive
  $2p+3q$ cone has complete eventual rank coverage but recurrent
  multiplicities; no Booleanisation or achievement-set membership theorem is
  known.
\end{enumerate}
