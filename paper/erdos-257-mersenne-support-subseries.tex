...
over every infinite support rather than over $\Npos$.  For every nonnegative
rational target, membership is exactly cofinal actual skipping by its canonical
greedy orbit
(\lword{Erdos257/MersenneSubseriesRigidity.lean}{16}{rat_mem_mersenneAchievementSet_iff_cofinal_greedy_skips}{checked}).
For a set $J$ of future offsets write
$T_J(n)=\sum_{k\in J}\wgt{n+k+1}$ for the tail restricted to $J$
(\lword{Erdos257/MersenneSubseriesRigidity.lean}{31}{selectedMersenneTail}{definition},
summable at
\lword{Erdos257/MersenneSubseriesRigidity.lean}{35}{summable_selectedMersenneTail}{Lean}).
Then $T_J(n)<\wgt n$ for every $J$ and every $n\ge1$
(\lword{Erdos257/MersenneSubseriesRigidity.lean}{41}{selectedMersenneTail_lt_weight}{checked}),
...
supported in $J$
(\lword{Erdos257/MersenneSubseriesRigidity.lean}{65}{supportedMersenneDigitValue_injective}{checked}),
stated on the subtype of
\lword{Erdos257/MersenneSubseriesRigidity.lean}{56}{SupportedMersenneDigits}{digit strings vanishing off $J$}
and evaluated by the
\lword{Erdos257/MersenneSubseriesRigidity.lean}{60}{supportedMersenneDigitValue}{restricted digit map},
...
\lword{Erdos257/MersenneSubseriesRigidity.lean}{74}{supportedMersenneDigitSet}{supported digit set},
which is
\lword{Erdos257/MersenneSubseriesRigidity.lean}{77}{isClosed_supportedMersenneDigitSet}{closed}.
Its range is the
\lword{Erdos257/MersenneSubseriesRigidity.lean}{87}{supportedMersenneAchievementSet}{restricted achievement set};
the range and image descriptions agree by
\lword{Erdos257/MersenneSubseriesRigidity.lean}{90}{supportedMersenneAchievementSet_eq_image}{the image theorem}.
Consequently $\Ach_J$ is
\lword{Erdos257/MersenneSubseriesRigidity.lean}{101}{isCompact_supportedMersenneAchievementSet}{compact}
and
\lword{Erdos257/MersenneSubseriesRigidity.lean}{107}{isClosed_supportedMersenneAchievementSet}{closed}.
It lies inside $\Ach$ by
\lword{Erdos257/MersenneSubseriesRigidity.lean}{114}{supportedMersenneAchievementSet_subset}{support restriction}
and is therefore
\lword{Erdos257/MersenneSubseriesRigidity.lean}{123}{isNowhereDense_supportedMersenneAchievementSet}{nowhere dense}.
If $J$ is infinite, the digit space is
\lword{Erdos257/MersenneSubseriesRigidity.lean}{131}{preperfect_supportedMersenneDigitSet}{preperfect};
injectivity transfers that property to
\lword{Erdos257/MersenneSubseriesRigidity.lean}{161}{preperfect_supportedMersenneAchievementSet}{$\Ach_J$},
so the closed set is
\lword{Erdos257/MersenneSubseriesRigidity.lean}{178}{perfect_supportedMersenneAchievementSet}{perfect}.
...
\lword{Erdos257/MersenneSubseriesRigidity.lean}{186}{summable_mersenneDigitTerm}{controls digit terms},
and changing one coordinate changes the value by precisely its signed weight
by
\lword{Erdos257/MersenneSubseriesRigidity.lean}{193}{positiveMersenneDigitValue_update}{the update formula}.
If $k\notin J$, allowing $k$ splits the new set into $\Ach_J$ and its translate
by $\wgt{k+1}$
\lword{Erdos257/MersenneSubseriesRigidity.lean}{214}{supportedMersenneAchievementSet_insert}{exactly}.
The two pieces are
\lword{Erdos257/MersenneSubseriesRigidity.lean}{273}{disjoint_supportedMersenneAchievementSet_translate}{disjoint},
so adjoining one coordinate
\lword{Erdos257/MersenneSubseriesRigidity.lean}{297}{volume_supportedMersenneAchievementSet_insert}{doubles the volume}.
At $J=\N$, the restricted set is the full set $\Ach$
\lword{Erdos257/MersenneSubseriesRigidity.lean}{311}{supportedMersenneAchievementSet_univ}{by definition}.
...
\lword{Erdos257/MersenneSubseriesRigidity.lean}{324}{volume_supportedMersenneAchievementSet_finset_compl_scaled}{multiplies the face volume by $2^{|F|}$}
and its solved form
\lword{Erdos257/MersenneSubseriesRigidity.lean}{360}{volume_supportedMersenneAchievementSet_finset_compl}{gives $2^{-|F|}$}.
Monotonicity under enlarging $J$ is
\lword{Erdos257/MersenneSubseriesRigidity.lean}{369}{supportedMersenneAchievementSet_mono}{checked}.
...
\lword{Erdos257/MersenneSubseriesRigidity.lean}{379}{volume_supportedMersenneAchievementSet_eq_zero_of_compl_infinite}{measure zero}.
The two cases are assembled in
\lword{Erdos257/MersenneSubseriesRigidity.lean}{408}{volume_supportedMersenneAchievementSet_dichotomy}{the formal dichotomy}.
...
\noindent Checked as
\mword{Erdos249257/GreedyAchievementSet.lean}{2585}{half_mem_mersenneAchievementSet_iff_greedySkippedSupport_infinite}{the greedy form},
