...
The first three arguments share a mechanism.  Freeze a finite set of
...
checks the classical full-support, pairwise-coprime summable-support and
periodic-weight theorems, the denominator identity, the geometric
...
\textbf{Infinite supports.} Divisibility-weighted summability, sub-log-star
