...
\renewcommand{\commit}{d6b0a70c9a9c1204ad58eea7234ad5341ef33a6a}
\renewcommand{\commitshort}{d6b0a70c9a9c}
\hypersetup{
...
whose values at every power-of-two base are jointly controlled by the
literature and on which two of the
...
all of $\Npos$ & every $b\ge2$ & Erd\H{o}s 1948~\cite{erdos1948};
  \mword{Erdos249257/CertificateKernel.lean}{8998}{irrational_erdosSupportSeries_univ}{formalised here} \\
multiples of a fixed $d$ & every $b\ge2$ & dilation: the multiples series at
  base $b$ \emph{is} the full-support series at base $b^d$
  (\mword{Erdos249257/CertificateKernel.lean}{9056}{irrational_erdosSupportSeries_multiples}{checked}) \\
\addlinespace
\multicolumn{3}{@{}l}{\emph{Periodicity of the coefficient sequence}}\\
eventually periodic & every $b\ge2$ &
  \mword{Erdos249257/CertificateKernel.lean}{11557}{irrational_erdosSupportSeries_eventuallyPeriodic}{checked here};
...
a residue class; the odd numbers & every $b\ge2$ & special cases of the row
  above (\mword{Erdos249257/CertificateKernel.lean}{11625}{irrational_erdosSupportSeries_residueClass}{residue class},
  \mword{Erdos249257/CertificateKernel.lean}{11639}{irrational_erdosSupportSeries_odd}{odd});
...
factorials $\{n!\}$ & every $b\ge2$ &
  \mword{Erdos249257/CertificateKernel.lean}{5988}{irrational_erdosSum_factorial_support}{checked here} \\
powers of two $\{2^k\}$ & every $b\ge2$ &
  \mword{Erdos249257/CertificateKernel.lean}{6012}{irrational_erdosSum_two_pow_support}{checked here} \\
pairwise coprime, $\sum_{a\in A}a^{-1}<\infty$ & every $b\ge2$ &
  Erd\H{o}s~\cite{erdos1968}, theorem on p.~222;
  \mword{Erdos249257/CertificateKernel.lean}{10729}{irrational_erdosSupportSeries_pairwise_coprime}{formalised here} \\
\addlinespace
...
(\mword{Erdos249257/CertificateKernel.lean}{6225}{lcm_gap_hypothesis_fails_full_support}{checked}).
...
(\mword{Erdos249257/CertificateKernel.lean}{14128}{irrational_or_bpow_mul_eq_intCast_intWeightedErdosSeries_periodic}{checked}).
...
\mword{Erdos249257/CertificateKernel.lean}{9420}{irrational_erdosSupportSeries_of_tail}{Lean}
and
\mword{Erdos249257/CertificateKernel.lean}{9429}{irrational_erdosSupportSeries_tail_of_irrational}{Lean}.
...
\mword{Erdos257/HalfCounterexampleFrontier.lean}{59}{finiteErdosSum_ne_one_div_twenty_one}{the formal theorem}.
...
\[
 ...
 \end{aligned}
\]
Here $D_R\subseteq\{2,\ldots,R\}$ is obtained by descending integer-greedy
selection on the exact quotient weights, and $s_R$ is its terminal scalar
remainder
...
Every closed Boolean quotient row is this canonical row, including exact
saturation
(\mword{Erdos249257/TwentyOneQuotientGreedy.lean}{231}{twentyOneClosedRow_forces_quotientGreedy}{checked}).

Let $\mathcal F_{21}$ denote \texttt{TwentyOneFatalAlignedBranch}: a fatal
real-greedy witness, finitely many skipped exponents (hence cofinite eventual
selection), eventual quotient/rational-greedy alignment, and eventual
occupation of every doubling block.  The key logical boundary is exact:
\[
 \frac1{21}\in\Ach\quad\Longleftrightarrow\quad\neg\mathcal F_{21}
\]
(\mword{Erdos249257/TwentyOneQuotientGreedy.lean}{3508}{one_div_twenty_one_mem_iff_not_fatalAlignedBranch}{checked}).
On $\mathcal F_{21}$, the quotient orbit is eventually strictly
...
\]
This is the literal conclusion of
\mword{Erdos249257/TwentyOneQuotientGreedy.lean}{5657}{twentyOneFatalAlignedBranch_eventually_affine_supercapacity}{the checked affine normal form}.
It is conditional, not a contradiction: synthetic pulses can sustain such an
affine recurrence without being the actual divisor pulse.
...
The following questions are ranked by how directly an answer would move the
checked boundary.
...
$Q_N\le1$
(\mword{Erdos249257/BooleanMobiusCarry.lean}{2842}{one_div_twenty_one_mem_mersenneAchievementSet_of_defect_le_one_cofinally}{consumer})
...
\mword{Erdos249257/TwentyOneQuotientGreedy.lean}{3736}{lastTwentyOneSkip_erdosBorwein_fatalInterval}{an exact one-sided approximation}.
The reduced skipped-prefix denominator has binary order equal to the lcm of
the skipped exponents and hence at least $M$
(\mword{Erdos249257/TwentyOneQuotientGreedy.lean}{3570}{lastTwentyOneSkip_oddDoublingOrder_eq_lcm}{order identity},
\mword{Erdos249257/TwentyOneQuotientGreedy.lean}{3584}{lastTwentyOneSkip_le_oddDoublingOrder}{lower bound}).
...
\]
If not, what cyclotomic, valuation or cancellation conditions characterize
...
\paragraph{The secondary target $1/2$.}
No finite support has value $1/2$, and Theorem~\ref{res:half} makes membership
equivalent to infinitely many greedy skips; non-membership is equivalent to a
finite fatal gap.  Thus $1/2\in\Ach$ would also refute \#257, while
$1/2\notin\Ach$ would eliminate only this candidate.  The question remains
valid, but the public proof frontier at $1/21$ is presently sharper.
