...
for every nonzero eventually periodic sequence of nonnegative rational
weights.
...
base $b\ge2$; so are all convergent pairwise-coprime supports and all nonzero
eventually periodic nonnegative rational weight sequences.  Finite subsums
...
\noindent Checked as
\mword{Erdos249257/GreedyAchievementSet.lean}{2571}{half_mem_mersenneAchievementSet_iff_greedySkippedSupport_infinite}{the greedy form},
