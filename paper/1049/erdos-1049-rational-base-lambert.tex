...
Lemma~7 before the source's integer-specialisation step. Lean checks the
theorem and the corollary below, with the source supply applied.
...
The extension to non-integer rational bases noted in
\cite[Sec.~2, p.~4]{zudilin2016} has the same shape, with the computable
...
\begin{proposition}[Pad\'e summand bound and exact gap]\label{res:pade}
