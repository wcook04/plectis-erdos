...
proof using the polynomial conclusion of Zudilin's Lemma~7; Lean checks
...
The two theorems are not kernel-checked.  The linked Lean declarations establish exact inequalities,
