...
is ordinary mathematics; the corresponding Lean assembly retains a row
hypothesis. The record also gives a separate positive-measure proof of
...
$2^{N}\mathrm{lc}=(N!)^{2}(N+1)!$, are ordinary in this record;
those Lean names are not in this checkout.  The initial-monomial theorem for rows $j\ge2$ is outside this
