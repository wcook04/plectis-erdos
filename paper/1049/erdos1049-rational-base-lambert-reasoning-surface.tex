...
development at revision \texttt{181078b6b009}.  The two below were proved
later.  Each has a Lean statement of the same assertion, checked by the Lean
kernel using only those three axioms, at revision \texttt{e4ba6841dfdb}.
