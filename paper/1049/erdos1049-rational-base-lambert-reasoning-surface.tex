...
development at revision \texttt{181078b6b009}.  Four of the six have a
Lean statement of the same assertion, checked by the Lean kernel using only
those three axioms, at a later revision:
Propositions~\ref{long1049:res:nomahler} and~\ref{long1049:res:finite-pencil}
at \texttt{e4ba6841dfdb}, as described below, and
...
arguments and have no Lean statement at either revision.
