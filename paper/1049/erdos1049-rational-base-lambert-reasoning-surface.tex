...
development at the formal-source checkpoint \texttt{7380b7871687}. Two of the six,
Propositions~\ref{long1049:res:nomahler} and~\ref{long1049:res:finite-pencil},
have Lean statements of the same assertions, checked by the Lean kernel
using only those three axioms, as described below. The other four are proved by
