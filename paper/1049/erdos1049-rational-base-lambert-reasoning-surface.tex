...
Proposition~\ref{long1049:prop:rogers-factorisation} below is a
\href{\laterepobase/lean/ErdosProblems/Erdos1049/PaperCompleteR21/RogersFactorisationAnalytic.lean\#L1312}{Lean theorem};
the two theorems of this subsection have ordinary proofs and no Lean
statement. Nothing in this subsection changes a denominator valuation or
...
later extension \texttt{168bf6727758}. Four of the six have Lean statements
of the same assertions, checked by the Lean kernel using only those three
axioms:
Propositions~\ref{long1049:res:nomahler} and~\ref{long1049:res:finite-pencil}
at \texttt{7380b7871687}, as described below, and
...
The remaining two, Theorems~\ref{long1049:thm:geometric-universality}
and~\ref{long1049:thm:sharp-fixed-base} in
Section~\ref{long1049:sec:sharp-fixed-base}, are proved by ordinary
arguments and have no Lean statement at either checkpoint.
