...
onset $a_D$, the sharp bound $K$, and Theorem~\ref{long269:res:uniform-rank} are ordinary proofs in this paper; the window-growth law and the enlarged little-$o(8^a)$ equivalence band have named Lean endpoints; the three
