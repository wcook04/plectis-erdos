...
residue-window escape.  No irrationality or transcendence result for any three-prime instance
is claimed.
\end{abstract}
...
pair of distinct primes, by reduction to a Hecke--Mahler value; no priority is
claimed.  \textbf{Three primes.} This paper proves the exact LCM cell
...
construction or its arbitrary-size minors.  Neither result supplies the
missing three-prime irrationality argument.
...
it to the actual series uses the integral carry and bound proved above;
...
the actual series supplies its hypotheses.  The paper shell argument supplies
the factorisation, recurrence and specified bound; cofinal escape remains
unproved.  In particular it is not an irrationality theorem
