...
structure, the radix alphabet for $\{2,3,5\}$, symmetric prime-power boundary
...
is the
\lword{Erdos269/RationalLatticeReduction.lean}{44}{smoothHeight_mul_prime_dvd_boundaryHeight}{checked
prime-power boundary clearing theorem}.
\end{proof}
...
proving~\emph{(14)}.  This is the
\lword{Erdos269/IntegralBranchWidth.lean}{36}{trueNormalizedState_eq_telescope}{checked
finite-depth tail telescope}; no limiting argument is hidden.
...
identity supplies no Diophantine lower bound.  It proves neither irrationality
nor transcendence and carries no priority claim.  Its authored proof is
