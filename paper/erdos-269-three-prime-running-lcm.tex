...
with the required divisibility by the
$\{2,3,5\}$-smooth part of its denominator, that factor could be cancelled and
the remaining denominator $B$ would be coprime to $30$.  A suitable consecutive
window would then force the reduced carry outside its bound.  Lean checks the
