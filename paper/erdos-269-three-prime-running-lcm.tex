...
\ref{sec:cells} and~\ref{sec:fibre} make the finite ingredients of that
reindexing exact, in the case $|P|=3$: they identify where the value is
constant, by exactly what factor it changes when it changes, and give a finite
rectangular-box fibre identity.  They do not justify the ordered infinite
passage or recover the irrationality proof Erd\H{o}s reported for the
