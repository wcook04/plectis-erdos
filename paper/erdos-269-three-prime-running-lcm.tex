...
\noindent Both clauses are \lloc{Erdos269/PaperR7BasicAssembly.lean}{22}.
...
\noindent The statement is \lloc{Erdos269/PaperR7ModularMinors.lean}{133}.
...
\lloc{Erdos269/PaperR7BasicAssembly.lean}{102}.
...
\noindent The statement is \lloc{Erdos269/PaperR7FiniteCutRank.lean}{182}.
...
\end{equation}
Both inequalities are \lloc{Erdos269/PaperR7BasicAssembly.lean}{112}.
...
\noindent Both clauses are \lloc{Erdos269/PaperR7ActualOrbit.lean}{48}.
...
All four clauses are \lloc{Erdos269/PaperR7SeriesIdentification.lean}{168}.
...
\noindent The statement is \lloc{Erdos269/PaperR7RationalBridge.lean}{80}.
...
\noindent The statement is \lloc{Erdos269/PaperR7BasicAssembly.lean}{138}.
...
\lloc{Erdos269/PaperR7WindowResults.lean}{51}.
...
\begin{problem}[nonintegrality of the actual reduced tails]
\label{prob:tails269}\label{prob:producer}
...
\appendix
\section{Guide to the principal formal statements}\label{app:index}
The arbitrary-order minor and non-separability statements are
\path{exists_uniform_nonsingular_threePrimeKernel_minor_of_prime} and
\path{not_finite_separable_threePrimeKernel} in
\path{ErdosProblems/Erdos269/KernelCarryRank.lean}.
The same file contains the leading-four identities.
The interval-difference algebra behind the finite cut-rank formula is in
\path{ErdosProblems/Erdos269/FiniteCutRank.lean}; that file by itself is
not a formal proof of the full arithmetic normal form.

The running-LCM and finite shell statements are in
\path{ErdosProblems/Erdos269/ThreePrimeRunningLcm.lean}.
The actual bridge is
\path{exists_reducedCarry_of_value_eq_rat} in
\path{ErdosProblems/Erdos269/RationalityCarryBridge.lean}.
The finite residue argument is in
\path{ErdosProblems/Erdos269/ResidueEscape.lean}, and its window composition
is in \path{ErdosProblems/Erdos269/RestrictedFloorSum.lean}.
The exact block-potential classification and its anchor condition are in
\path{ErdosProblems/Erdos269/ThreeChannelBlockRigidity.lean}.
These source statements retain their displayed hypotheses.
