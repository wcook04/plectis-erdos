...
$|P|\ge2$.  In the primary 1988 source, Erd\H{o}s proves
...
\cite[p.~3, Theorem~1.1]{bugeaudlaurent2022}.  This is an independent modern
...
Erd\H{o}s 1974 letter & Asserted on p.~335, but no proof is supplied there and
the letter's argument is not recovered here. \\
Transcendence after deleting duplicate values when $|P|=2$ &
Paper using Bugeaud--Laurent Theorem~1.1 & Unconditional for every pair of
...
\cite[p.~3, Theorem~1.1]{bugeaudlaurent2022}.  We may take
...
\bibitem{bugeaudlaurent2022} Y.~Bugeaud and M.~Laurent,
  \href{https://arxiv.org/abs/2203.12901}
  {\emph{Transcendence and continued fraction expansion of values of
  Hecke--Mahler series}}, arXiv:2203.12901v1, 2022, 29~pp.
  Theorem~1.1 is on p.~3; the authors note there that its $\rho=0$ case was
  already obtained by Loxton and van der Poorten.
\end{thebibliography}
