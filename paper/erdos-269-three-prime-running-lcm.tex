...
coboundary; its Cartier realisation shows that any finite-dimensional
factorisation would force the realised symbolic span to be finite
...
No theorem proves that the literal realised span is infinite, so this is a
representation obligation, not a general analytic no-go.
