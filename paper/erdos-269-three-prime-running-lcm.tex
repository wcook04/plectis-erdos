...
The newly public bounded-radix theorem gives a useful exact reduction.  Since
...
unbounded denominator and cofinal-start quantifiers.  The finite checker is a
regression test for proposed producers, not evidence for either shortcut.
...
may need.  The newly public observer formalisation isolates the precise
...
three-prime kernel under a specified family of shifts.  The newly public
three-channel rigidity and carry-lift extinction theorems already exclude one
false route: ordinary block-nullity plus the two genuine anchors kills the
perturbation and is incompatible with the required bounded lift
(\lword{Erdos269/ThreeChannelBlockRigidity.lean}{61}{channelBlockNull_iff_channelPotential}{rigidity},
\lword{Erdos269/CarryLiftExtinction.lean}{236}{no_bounded_carryLift_of_blockNull_twoAnchors}{extinction}).
The actual carry supplies a weighted block defect instead, so a producer must
use that weighted identity or construct a different faithful lift.

Until the bridge and either the direct tail problem or an adequate producer
...
integer least-positive-residue consumer & \lrefx{Erdos269/ResidueEscape.lean}{107}{no_bounded_positive_int_state_of_leastPositiveResidue}\\
...
cofinal window producer & \lrefx{Erdos269/RestrictedFloorSum.lean}{629}{CofinalLocalWindowEscape}\\
