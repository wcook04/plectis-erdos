...
three-prime kernel under a specified family of shifts.  The three-channel
rigidity and carry-lift extinction theorems already exclude one false route:
ordinary block-nullity plus the two genuine anchors kills the
...
The actual carry supplies a weighted block defect instead, so any successful
