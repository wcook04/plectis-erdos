...
running-LCM identity, the smallest rank-two kernel minor, and the conditional
reduced-carry extinction interface.  The latter preserves its cofinal-escape,
coprimality, recurrence, positivity, and bound hypotheses; it is not an
unconditional three-prime result.  Comparator deliberately does not badge the
paper-authored two-prime transcendence argument.}
