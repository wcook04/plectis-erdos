...
\renewcommand{\commit}{5b1e6c05c1c5485ba40dec8ba3dcc94c134f026b}
\renewcommand{\commitshort}{5b1e6c05c1c5}
\hypersetup{
...
Hecke--Mahler value $A$; the repeated sum factorises as $A(1+B)$ and is a
nonconstant quadratic in the same $A$.  Bugeaud--Laurent's transcendence
theorem supplies the transcendence of $A$.  These are the unconditional
irrationality conclusions of the note.  Both are paper proofs using that
external theorem, not Lean-formalised results, and neither applies to any
