...
share that bivariate little-$q$-Legendre Pad\'e kernel, but not one scalar
recurrence: Amdeberhan--Zeilberger use the moving diagonal
...
non-transfer.  No recurrence, endpoint, lattice, or valuation statement for
one diagonal is used for the other; the displayed exact residual is the sole
claim made here about their incompatibility.
