...
coefficient and its coefficient at $W$, and a \emph{unit} endpoint is one equal
...
architecture all lie outside its two hypotheses.  A theorem showing that every
