...
\lloc{Erdos1049/PaperOmegaIndicatorR7.lean}{1297}.
...
\lloc{Erdos1049/PaperHomogenisationR7.lean}{61}.
Moreover
\[
\begin{split}
 \log\bigl(b^{W_n}\Lambda_n(a/b)\bigr)
...
\lloc{Erdos1049/TwoSelectorRemainderEscape.lean}{128}.
\end{proof}
...
the contradiction, is \lloc{Erdos1049/PaperRankTwoCapR7.lean}{123}.
...
\lloc{Erdos1049/PaperRankTwoCapR7.lean}{144}, and the final numerical clause is
\lloc{Erdos1049/PaperRankTwoCapR7.lean}{155}.
...
the sufficient width are together \lloc{Erdos1049/PaperFiniteAssembliesR7.lean}{248}.
\end{proof}
...
together \lloc{Erdos1049/PaperFiniteAssembliesR7.lean}{269}.
\end{proof}
...
against Mathlib.  The finite signature-and-bin statement used here is
\lword{Erdos1049/QuantitativeSelectorEscape.lean}{79}{exists_small_real_escape_of_conditional_multiplicity}{linked at revision \commitshort}.
Its source-specific multiplicity and real-bin estimates remain hypotheses.
