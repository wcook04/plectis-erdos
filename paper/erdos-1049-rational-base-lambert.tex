...
V\"a\"an\"anen~\cite[Thm.~2, pp.~176--177]{bv1994} settles a family of rational bases restricted by a
...
\cite[Theorem~1.1, p.~2; proof pp.~6--8]{rivin2026}.
...
$a_n=(-1)^n$ completes the elementary digit method for negative integer
bases~\cite[Thm.~1.2, p.~2]{vandehey2013}.  All
...
\bibitem{rivin2026} I.~Rivin,
  \href{https://arxiv.org/abs/2604.25151}{\emph{Linear recurrences and rational
  Lambert series}}, arXiv:2604.25151v1, 2026.
  Theorem~1.1 is on p.~2 and proved on pp.~6--8; the periodic-coefficient
