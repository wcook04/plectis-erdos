...
carry the mathematical claims.  For non-integer rational $t$ the problem is
open.
...
bound using little $q$-Legendre Pad\'e approximants
...
by way of Heine's basic transform and a permutation
group~\cite[Secs.~4--5, pp.~159--162]{zudilin2004}.
