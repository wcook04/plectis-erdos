...
interfaces.  Registration of that package in the public portfolio is a
separate release step.}

The selected cleared-tail Comparator row is an exact algebraic interface.  For
