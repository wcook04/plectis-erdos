...
four-jet threshold with its unit-block optimality statement, and the abstract
bounded-fibre escape theorem.  It also retains the exact rational-base tail
...
coordinatewise-corridor exclusion at $3/2$.  Registration of either package
...
revision~\commitshort.  The declarations of this note live in six modules:
\texttt{RationalBaseLambert}, \texttt{QAperyDiagonalNonEquivalence},
\texttt{RationalPadeArithmetic}, \texttt{ZudilinConeArithmetic},
\texttt{ZudilinHeightRegion}, and \texttt{HermitePadeNoGo}.  The first contains
...
and rectangular exponent model.  The link
