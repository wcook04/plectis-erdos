...
\renewcommand{\commit}{a697d3009d8ebc97b7e5d3c2498b610308fa8308}
\renewcommand{\commitshort}{a697d3009d8e}
\hypersetup{
...
\lword{Erdos1049/ZudilinConeArithmetic.lean}{161}{homEvalThreeTwo_mod_three}{bottom-endpoint
identity} and
\lword{Erdos1049/ZudilinConeArithmetic.lean}{175}{homEvalThreeTwo_mod_two}{top-endpoint
identity}; the unit consequences are the
\lword{Erdos1049/ZudilinConeArithmetic.lean}{193}{three_not_dvd_homEvalThreeTwo_of_const_unit}{constant-endpoint
obstruction} and
\lword{Erdos1049/ZudilinConeArithmetic.lean}{211}{two_not_dvd_homEvalThreeTwo_of_top_unit}{top-endpoint
obstruction}.
...
\lword{Erdos1049/ZudilinConeArithmetic.lean}{149}{bottomJet3_eq_zero_iff_dvd}{bottom-jet
consumer} and
\lword{Erdos1049/ZudilinConeArithmetic.lean}{155}{topJet2_eq_zero_iff_dvd}{top-jet
...
\(\{-1,0,1\}^n\) cancelling all four jets.
\end{theorem}
...
distinct selectors in the same fibre.
\end{proof}

\noindent This is the checked
\lword{Erdos1049/ZudilinConeArithmetic.lean}{133}{exists_distinct_binary_selectors_same_fourJet}{four-jet
pigeonhole kernel}.  It proves abstract kernel existence and gives bounded
coefficients.  It does not prove that an available family has enough genuinely
independent directions at the required quadratic depths, or that a collision
vector lies outside the analytic remainder nullspace.
...
\noindent This is the checked
\lword{Erdos1049/ZudilinConeArithmetic.lean}{262}{three_two_scalar_margin_neg}{three-halves
...
Exhibit enough genuinely independent Heine--Zudilin coefficient pairs
\((U_j,V_j)\) to satisfy the cardinal hypothesis of
Theorem~\ref{res:jetkernel} at the required quadratic depths, and prove that
at least one resulting collision satisfies
\[
...
\paragraph{Wanted.}
An explicit growing-rank coefficient matrix large enough for the checked
pigeonhole inequality, plus a proof that some collision vector has nonzero
remainder and sufficient local gain.  A scalar ray, a multiplicative
cyclotomic factor, or another primitive-content computation is not responsive
to the surviving obstruction.
...
forces a nonzero \(\{-1,0,1\}\) four-jet collision.  None of these statements
produces enough actual independent forms or proves a collision remainder
nonzero.

\paragraph{Most useful answer.}
Give the first actual family size \(r=r(n)\) satisfying the four-jet cardinal
inequality, then show that the collision fibre is not contained in the
remainder-nullspace.  If every available family is too small or degenerate, a
rank theorem identifying that obstruction is more valuable than further
...
four-jet pigeonhole kernel & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{133}{exists_distinct_binary_selectors_same_fourJet}\\
bottom-jet divisibility & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{149}{bottomJet3_eq_zero_iff_dvd}\\
top-jet divisibility & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{155}{topJet2_eq_zero_iff_dvd}\\
bottom endpoint modulo three & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{161}{homEvalThreeTwo_mod_three}\\
top endpoint modulo two & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{175}{homEvalThreeTwo_mod_two}\\
unit constant endpoint obstruction & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{193}{three_not_dvd_homEvalThreeTwo_of_const_unit}\\
unit top endpoint obstruction & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{211}{two_not_dvd_homEvalThreeTwo_of_top_unit}\\
irrationality-exponent inequality & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{250}{twice_le_of_irrationalityExponent_bounds}\\
three-halves scalar margin & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{262}{three_two_scalar_margin_neg}\\
\end{tabular}
\fi
