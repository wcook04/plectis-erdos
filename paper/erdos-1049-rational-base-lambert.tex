...
\hypersetup{
  pdftitle={A rational-base irrationality region for the Lambert value, and sharp obstructions at base 3/2, for Erdős Problem 1049},
...
\runninghead{Erd\H{o}s \#1049: a rational-base irrationality region}
\title{A Rational-Base Irrationality Region for the Lambert Value}
\subtitle{The region $b^{\mu}<a$, the base $31/4$, and sharp obstructions at
$3/2$, for Erd\H{o}s Problem~\#1049}
\author{Will Cook}
\date{July 2026}
