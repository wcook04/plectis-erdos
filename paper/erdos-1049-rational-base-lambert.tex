...
The \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos1049/PaperOmegaIndicatorR7.lean#L1297}{omega-indicator theorem}
proves both the zero-one values and this thirteen-interval support.

\paragraph{Integral polynomials and their degrees.}
The source's polynomial inclusion is Lemma~7, display~(23), on p.~161 \cite{zudilin2004}.
...
The \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos1049/PaperHomogenisationR7.lean#L61}{cleared linear-form identity}
combines that integrality with the resulting linear form.
Moreover
\[
\begin{split}
 \log\bigl(b^{W_n}\Lambda_n(a/b)\bigr)
...
The \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos1049/TwoSelectorRemainderEscape.lean#L128}{rational integer-linear-form gap}
gives the separation bound for a nonzero integral form at a rational target.
\end{proof}
...
The \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos1049/PaperRankTwoCapR7.lean#L123}{cross-product limit obstruction}
formalises the integer argument from the two limits to the contradiction.
...
The \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos1049/PaperRankTwoCapR7.lean#L144}{negative-balance equivalence}
gives the arithmetic form of that region, and the
\href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos1049/PaperRankTwoCapR7.lean#L155}{half-cap equivalence}
gives the final numerical clause.
The displayed degree upper bound furnishes a sufficient decay cutoff; the following corollary gives a separate exclusion under the same all-base hypotheses.
\end{proof}

\begin{corollary}[Undivided forms below the square boundary]
\label{cor:no-decay-below-square}
Under the hypotheses of Theorem~\ref{res:archimedean-cap}, for positive integers
...
The \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos1049/PaperFiniteAssembliesR7.lean#L248}{four-jet assembly theorem}
combines the cardinality formula, the collision, the signed
\(\{-1,0,1\}\) vector and the sufficient width.
\end{proof}
...
The \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos1049/PaperFiniteAssembliesR7.lean#L269}{Pl\"ucker assembly theorem}
combines the ring-generic minor collapse with the modular selector collision.
\end{proof}
