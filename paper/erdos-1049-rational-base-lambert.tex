...
\renewcommand{\commit}{d7c339fe1e2c9c4729004afafd10ae4b2cf59fef}
\renewcommand{\commitshort}{d7c339fe1e2c}
\hypersetup{
...
containing $7/2$, is used as an external theorem; of its inputs we formalise
only two exact arithmetic facts.  Separately we check polynomial bounds on the
denominator exponents of a homogenised Pad\'e construction, with the analytic
...
family of rational bases cut out by a height condition~\cite{bv1994}.  The
criterion applies at $\beta=7/2$.  It is an analytic theorem and it is not
formalised here.  Two of its elementary inputs are.
...
$\pi$, and the analytic theorem of~\cite{bv1994} itself.
Proposition~\ref{res:sevenhalves} is not a formalisation of the criterion
of~\cite{bv1994}.  The two remaining elementary inputs, the logarithmic
monotonicity step and the bound $3<\pi$, could be formalised on their own, with
the analytic theorem left external and cited.
