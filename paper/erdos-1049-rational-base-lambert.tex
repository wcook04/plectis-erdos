...
\renewcommand{\commit}{b0e3723fa5222346a546f415b8fe93d7c756ce4d}
\renewcommand{\commitshort}{b0e3723fa522}
\hypersetup{
...
\]
This is the
\lword{Erdos1049/ZudilinConeArithmetic.lean}{95}{homEvalThreeTwo}{homogeneous
endpoint evaluation}.
...
\lword{Erdos1049/ZudilinConeArithmetic.lean}{120}{homEvalThreeTwo_mod_three}{bottom-endpoint
identity} and
\lword{Erdos1049/ZudilinConeArithmetic.lean}{134}{homEvalThreeTwo_mod_two}{top-endpoint
identity}; the unit consequences are the
\lword{Erdos1049/ZudilinConeArithmetic.lean}{152}{three_not_dvd_homEvalThreeTwo_of_const_unit}{constant-endpoint
obstruction} and
\lword{Erdos1049/ZudilinConeArithmetic.lean}{170}{two_not_dvd_homEvalThreeTwo_of_top_unit}{top-endpoint
obstruction}.
...
\lword{Erdos1049/ZudilinConeArithmetic.lean}{108}{bottomJet3_eq_zero_iff_dvd}{bottom-jet
consumer} and
\lword{Erdos1049/ZudilinConeArithmetic.lean}{114}{topJet2_eq_zero_iff_dvd}{top-jet
consumer}.  They turn the missing local divisor into an additive congruence
kernel problem; they do not construct such a kernel.
...
\lword{Erdos1049/ZudilinConeArithmetic.lean}{221}{three_two_scalar_margin_neg}{three-halves
...
Construct additive combinations of genuinely independent Heine--Zudilin
coefficient pairs \((U_j,V_j)\), with rank tending to infinity, which satisfy
\[
...
remainder is nonzero and the coefficient height is smaller than the local
gain.  A rank-saturated contiguous-shift determinant or a genuinely
independent deformation is an acceptable first producer.
\end{problem}
...
\paragraph{Wanted.}
An explicit growing-rank coefficient matrix, with its four endpoint-jet
congruences, a nonvanishing certificate for the resulting linear form, and an
asymptotic height bound.  A scalar ray, a multiplicative cyclotomic factor, or
another primitive-content computation is not responsive to the surviving
obstruction.
...
\(3\) and \(2\); and the source integer-base ratio inequality implies a
strictly negative scalar margin at \(3/2\).  None of these statements proves
the all-scale rational specialisation or irrationality.

\paragraph{Most useful answer.}
Give the first rank \(r=r(n)\) for which the four jet maps have a nonzero
kernel vector outside the remainder-nullspace, together with exact coefficient
height.  If no such vector exists, a rank theorem identifying the obstruction
is more valuable than further low-rank enumeration.
...
homogeneous endpoint evaluation & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{95}{homEvalThreeTwo}\\
bottom-jet divisibility & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{108}{bottomJet3_eq_zero_iff_dvd}\\
top-jet divisibility & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{114}{topJet2_eq_zero_iff_dvd}\\
bottom endpoint modulo three & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{120}{homEvalThreeTwo_mod_three}\\
top endpoint modulo two & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{134}{homEvalThreeTwo_mod_two}\\
unit constant endpoint obstruction & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{152}{three_not_dvd_homEvalThreeTwo_of_const_unit}\\
unit top endpoint obstruction & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{170}{two_not_dvd_homEvalThreeTwo_of_top_unit}\\
irrationality-exponent inequality & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{209}{twice_le_of_irrationalityExponent_bounds}\\
three-halves scalar margin & \lrefx{Erdos1049/ZudilinConeArithmetic.lean}{221}{three_two_scalar_margin_neg}\\
\end{tabular}
\fi
