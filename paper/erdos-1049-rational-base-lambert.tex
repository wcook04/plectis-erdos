...
irrationality result.  At the rational base $3/2$ we instead prove two scoped
 arithmetic obstructions.  One quantitative result concerns an explicit rectangular two-function
exponent model has no better threshold than the classical one-function margin,
with equality only at $ho=0$ and $sigma=1$ under
$0leho$ and $1+holesigma$
