...
The finite collision count has a sharper threshold than this convenient bound.
For four-jet depths $R,S$, $M$ coefficient pairs suffice exactly when
$M>2Rlog_2 3+2S$; if $N=2^M$ and
$Q=3^{2R}2^{2S}$, convexity gives at least
