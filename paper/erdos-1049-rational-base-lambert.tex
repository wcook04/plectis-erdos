...
\hypersetup{
  pdftitle={Sharp normalized Hankel order and arithmetic obstructions at base 3/2 for Erdős Problem 1049},
...
\runninghead{Erd\H{o}s \#1049: sharp Hankel order and arithmetic obstructions}
\title{Sharp Normalized Hankel Order and Arithmetic Obstructions at Base $3/2$}
\subtitle{An exact all-rank formula and named-route closures for Erd\H{o}s
Problem~\#1049}
\author{Will Cook}
\date{July 2026}
...
Our strongest theorem sharpens the normalized Hankel estimate in Zudilin's
