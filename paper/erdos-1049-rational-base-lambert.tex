...
\noindent Minor propagation when every second coordinate is a unit is
...
and its explicit $2$/$3$-depth endpoint is
\lword{Erdos1049/BezoutPluckerJets.lean}{249}{zmod_binary_tail_collision_of_two_three_depth}{kernel checked}.
The rowwise-unimodular extension is proved above; its Lean verification is
pending.  This conditional theorem is stronger than the ambient four-jet count only
