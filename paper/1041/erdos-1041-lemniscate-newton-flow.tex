...
A degree-seven counterexample to the unrestricted assertion has been
reported to the author. Its proof is not reproduced or independently
verified in this revision. We use Problem~1041 as the historical question,
not as an assertion here that the unrestricted bound remains open.
...
not the ordinary root-disc reduction.
\end{proof}
