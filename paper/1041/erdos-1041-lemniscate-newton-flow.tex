...
$|\zeta_1|+|\zeta_2|<2$.
The displayed statement is ordinary mathematics in this note.
\texttt{PaperTrinomial.lean} is not in this checkout.  Lean checks Newton-flow
decay, ray/translation geometry and root retention in
\texttt{NewtonFlowRaySeparation.lean}, and solved-family kernels rather than
this all-degree trinomial assembly.
\end{proof}
...
available.  The statement with the radius supplied is ordinary mathematics;
\texttt{PaperTrinomial.lean} is not in this checkout.
...
\noindent This is checked in consumer form: the kernel accepts
\lword{Erdos1041/NewtonFlowRaySeparation.lean}{315}{no_newtonConnection_of_not_samePositiveRay}{the implication from distinct rays to the absence of a Newton connection}.
It is the statement the topology needs, and it is a genuine sharpening of the criterion
