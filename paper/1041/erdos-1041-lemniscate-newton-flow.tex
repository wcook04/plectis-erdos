...
\end{proposition}
\evidenceremark{No Lean proof covers the whole proposition. Lean checks
that the roots lie in the open unit disc and that $\mu=187/2000\le1/2$.
The root count $k_0=2$ is not checked, and neither is the capacity
clause, which needs logarithmic capacity, a notion Mathlib does not
define.}
