...
\textbf{Reader entry.} The Newton value equation and its exponential first integral are checked exactly.
...
\textbf{Reader entry.} Distinct positive rays exclude a finite Newton connection.
