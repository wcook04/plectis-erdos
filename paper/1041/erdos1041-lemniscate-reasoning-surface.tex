...
\begin{enumerate}
\item $-\log|f|$ is a proper excellent Morse function on
$U\setminus f^{-1}(0)$, with exactly $k-1$ nondegenerate saddles;
...
distinct, and properness follows at the boundary and at the deleted roots.
