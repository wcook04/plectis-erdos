...
point in $U$.  A component of a polynomial lemniscate is simply connected.
The proper map $P:U\to Q$ therefore has degree two: Riemann--Hurwitz gives
...
\]
P\'olya's area--capacity inequality then yields
...
polynomial, proved by Eremenko and Lempert \cite{eremenkolempert1994}, whose
...
stratum where the critical values separate both by angle and by level.
