...
Two questions must be evaluated separately.  The first asks whether the
current semantic layers help a reader find existing mathematics and interpret
it correctly.  The second asks whether the derived layers as they stood in the
past shorten the work of producing a later result.  Checking out a past
revision answers the first and does not by itself isolate the second.  Later
