...
\path{CompressedPrimitiveChannelKernel.md}.  The quadratic stopping theorem has an ordinary finite-source proof.
...
The separate finite-source Lean draft has not been compiled.  The growth liminf is the
