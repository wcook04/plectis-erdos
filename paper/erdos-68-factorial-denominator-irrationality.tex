...
the second from a rational enclosure between Farey neighbours.  An integral divisor basis determines
...
Erd\H{o}s's original formulation begins at $n=2$ on
\href{https://www.renyi.hu/~p_erdos/1988-22.pdf#page=1}{p.~102}
of~\cite{erdos1988}.  Equivalently, one may write
$S=\sum_{n\ge1}((n+1)!-1)^{-1}$ by shifting the index.
The unshifted expression $(1!-1)^{-1}$ is not a term of this real series.
...
\noindent Lean checks the \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteExisting.lean#L29}{cofinal companion criterion}.
...
\noindent Lean checks the \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteExisting.lean#L47}{carry and divisibility criteria}.
\begin{proof}
...
\noindent Lean checks the \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteDivisorCoordinates.lean#L260}{divisor-channel coordinate theorem}.
\begin{proof}
...
be adjusted separately by a multiple of its own denominator.  Lean checks the \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteSupplementary.lean#L17}{expansion of $U_9$} and its \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteSupplementary.lean#L45}{observable profile}.
...
\end{equation}
in the equivalent \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteSupplementary.lean#L53}{integer-divisibility form},
...
Lean checks the displayed residual identity and its convergence on every finite paper-domain vector, and proves both
\href{https://github.com/wcook04/plectis-erdos/blob/f20f727ae44d6dc3b24036bf63118b8fe591912e/ErdosProblems/Erdos68/PaperCompleteResidualIdentity.lean#L185}{zero-moment integrality} and
\href{https://github.com/wcook04/plectis-erdos/blob/f20f727ae44d6dc3b24036bf63118b8fe591912e/ErdosProblems/Erdos68/PaperCompleteResidualIdentity.lean#L195}{equal-moment invariance modulo the integers}; the source endpoints for the identity and convergence are
\href{https://github.com/wcook04/plectis-erdos/blob/f20f727ae44d6dc3b24036bf63118b8fe591912e/ErdosProblems/Erdos68/PaperCompleteResidualIdentity.lean#L116}{residual transparency} and
\href{https://github.com/wcook04/plectis-erdos/blob/f20f727ae44d6dc3b24036bf63118b8fe591912e/ErdosProblems/Erdos68/PaperCompleteResidualIdentity.lean#L166}{full-residual summability}.
...
The resulting positive generator is attained by a vector of coefficient
content one, hence by a primitive vector.  A prime $p$ with $D/2<p\le D$ may
be used to compute the finite gcd below, and the generator is independent of
which eligible prime is chosen.  Lean proves the
\href{https://github.com/wcook04/plectis-erdos/blob/f20f727ae44d6dc3b24036bf63118b8fe591912e/ErdosProblems/Erdos68/PaperCompleteMomentIdeal.lean#L139}{exact attainable ideal}, together with
\href{https://github.com/wcook04/plectis-erdos/blob/f20f727ae44d6dc3b24036bf63118b8fe591912e/ErdosProblems/Erdos68/PaperCompleteMomentIdeal.lean#L242}{primitive attainment},
\href{https://github.com/wcook04/plectis-erdos/blob/f20f727ae44d6dc3b24036bf63118b8fe591912e/ErdosProblems/Erdos68/PaperCompleteMomentIdeal.lean#L307}{content-one attainment}, and
\href{https://github.com/wcook04/plectis-erdos/blob/f20f727ae44d6dc3b24036bf63118b8fe591912e/ErdosProblems/Erdos68/PaperCompleteMomentIdeal.lean#L321}{independence of the eligible prime}.
Odd $u_n$ vanish by induction.  For a prime $p$, the sole nonzero
...
\noindent Lean checks the \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteMomentHorizon.lean#L252}{finite moment-horizon theorem}.
\begin{proof}
...
\end{equation}
Lean checks the \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteLiminf.lean#L42}{extended-real lcm growth bound with exponent $3/2$}.
...
\end{equation}
Lean checks the \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompletePrimePole.lean#L118}{prime-pole survival criterion for the actual prefix lcm}.
...
\noindent Lean checks the \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteExisting.lean#L156}{irrationality criterion at natural parameters}.
\begin{proof}
...
The size exclusion has a separate kernel-checked certificate.  Put
$K=2^{80000}$ and
\[
...
\]
The certificate supplies rational endpoints $A/B<C/E$ containing this
interval, with $B,E>0$ and $BC-AE=1$, and checks
\[
 B+E\ge2^{39990},\qquad B+E>10^{12040}.
\]
If $S=a/q$ with $q>0$, then $u=aB-Aq$ and $v=Cq-aE$ are positive
integers.  The determinant identity gives $q=Eu+Bv\ge B+E$.
Thus the decimal bound holds without assuming that $a/q$ is reduced.

The dyadic enclosure, endpoint comparisons and denominator conclusion are
...
The factorial-grid exclusion above remains supported by the separate exact
GMP carry computation; it is not asserted here as a checked Lean certificate.
Neither finite exclusion supplies \eqref{eq:canonical-open-target}.
...
Remark~\ref{bdry:companion-orbit-nonconcentration}.  The supplementary moving-factor
Comparator package records two further conditional irrationality criteria:
\path{movingPrivateFactorScaleSplit_implies_irrational} requires a cofinal
prefix-private prime with both global and local scale inequalities;
\path{splitFactorNormalizedCollision_implies_irrational} requires cofinal
prime parameters, two factors of the private modulus with distinct projected
complementary residues, and a normalized collision bound.  Neither supplies
its cofinal certificates.  Their full hypotheses are in the package
\path{ExternalVerification68MovingFactorScaleSplit/Challenge.lean}, with
proofs in its \path{Solution.lean}; they are supplementary to the joint
criterion in Proposition~\ref{res:global-complementary-criterion}.
The third endpoint, \path{fixedOwnerPair_eventually_absorbed}, says that fixed
owners $i,j\ge2$ have private quotients one once
$p>\max(i!-1,j!-1)$.  Indeed, both denominators then divide $(p-1)!$,
which divides the collision core; dividing either denominator by its gcd
with that core therefore gives one.  These source-current modules, Comparator
