...
\hypersetup{
  pdftitle={An exact prime-pole cancellation law, cofinal private factorial-gap primes, and channel obstructions for Erdős Problem 68},
...
% Inline declaration links resolve against the pinned formal source.
\newcommand{\Ser}{S}
\newcommand{\chn}[2]{V_{#1}(#2)}
\newcommand{\Lc}{L}

\runninghead{Erd\H{o}s \#68: an exact prime-pole cancellation law}
\title{An Exact Prime-Pole Cancellation Law}
\subtitle{Unconditional theorems about the factorial-gap series, with the
channel obstructions and orbit boundaries beside them, for Erd\H{o}s
Problem~\#68}
\author{Will Cook}
