...
\hypersetup{
  pdftitle={Cubic-rate irrationality, and an exact record-excess criterion, for Erdős Problem 243},
...
\runninghead{Erd\H{o}s \#243: cubic-rate irrationality}
\title{Irrationality at the Cubic Rate}
\subtitle{An unconditional theorem, and rigidity criteria, for Erd\H{o}s
Problem~\#243}
\author{Will Cook}
\date{July 2026}
