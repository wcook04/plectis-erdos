...
arbitrary-order kernel minors and the exclusion of finite separation are
ordinary mathematics in this paper; they are not in the Comparator manifest.
Comparator names the $(2,3,5)$ minor $-1/15$, the running-LCM height identity,
and a conditional carry-escape consumer.  The actual-series reduction is given;
