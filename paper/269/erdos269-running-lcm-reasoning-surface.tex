...
\(\Kernel(i,j,k)=\sum_{\ell<d}f_\ell(i)G_\ell(j,k)\).  Those statements are
ordinary mathematics in this paper.  A single binary floor carry is the whole difference,
