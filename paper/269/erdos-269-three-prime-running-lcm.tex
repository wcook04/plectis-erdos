...
Section~4 of the companion paper, \emph{The Three-Prime Running LCM: Kernel
...
deduction~\cite{fan2026comment}.  Every other theorem, proposition, lemma
and corollary has a Lean proof of its whole statement, marked in the
margin; Appendix~\ref{app:sources} describes the formal sources.  Neither
these proofs nor the finite calculations supply the required windows for
every eligible denominator and arbitrarily late starts.
...
sources.  AI agents carried out most of the research
