...
The modular-minor corollary has an ordinary proof above; its older linked
module is absent from the supplied source tree, so the inventory does not
establish its current build status.  The exact-denominator corollary has an ordinary proof above.  The
moving-boundary example is proved in the companion, without a new
formalisation claim.  No Lean, Comparator, Isabelle or NanoDa run was
performed for this exposition revision.  Neither the listed checks nor
