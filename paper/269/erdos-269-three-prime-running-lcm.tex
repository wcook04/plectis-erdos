...
The links in Appendix~\ref{sec:pinned-lean-sources} point to a fixed
earlier revision of the Lean sources.
...
condition itself.  Appendix~\ref{sec:pinned-lean-sources} lists the Lean
declarations cited by an earlier version of this note.
...
\section{Index of Lean declarations}
\label{sec:pinned-lean-sources}
The following index links the Lean declarations cited by an earlier
version of this note, at a fixed earlier revision of the Lean sources.
\begin{itemize}
