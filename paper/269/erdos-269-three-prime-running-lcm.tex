...
finite sample.  Steve Fan posted the two-prime factorisation, reduction and
transcendence conclusion first (erdosproblems.com/269, 26~June~2026,
post-7218).  This paper records that argument as an ordinary deduction from
Bugeaud--Laurent and does not claim priority or a Lean theorem for the
two-prime case.  The repeated three-prime irrationality question remains
open.
\end{abstract}
...
survives after all row and column factors have been removed.  We first
...
positive pure-power jump.  Fan's argument gives the repeated two-prime factorisation and its quadratic
reduction to a single Hecke--Mahler value.  The same boundary-channel
calculation also yields the de-duplicated affine formula displayed below
\cite{fan2026comment}.
...
\cite[authors' Online First PDF, p.~3]{bugeaudlaurent2023}:
...
Fan and Lott build their van der Corput coefficients on sums of two squares
by the same kind of regrouping: up to normalisation, the coefficient at $d$
sums a smooth weight over the representations $d=v^2(x^2+y^2)$, and the
average over $v$ keeps the associated complete sums in a fixed sector
\cite[\S3 and Corollary~4.4]{fanlott2026}.
...
set, a phenomenon going back to Eggleston
\cite[\S3 and Lemma~3.1]{fan2026strongly}.  For $g_a=Bh_a$ $(a\ge1)$ the
...
The two-prime argument uses the cited Hecke--Mahler value theorem and is
Steve Fan's; it is not a Lean theorem.
...
\bibitem{bugeaudlaurent2023} Y.~Bugeaud and M.~Laurent,
  ...
  Theorem~1.1 is on p.~3 of the inspected Online First PDF; the journal
  publication is pp.~59--90.  The authors
...
\bibitem{fanlott2026} S.~Fan and A.~Lott,
  \href{https://arxiv.org/abs/2606.29185}{\emph{The van der Corput property
  for sums of two squares}}, arXiv:2606.29185v1, 28~June 2026.  Section~3,
  pp.~4--8, defines the coefficients by summing smooth weights over the
  representations $d=v^2(x^2+y^2)$; pp.~5--6 explain that averaging over $v$
  places the complete sums in a fixed sector, and Corollary~4.4, p.~12,
  proves the sector bound.
\bibitem{fan2026strongly} S.~Fan,
  \href{https://arxiv.org/abs/2607.14071}{\emph{Strongly complete sets and a
