...
finite sample.  For two primes, the paper deduces transcendence of both
running-LCM series from the Hecke--Mahler value theorem of Loxton and van der
Poorten, in the form given by Bugeaud and Laurent.  Steve Fan posted the same
factorisation, reduction and conclusion first, on the problem's forum thread
(erdosproblems.com/269, 26~June~2026, post~7218); the two-prime result is not
formalised in Lean.  The repeated three-prime irrationality question remains
open.
\end{abstract}
...
(Proposition~\ref{res:lcm}); Fan's forum post states this identity for every
finite prime set~\cite{fan2026comment}.
...
\noindent The two clauses are the Lean declarations
\href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/KernelCarryRank.lean#L376}{uniform nonsingular minors}
and
\href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/KernelCarryRank.lean#L388}{no finite separation}.
Those declarations require $p\ne r$ and $q\ne r$, but not $p\ne q$.
The theorem above keeps pairwise distinctness because it is stated for a
three-prime set; allowing $p=q$ gives an extension of the abstract indexed
kernel, not a new three-prime case of the running-LCM problem.
...
\noindent The statement is \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/PaperR7ModularMinors.lean#L133}{admissible modular minors}.
...
\href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/PaperR7BasicAssembly.lean#L102}{two by two fixture}.
...
\noindent The statement is \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/PaperR7FiniteCutRank.lean#L182}{rank cut matrix}.
...
displayed below~\cite{fan2026comment}.  The proof below was found
independently.
...
Let $p,q,r$ be pairwise distinct primes and $x\ge1$.  Then the
\lword{Erdos269/ThreePrimeRunningLcm.lean}{123}{smoothPrefixLcm_eq_threePrimeHeight}{smooth-prefix LCM}
equals the three-prime height: $\Lprefix(x)=\hgt(x)$.
\end{proposition}
\begin{proof}
...
\noindent The statement is \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/ThreePrimeRunningLcm.lean#L124}{smooth prefix lcm equals three-prime height}.
The same definition gives
\begin{equation}\label{res:cube}
 x^3/(pqr)<\hgt(x)\le x^3.
\end{equation}
Both inequalities are \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/PaperR7BasicAssembly.lean#L112}{cubic height bounds}.

\begin{proposition}[smooth-prefix LCM cells]\label{res:cell}
If $x,y\ge1$ lie in the same logarithmic cell, then $\Lprefix(x)=\Lprefix(y)$:
the
\lword{Erdos269/ThreePrimeRunningLcm.lean}{179}{smoothPrefixLcm_eq_of_sameLogCell}{smooth-prefix LCM cell}
is constant.  Advancing exactly one logarithm multiplies the running value
by the corresponding
\lword{Erdos269/ThreePrimeRunningLcm.lean}{326}{smoothPrefixLcm_firstLogStep}{first-channel step},
\lword{Erdos269/ThreePrimeRunningLcm.lean}{339}{smoothPrefixLcm_secondLogStep}{second-channel step}
or
\lword{Erdos269/ThreePrimeRunningLcm.lean}{352}{smoothPrefixLcm_thirdLogStep}{third-channel step}.
The
\lword{Erdos269/ThreePrimeRunningLcm.lean}{278}{threePrimeJumpSetWithOrigin_card}{jump set with the origin},
formed from the first $n$ positive powers in each channel together with $1$,
has cardinality $3n+1$.
\end{proposition}
\begin{proof}
Cell constancy and the three jump ratios follow from
Proposition~\ref{res:lcm}, since the height depends on $x$ only through the
three integer logarithms.  Within one channel the first $n$ positive powers
are distinct; across channels a common value would be a positive power of
two distinct primes; and $1$ is not a positive prime power.
\end{proof}

\begin{proposition}[height-fibre regrouping]\label{res:fibre-prop}
If $F(H)$ is a height fibre in a finite exponent box $\mathcal B$, the
\lword{Erdos269/ThreePrimeRunningLcm.lean}{406}{finiteSmoothKernelSum_groupedByHeight}{height-fibre regrouping}
gives
...
\noindent The regrouping is \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/ThreePrimeRunningLcm.lean#L407}{finite smooth kernel sum grouped by height}.
...
For every $a\ge0$, $m_a$ is a positive integer and the
\lword{Erdos269/ThreePrimeRunningLcm.lean}{699}{dyadicBlockBase235_cases}{four-letter dyadic alphabet}
satisfies $b_a\in\{2,6,10,30\}$.
\end{lemma}
\begin{proof}
...
and the shell contains $2^a$.  Between consecutive two-powers,
\lword{Erdos269/ThreePrimeRunningLcm.lean}{668}{dyadicInternalPower_exponent_unique}{internal-power uniqueness}
leaves at most one three-power and at most one five-power.  Their optional
factors, together with the terminal factor two, give the four radices.
\end{proof}

\noindent Both clauses are \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/PaperR7ActualOrbit.lean#L48}{literal integer forcing and four radices}.
...
and five-exponents.  Each of the latter lies between $0$ and $a$, so the
\lword{Erdos269/ThreePrimeRunningLcm.lean}{646}{smoothExponentShell_card_quadratic}{quadratic shell bound}
gives at most $(a+1)^2$ terms.  By~\eqref{res:cube},
...
All four clauses are \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/PaperR7SeriesIdentification.lean#L168}{short actual orbit}.
...
The criterion below needs only a valid cap, and the bound just proved gives
the cap $90B(a+1)^2$.  The extended reasoning record proves the sharper bound
$X_a\le(n_a^2+8n_a+18)/9$, where $n_a$ is the sum of the three height
exponents at $2^a$.
...
\noindent The statement is \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/PaperR7RationalBridge.lean#L80}{short fixed split bridge}.
...
\noindent The statement is \href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/PaperR7BasicAssembly.lean#L138}{finite endpoint obstruction}.
...
\href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos269/PaperR7WindowResults.lean#L51}{short window equivalence}.
...
The two-prime theorem is an ordinary deduction from the cited Hecke--Mahler
value theorem and has no Lean declaration; Steve Fan posted the same argument
first~\cite{fan2026comment}.
The arbitrary-order kernel theorem is proved in the Lean module
\texttt{KernelCarryRank}: it contains the uniform minors and the exact
finite-separation contradiction used above.  The literal recurrence and the
fixed-split rationality bridge likewise have the named Lean statements linked
at their occurrences above.  The
...
recursive import closure.  The receipt's declaration-by-declaration axiom
audit concerns the named R12 Wave~A results, not these rank declarations.
Comparator separately records the finite $(2,3,5)$ minor $-1/15$, the
running-LCM height identity, and a conditional carry-escape consumer; it is
not the evidence for the arbitrary-order theorem.
The separate public Lean release
\href{https://github.com/wcook04/plectis-erdos-lean/blob/52f29ad173b04e3bac941b3663f2b9aebe5de0bb/PalomarCorpus/E269/Challenge.lean#L487}{\texttt{wcook04/plectis-erdos-lean}}
at commit \texttt{52f29ad1} selects the arbitrary-order theorem itself in
\texttt{PalomarCorpus/E269/Challenge.lean}:
\texttt{exists\_uniform\_nonsingular\_threePrimeKernel\_minor} gives
nonsingular minors of every order, with one index choice valid in every layer
of the third exponent, for bases $p,q,r>1$ with $\log_r p$ and $\log_r q$
irrational, and \texttt{threePrimeKernel\_infiniteRank\_and\_noFiniteSeparation}
gives, for primes $p,q,r$ with $p\ne r$ and $q\ne r$, both those minors and
the absence of a finite separated representation with rational-valued
factors; the $(2,3,5)$ minor is selected beside them as
\texttt{kernel\_235\_minor\_eq\_neg\_one\_fifteen}.  That repository's Linux
replay of Palomar's Comparator stage accepted the entry with the Lean kernel
and with NanoDa
(\href{https://github.com/wcook04/plectis-erdos-lean/actions/runs/34782407633}{run 34782407633}).
Neither selected clause yields irrationality of the sum.
...
The actual-series reduction is given; the source-specific cofinal escape
remains unproved.
