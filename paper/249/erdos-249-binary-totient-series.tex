...
diagonal entries. Lean checks the dyadic rank $2^e+1$ for $e\ge1$.  The all-base rank
$k^e+1$ uses Martin's external independence; Coons owns non-$k$-regularity
...
The dyadic finite-level rank $2^e+1$ ($e\ge1$), residue-series
irrationality, full-depth amplification, canonical equivalence and positive
rank-one floor have proofs in the supplied Lean source snapshot.  The
unconditional all-base exact-rank theorem is not a Lean theorem without
Martin's independence hypothesis:
