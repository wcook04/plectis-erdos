...
argument proves the all-base theorem ordinarily in the note. Lean checks the
dyadic theorem; its current all-base wrapper retains canonical-family
independence as a hypothesis. Martin's theorem supplies a broader external
...
the current all-base Lean wrapper is
...
and retains linear independence of the canonical family as an explicit
hypothesis. Martin's theorem supplies that independence externally; the direct
CRT--Dirichlet proof in Section~\ref{sec:rank} proves precisely the family used
here.
\end{enumerate}
...
unconditional all-base exact-rank theorem is not a Lean theorem without
Martin's independence hypothesis; the formal transfer is
