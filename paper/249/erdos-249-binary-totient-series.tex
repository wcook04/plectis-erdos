...
using Martin's external independence; Coons owns non-$k$-regularity
of $\ph$, equivalently infinite-dimensionality for integer-valued sequence
modules.  A separate ordinary argument treats bounded-residue series $A_m$.
Finite Farey exclusion and Lean diagonal certificates through $t\le 82$ are
finite; neither $t=83$ nor an unbounded family is supplied.
