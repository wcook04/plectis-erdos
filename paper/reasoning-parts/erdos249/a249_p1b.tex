...
For $a\ge8$, assume the longer-window bound $J+K+(a+6)<2\cdot2^a$
and $2H+J+K+2<2^K$.  Integrality of the translated actual orbit forces
\[
...
\lean{CertifiedGreedyMersenneDeath}{GreedyAchievementSet.lean:1754}
\end{obs}
