...
\scale{cofinal}\ \ev{Open}\ \coord{mobius-mersenne}\\
\lean{irrational_totient_series_of_lcm_cone_window_kill_supply}{CertificateKernel.lean:19202}
\end{prop}
...
\scale{cofinal}\ \ev{Open}\ \coord{mobius-mersenne}\\
\lean{irrational_totient_series_of_lcm_cone_nonflat_supply}{CertificateKernel.lean:19328}
\end{prop}
...
\lean{not_irrational_totientSeries_implies_unbounded_carryRank_unconditional}{TotientCarryKernelRigidity.lean:285}
\end{prop}
...
(Prop.~\ref{prop:B7}).
\scale{n/a}\ \ev{Lean}\ \coord{mobius-mersenne}\\
\lean{rational_totient_series_forces_lcm_cone_flatness}{CertificateKernel.lean:19190}
\end{prop}
...
\lean{tsum_totient_div_pow_two_eq_pnat_half_pow}{CertificateKernel.lean:18603}
\end{prop}
...
\lean{positive_rational_difference_lower_bound}{PrimitiveRationalGapSupply.lean:32}
\end{prop}
...
\lean{totient_tail_rank_two_kill_sound_but_not_shallower_cell}{CertificateKernel.lean:19278}
\end{obs}
...
\lean{CertifiedGreedyMersenneDeath}{GreedyAchievementSet.lean:1741}
\end{obs}
