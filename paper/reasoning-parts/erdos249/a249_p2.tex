...
\item[p-adic] Fixed and growing 2-adic valuation-unit dynamics:\newline the adelic height/denominator-tax
...
(\[\adjustbox{max width=\linewidth}{$\displaystyle 2^r\mid|x.\mathrm{num}|\wedge x<2/(2^n-1)\Rightarrow 2^r(2^n-1)<2\cdot x.\mathrm{den}$}\]) is exactly
