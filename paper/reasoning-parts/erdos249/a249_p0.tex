...
\lean{Farey interval bound}{GapFareyBound.lean:51}
\end{lem}
...
$}\]
This bound is \emph{sharp}: $q = Q_0+1 = 79\,\allowbreak 639\,\allowbreak 646\,\allowbreak 646\,\allowbreak 701\,\allowbreak 375\,\allowbreak 323\,\allowbreak 355\,\allowbreak 774\,\allowbreak 875\,\allowbreak 831\,\allowbreak 054$
...
\lean{Farey certificate through the stated denominator bound}{GapFareyBound.lean:176}
...
\lean{visible coprime-pair series equals the totient series}{CertificateKernel.lean:18544}
\lean{visible coprime-pair decomposition of the totient series}{CertificateKernel.lean:18557}
\end{prop}
...
\lean{coprime reciprocal-Mersenne sum identity}{GcdMomentCalculus.lean:349}
\lean{joint-divisibility sum identity}{GcdMomentCalculus.lean:266}
\end{prop}
...
\coord{farey} \scale{bounded} \ev{Lean}
\lean{denominator exclusion for the visible coprime-pair series}{CertificateKernel.lean:18572}
\end{thm}
...
is not equal to $a/d$.
\coord{farey} \scale{bounded} \ev{Lean}
\lean{denominator exclusion for the squared Mobius--Mersenne series}{CertificateKernel.lean:18487}
\end{thm}

\begin{rem}[Why the bound halves, and why this is not new information]
$Q_1 = \lfloor Q_0/2 \rfloor$ arithmetically: $Q_0$ is odd
($Q_0 = 79\,\allowbreak 639\,\allowbreak 646\,\allowbreak 646\,\allowbreak 701\,\allowbreak 375\,\allowbreak 323\,\allowbreak 355\,\allowbreak 774\,\allowbreak 875\,\allowbreak 831\,\allowbreak 053$), so
$Q_0/2 = 39\,\allowbreak 819\,\allowbreak 823\,\allowbreak 323\,\allowbreak 350\,\allowbreak 687\,\allowbreak 661\,\allowbreak 677\,\allowbreak 887\,\allowbreak 437\,\allowbreak 915\,\allowbreak 526.5$ and
...
\lean{positive-natural half-power form of the totient series}{SquaredMersenneDiagonalEnclosure.lean:72}
\lean{Mobius-square decomposition of the totient series}{MersenneLambertLadder.lean:665}
\end{prop}
...
(\lean{irrationality of the Erdos--Borwein series}{CertificateKernel.lean:8335}, \ev{Lean}).
...
\lean{near-integer multiplier criterion for irrationality}{CertificateKernel.lean:6120} and its
base-power specialisation
\lean{near-integer power-multiplier criterion for irrationality}{CertificateKernel.lean:6149}, both
...
\lean{linear-weight Lambert square identity}{GcdMomentCalculus.lean:105}
\end{prop}
...
\lean{reciprocal Mersenne-square divisor-sum identity}{GcdMomentCalculus.lean:216}
\end{prop}
...
\coord{mobius-mersenne} \scale{n/a}
\lean{totient-weighted Mersenne-square gcd-moment identity}{GcdMomentCalculus.lean:235}
\end{prop}
...
(\lean{dyadic window discrepancy}{TotientTailPeriodKiller.lean:66}, \ev{Lean}), and
\[\adjustbox{max width=\linewidth}{$\displaystyle
\mathrm{Sep}(h,N,L) \;:\equiv\; (N+h+L+2) < \Delta_{h,N,L} \bmod 2^{L} < 2^{L}-(N+h+L+2),
$}\]
(\lean{certified interior residue}{TotientTailPeriodKiller.lean:72}, \ev{Lean}, decidable). By
completeness (\lean{certificate existence characterizes tail nonintegrality}{LcmConeFlatness.lean:316},
...
\small
\begin{longtable}{p{0.16\linewidth} p{0.39\linewidth} p{0.15\linewidth} p{0.14\linewidth}}
...
\scale{fixed}
&
\lean{simultaneous certificate check for small shifts}{TotientTailPeriodKiller.lean:404}
\lean{denominator-divisibility exclusion}{TotientTailPeriodKiller.lean:416}
\\
...
\scale{fixed}
&
\lean{denominator exclusion through the first sixteen Mersenne factors}{CertificateKernel.lean:18890}
\\
...
\scale{fixed}
&
\lean{imported diagonal certificates}{DiagonalPincerCertificates.lean:2870}
\lean{diagonal certificate scales}{DiagonalPincerCertificates.lean:2852}
\lean{diagonal certificate depths}{DiagonalPincerCertificates.lean:2854}
\\
...
\lean{depth-64 diagonal certificate}{DiagonalPincerCertificateT64Endpoint.lean:1928}
\\
...
\scale{bounded}
&
\lean{rung-67 diagonal certificate within depth 82}{ErdosProblems/Skip/LadderT67.lean:71264}
\lean{rung-83 certificate depth floor}{ErdosProblems/Skip/LadderT67.lean:71294}
\\
Farey denominator floor
&
Every $q\in\mathbb{N}$ with $0<q\le Q_0=79\,\allowbreak 639\,\allowbreak 646\,\allowbreak 646\,\allowbreak 701\,\allowbreak 375\,\allowbreak 323\,\allowbreak 355\,\allowbreak 774\,\allowbreak 875\,\allowbreak 831\,\allowbreak 053$
...
&
Every $d\in\mathbb{N}$ with $0<d\le Q_1=39\,\allowbreak 819\,\allowbreak 823\,\allowbreak 323\,\allowbreak 350\,\allowbreak 687\,\allowbreak 661\,\allowbreak 677\,\allowbreak 887\,\allowbreak 437\,\allowbreak 915\,\allowbreak 526$
