...
This \emph{one-sided} inequality excludes the upper endpoint arc forced
by an integral orbit under the stated window and room bounds.
The sign input is the unconditional positivity statement: for $a\ge8$ and
$J+(a{+}6)<2\cdot2^a$,
\[
  0 < R_{2H+J}-R_{H+J}
\]
...
\lean{Erdos249257.linearIndependent_canonicalTotientKernelFamily}{TotientMahlerDefect.lean:946}
...
\]
\lean{Erdos249257.not_irrational_totientSeries_implies_unbounded_carryRank_unconditional}{TotientCarryKernelRigidity.lean:301}
\quad \ev{Lean} \quad \scale{uniform} \quad \coord{other:carry-kernel-rank}.
...
span:
\lean{Erdos249257.not_finiteDimensional_span_fullTotientKernel}{TotientMahlerDefect.lean:1146}
\quad \ev{Lean}.
