...
large power of \(2\)).
\end{thm}
\lean{linearIndependent\_canonicalTotientKernelFamily}{TotientMahlerDefect.lean:946}; consequently the full
infinite family spans an infinite-dimensional \(\mathbb Q\)-space,
\lean{not\_finiteDimensional\_span\_fullTotientKernel}{TotientMahlerDefect.lean:1146}. A companion
