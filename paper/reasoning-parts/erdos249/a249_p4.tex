...
\href{https://doi.org/10.5802/jtnb.718}{Coons, Theorem~3.2} had already
excluded for every base $k\ge2$ \ev{Cited}.
...
(\href{https://arxiv.org/abs/1511.07535}{Coons, Theorem~1, Proposition~4 and
Corollary~7}) \ev{Cited}.  The totient is not regular, so that theorem does not
...
slopes (\href{https://arxiv.org/abs/math/0603053}{Martin, Theorem~1})
