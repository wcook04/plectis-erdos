...
The single most important structural fact about the corpus is that
\emph{everything unconditional and quantitative sits on the fixed or bounded
side, while $\mathrm{Sep}$ is cofinal}. Theorem~\ref{thm:gamma} says that gap
is one of kind and not of degree: no accumulation of bounded verification, at
any bound, is evidence that the cofinal statement holds. Read every result's
\texttt{scale} tag before reading its content.
