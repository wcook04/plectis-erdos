...
If $H$ and $r$ are both even, \[\adjustbox{max width=\linewidth}{$\displaystyle \mathrm{diagonalHeightIncrement}(2H,2r) =
2\cdot\mathrm{diagonalHeightIncrement}(H,r)$}\]; if $H$ is even and $r$ odd, the
same doubled height increment equals \[\adjustbox{max width=\linewidth}{$\displaystyle \mathrm{diagonalHeightIncrement}(H,r)$}\]
unchanged.
...
The newly published \texttt{\breakcode{ErdosProblems/Erdos249/CyclotomicAnchoredKill.lean}}
(3222 lines, namespace \texttt{\breakcode{ErdosProblems.Erdos249.CyclotomicAnchoredKill}})
