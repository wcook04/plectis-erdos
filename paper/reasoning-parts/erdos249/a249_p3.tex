...
(\lean{certificate supply implies irrationality}{TotientTailPeriodKiller.lean:394}), is the
...
\lean{weighted window discrepancy}{TotientTailPeriodKiller.lean:66}. For $h,N,L\in\mathbb N$,
\[\adjustbox{max width=\linewidth}{$\displaystyle
...
(\lean{local totient tail}{TotientTailPeriodKiller.lean:57}).
\end{defn}

\begin{defn}[Certified kill]
\lean{certified residue gap}{TotientTailPeriodKiller.lean:72}.
\[\adjustbox{max width=\linewidth}{$\displaystyle
...
of $0$. \lean{necessary certificate depth}{TotientTailPeriodKiller.lean:79} records the necessary
room condition this forces: $2(N{+}h{+}L{+}2) < 2^L$.
\end{defn}

\begin{defn}[First-harmonic real and complex characters]
\lean{first-harmonic cosine}{FirstHarmonicGap.lean:27} and
\lean{first-harmonic character}{FirstHarmonicPivot.lean:38}:
\[\adjustbox{max width=\linewidth}{$\displaystyle
...
$}\]
\lean{real-part identity for the first harmonic}{FirstHarmonicPivot.lean:42} records $\mathrm{Re}(\mathtt{windowFirstExp})
= \mathtt{windowFirstCos}$ and \lean{unit-modulus first harmonic}{FirstHarmonicPivot.lean:48} that
...
\label{thm:hgap-real}
\lean{block harmonic gap produces a certificate}{FirstHarmonicGap.lean:128}. \ev{Lean}.
...
\lean{subset harmonic gap produces a certificate}{FirstHarmonicGap.lean:104}.
...
\label{thm:hgap-norm}
\lean{norm gap produces a certificate}{FirstHarmonicPivot.lean:53} and
\lean{norm-gap supply implies irrationality}{FirstHarmonicPivot.lean:83}.
...
\lean{certificate supply implies irrationality}{TotientTailPeriodKiller.lean:394}.
\end{thm}
...
supply: \lean{two-point subset instantiation}{AdjacentPhaseSeparation.lean:267} instantiates $T$ as
...
\lean{arbitrary-subset instantiation}{PivotAntiReconstruction.lean:882} and
\lean{singleton subset instantiation}{PivotAntiReconstruction.lean:1572} use, respectively, an
...
algebra in \lean{prime-pivot construction}{FirstHarmonicPivot.lean} already sets up via
...
(\lean{positive actual LCM tail orbit}{TotientActualLcmOrbitSign.lean:144}).
\end{defn}

\begin{thm}
\lean{positive shifted LCM tail difference}{TotientActualLcmOrbitSign.lean:39} and
\lean{positive actual LCM tail orbit}{TotientActualLcmOrbitSign.lean:144}. \ev{Lean}. \scale{uniform}.
...
\lean{positivity of every short LCM-ray letter}{TotientActualLcmOrbitArithmetic.lean:1703} and
\lean{LCM-height bound from one arithmetic letter}{TotientActualLcmOrbitArithmetic.lean:1906}.
\end{thm}
...
\lean{integrality forces a top-edge residue}{TotientActualLcmOrbitSign.lean:211} proves that,
under integrality, the consequence is not a kill but the opposite: the residue is forced to the
\emph{top edge}, exactly $2^K - e$ where $e$ is the true carry orbit (\lean{true carry orbit}{CarrySurvivorExtinction.lean:387}). So the
...
\lean{top-edge gap excludes integral tail differences}{TotientActualLcmTopEdgeStaircase.lean:1260},
\lean{top-edge gap excludes an integral tail orbit}{TotientActualLcmTopEdgeStaircase.lean:1314},
\lean{top-edge gap supply implies irrationality}{TotientActualLcmTopEdgeStaircase.lean:2184}.
...
\lean{cofinal top-edge residue-gap supply}{TotientActualLcmTopEdgeStaircase.lean:1325}.
...
\lean{terminal-letter characterization of the top-edge gap}{TotientActualLcmTopEdgeStaircase.lean:909} further
...
\lean{cofinal top-edge residue-gap supply}{TotientActualLcmTopEdgeStaircase.lean:1325} in the
...
\begin{enumerate}[leftmargin=*]
  \item \lean{cofinal adjacent-suffix midband supply}{TotientActualLcmTopEdgeStaircase.lean:1334}
    (\ev{Open}, \scale{cofinal}):
    \[\adjustbox{max width=\linewidth}{$\displaystyle
  ...
  \item \lean{cofinal guarded half-word band supply}{TotientActualLcmTopEdgeStaircase.lean:1349}
    ...
    $1/32$ central band.''
  \item \lean{cofinal final centered-magnitude supply}{TotientActualLcmTopEdgeStaircase.lean:1471}
    (\ev{Open}, \scale{cofinal}), \emph{proved equivalent} to the previous one via
    \lean{half-word band iff centered magnitude}{TotientActualLcmTopEdgeStaircase.lean:1479}:
    \[\adjustbox{max width=\linewidth}{$\displaystyle
    ...
    $}\]
  \item \lean{flexible centered-magnitude supply}{TotientActualLcmTopEdgeStaircase.lean:1927}
  ...
  \item \lean{flexible terminal-dominance supply}{TotientActualLcmTopEdgeStaircase.lean:1908}
...
\lean{cofinal top-edge residue-gap supply}{TotientActualLcmTopEdgeStaircase.lean:1325} (chain:
midband $\to$ residue-gap at \lean{midband supply yields the top-edge gap}{TotientActualLcmTopEdgeStaircase.lean:2108}; half-word-band
$\to$ midband at \lean{guarded half-word band yields the midband}{TotientActualLcmTopEdgeStaircase.lean:2057}; final-magnitude
$\Leftrightarrow$ half-word-band at \lean{half-word band iff centered magnitude}{TotientActualLcmTopEdgeStaircase.lean:1479};
flexible-magnitude $\to$ midband at \lean{flexible magnitude yields the midband}{TotientActualLcmTopEdgeStaircase.lean:2007};
final-magnitude $\to$ flexible-magnitude at \lean{final magnitude yields flexible magnitude}{TotientActualLcmTopEdgeStaircase.lean:1991}).
\end{prop}
...
\begin{defn}
\lean{flexible terminal-dominance supply}{TotientActualLcmTopEdgeStaircase.lean:1908}.
...
\begin{thm}[Consumer]
\lean{terminal dominance excludes an integral tail orbit}{TotientActualLcmTopEdgeStaircase.lean:1880}
and
\lean{terminal-dominance supply implies irrationality}{TotientActualLcmTopEdgeStaircase.lean:2221}.
...
\lean{exact centered-lift and carry identity}{TotientActualLcmTopEdgeStaircase.lean:1678}.
...
But SGN-02
(\lean{positive true-carry corridor}{TotientActualLcmOrbitSign.lean:172}, \ev{Lean},
...
\lean{carry-corridor escape excludes an integral tail orbit}{TotientActualLcmTopEdgeStaircase.lean:1824}
...
magnitude form \lean{flexible centered-magnitude supply}{TotientActualLcmTopEdgeStaircase.lean:1927}
...
(\lean{magnitude supply yields carry-corridor escape}{TotientActualLcmTopEdgeStaircase.lean:1938})
...
\begin{thm}
\lean{explicit actual-LCM approximation error}{TotientActualLcmOrbitSeparation.lean:141} and
\lean{orbit-separation supply implies irrationality}{TotientActualLcmOrbitSeparation.lean:305}.
...
$a=4$ and $a=6$
(\lean{nonintegrality at LCM exponents four and six}{TotientActualLcmShortKill.lean:35}, \ev{Cert},
\scale{fixed}, via \lean{diagonal certificate at scale sixteen}{DiagonalPincerCertificates.lean:2842} and
\lean{diagonal certificate at scale sixty-four}{DiagonalPincerCertificateT64Endpoint.lean:1928}). Nothing beyond
...
\begin{thm}
\lean{short arithmetic kills through exponent six}{TotientActualLcmShortKill.lean:54}
and
\lean{short-kill supply implies irrationality}{TotientActualLcmShortKill.lean:63}.
...
$\langle$\texttt{\breakcode{6, 93, ha0, by norm\_num, lcmDiagonalArithmeticKill\_two\_pow\_six}}$\rangle$ --- a single
hard-coded witness $(a,L)=(6,93)$, itself discharged from
\lean{diagonal certificate at scale sixty-four}{DiagonalPincerCertificateT64Endpoint.lean:1928} (a
...
that window is a bare prime power, by \texttt{\breakcode{eq\_prime\_pow\_of\_not\_dvd\_periodLcm}} --- so this
...
\begin{thm}
\lean{imported diagonal certificate family}{DiagonalPincerCertificates.lean:2870}, with
\lean{certified diagonal scales}{DiagonalPincerCertificates.lean:2852} and
\lean{diagonal certificate depths}{DiagonalPincerCertificates.lean:2854}. \ev{Cert}. \scale{fixed}.
\[\adjustbox{max width=\linewidth}{$\displaystyle
...
\lean{diagonal certificate at scale sixty-four}{DiagonalPincerCertificateT64Endpoint.lean:1928}).
The later aggregate theorem closes every scale $t\le82$ with no holes
(\lean{bounded diagonal-kill witness}{ErdosProblems/Skip/LadderT67.lean:71264}).
Every witness
...
\lean{necessary certificate depth}{TotientTailPeriodKiller.lean:79} forces $2(2H_t{+}L{+}2)<2^L$,
...
\begin{thm}
\lean{simultaneous certificates through period sixteen}{CarrySurvivorExtinction.lean:574} and
\lean{denominator-restricted rational exclusion through sixteen}{CertificateKernel.lean:18890}
(shallower sibling \lean{simultaneous small-period certificates}{TotientTailPeriodKiller.lean:404}). \ev{Cert}.
\scale{fixed}.
\[\adjustbox{max width=\linewidth}{$\displaystyle
...
\begin{thm}
\lean{certified finite-denominator exclusion}{CertificateKernel.lean:18384},
built from the classical mediant lemma \lean{Farey-neighbour gap bound}{GapFareyBound.lean:51} and the window
sharpness certificate \lean{sharp Farey window certificate}{GapFareyBound.lean:176}
/ \lean{first failure beyond the certified Farey window}{GapFareyBound.lean:225}. \ev{Lean} for the general
...
\lean{first failure beyond the certified Farey window}{GapFareyBound.lean:225} establishes that the $K=240$
...
\lean{reduced-denominator unit-gap certificate}{PrimitiveWeightCertificate.lean:30} and
\lean{primitive unit-gap supply}{PrimitiveWeightCertificate.lean:47}, the corpus's
own attempt at strengthening this window refinement via a unit-modulo-odd-part criterion, prove a
hard ceiling in
\lean{prime-power characterization of unit-gap certificates}{PrimitiveWeightCertificate.lean:54} and
\lean{at most one prime-power candidate}{PrimitiveWeightCertificate.lean:111}
...
\begin{thm}
\lean{prime construction with prescribed totient divisors}{TotientTwoAdicPulseBlock.lean:54},
\lean{prime producing a totient half-pulse}{TotientTwoAdicPulseBlock.lean:211},
\lean{half-turn window congruence}{TotientTwoAdicPulseBlock.lean:262},
\lean{integrality forces cofinal half-pulses}{TotientTwoAdicPulseBlock.lean:327}.
...
\lean{cofinal strict LCM jumps}{DiagonalFreshLossBridge.lean:2635}. \ev{Lean}.
...
\lean{power-of-two post-jump slack supply}{DiagonalFreshLossBridge.lean:2693} shows
...
\lean{centered adjacent-suffix slack}{DiagonalFreshLossBridge.lean:2651}:
\[\adjustbox{max width=\linewidth}{$\displaystyle
...
\lean{post-jump central-slack supply}{DiagonalFreshLossBridge.lean:2686} (any strict
jump) and \lean{power-of-two post-jump slack supply}{DiagonalFreshLossBridge.lean:2693}
...
\lean{post-jump slack supply implies irrationality}{DiagonalFreshLossBridge.lean:2941}
and
\lean{power-of-two slack supply implies irrationality}{DiagonalFreshLossBridge.lean:2948}.
\end{defn}
...
(\lean{prime-power structure of strict LCM jumps}{DiagonalFreshLossBridge.lean:2332}) says a
...
\lean{slack constancy on LCM plateaux}{DiagonalFreshLossBridge.lean:2658}
...
\begin{thm}
\lean{sharp prime-jump exclusion radius}{PrimeJumpWindow.lean:37} and
\lean{sharp residue kill excludes an integral commutator}{PrimeJumpWindow.lean:178}. \ev{Lean}.
...
\lean{explicit 12-to-5 prime-jump kill}{PrimeJumpWindow.lean:186}. \ev{Cert}. \scale{fixed}.
...
\lean{prime-jump supply implies irrationality}{PrimeJumpWindow.lean:193}.
\end{thm}
...
\texttt{\breakcode{rational\_totient\_series\_forces\_lcm\_cone\_flatness}}$\to$contradiction, the natural
...
\lean{affine annihilation of old channels}{JointExponentTransport.lean:36}.
\end{rem}

\subsubsection{b7 --- the M\"obius--Mersenne denominator channel: unbounded, but off-coordinate (\coord{mobius-mersenne})}

\begin{thm}
\lean{exponential lower bound for the upper-half Mersenne product}{MersenneShadowDenominatorGrowth.lean:60},
\lean{denominator growth of the scaled Mobius shadow}{MersenneShadowDenominatorGrowth.lean:85},
\lean{surviving Mersenne denominator channel}{MersenneShadowDenominatorGrowth.lean:99}.
...
(\texttt{\breakcode{scaleFullTarget\_miss\_of\_lambert\_projected\_separation}},
\texttt{\breakcode{scaleFullTarget\_miss\_of\_lambert\_projected\_num\_gap}}) are \#257-facing
(\texttt{ScaleFullTargetHit}), not \#249-facing.
\end{rem}

\begin{prop}[What would close it]
Either (i) a Dirichlet-criterion bridge in the shape of
\lean{denominator-error irrationality criterion}{CertificateKernel.lean:5371}: a sequence of
...
\begin{thm}
\lean{linear independence of the dyadic totient kernels}{TotientMahlerDefect.lean:935}. \ev{Lean}.
...
\begin{thm}
\lean{rationality forces exponential carry rank}{TotientCarryKernelRigidity.lean:300}.
...
to it is dead:
\lean{impossibility of a compressed adjoint certificate}{TotientMahlerDefect.lean:1183} (\ev{Lean},
\scale{n/a}) shows no
\lean{compressed adjoint certificate}{TotientMahlerDefect.lean:1171} ($Q\cdot v\cdot A = $ boundary
with $|\mathrm{boundary}| < Q\cdot v$ and $A\ne 0$) can exist, and
\texttt{\breakcode{not\_finiteDimensional\_span\_fullTotientKernel}} (immediately above it in the same file)
...
\texttt{\breakcode{not\_irrational\_totientSeries\_implies\_mod\_period\_and\_unbounded\_rank}}
