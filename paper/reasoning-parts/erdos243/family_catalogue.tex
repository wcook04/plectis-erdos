...
\textbf{Result-atom population.} 32 of 681 public coordinates. The public atom catalog groups them under this family.
...
\textbf{Result-atom population.} 36 of 681 public coordinates. The public atom catalog groups them under this family.
...
\textbf{Reader position.} 15 of 70; display band: major result.  Formal editorial disposition: promote.  These are separate classifications.

\textbf{Reader entry.} Normalised vanishing excludes a cofinally bounded negative part and forces eventual Sylvester behaviour.
...
\textbf{Reader position.} 26 of 70; display band: mechanism.  Formal editorial disposition: merge.  These are separate classifications.

\textbf{Reader entry.} A bounded-rise sequence cannot remain coprime to fresh pairwise-coprime moduli; reduced tails inherit this obstruction.
...
\textbf{Reader position.} 49 of 70; display band: frontier.  Formal editorial disposition: promote.  These are separate classifications.

\textbf{Reader entry.} Constant, eventually constant, periodic, and eventually periodic negative-error orbits are excluded in their stated regimes.
