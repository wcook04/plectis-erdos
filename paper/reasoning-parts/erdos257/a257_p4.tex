...
built from
\lean{centred completion of one valuation-unit step}{TropicalCurvatureCarry.lean:69}
and
\lean{prefix-locked completion of a valuation-unit word}{TropicalCurvatureCarry.lean:115}.
...
\lean{two-sided dyadic seam escape criterion}{HalfCylinderMiddleCarryLowerBound.lean:4374}
...
\]
\lean{upper-branch remainder bound}{HalfCylinderMiddleCarryLowerBound.lean:3924}
(from
\lean{upper-branch reset-charge identity}{HalfCylinderMiddleCarryLowerBound.lean:3542},
...
\lean{landing excess at most two after one middle step}{HalfCylinderMiddleCarryLowerBound.lean:2319}
...
(\lean{eventually-right upper competitor exceeds one half}{HalfCylinderFatalGapRightTail.lean:627}),
hence the producer carry is strictly below its complete future incidence tail
(\lean{an all-right middle producer forces carry below the tail}{HalfCylinderMiddleCarryLowerBound.lean:1814});
...
(\lean{an all-right middle producer stays below the take threshold}{HalfCylinderMiddleCarryLowerBound.lean:1869});
...
(\lean{middle-producer cardinality escape criterion}{HalfCylinderMiddleCarryLowerBound.lean:279},
\lean{middle-producer row escape criterion}{HalfCylinderMiddleCarryLowerBound.lean:1769}) with
...
\lean{middle-producer cardinality escape implies half membership}{HalfCylinderMiddleCarryLowerBound.lean:2364}.
...
\lean{unbounded fanout of balanced pulses}{GenericTailOrbitRigidity.lean:237}).
...
least $1/63$.
\lean{negative-Mobius mass exceeds one half}{MobiusSignSupportNoGo.lean:164}
(exact decomposition at
\lean{decomposition of the negative-Mobius mass}{MobiusSignSupportNoGo.lean:111}).
...
denominator.
\lean{finite Boolean supports cannot equal one half}{HalfCarryReachability.lean:589}. Separately,
...
\lean{certified exclusion of three quarters}{GreedyAchievementSet.lean:1778}), and this
...
\lean{certified greedy-death witness}{GreedyAchievementSet.lean:1756}.
...
period $h_0$
(\lean{multiple-survivor supply implies irrationality}{CarrySurvivorExtinction.lean:491}),
and this collapses onto the single $\mathbb N$-indexed family $\mathrm{periodLcm}(t)=\mathrm{lcm}(1,\ldots,t)$
(\lean{LCM-survivor supply implies irrationality}{CarrySurvivorExtinction.lean:540}).
Concrete unconditional deposit: every period $h\le16$ is machine-checked dead at $(N,L)=(14,9)$
(\lean{denominator exclusion through the first sixteen factors}{CarrySurvivorExtinction.lean:587}).
...
\]
\lean{localization-complement divisibility}{AdelicHeightObstruction.lean:23}.
...
\lean{integer localization numerator identity}{AdelicHeightObstruction.lean:56}.
...
(\lean{denominator divisibility under an integral quotient}{RationalDenominatorSurvival.lean:17})
...
prefix LCM.
\lean{positive-rational Mersenne height}{AdelicHeightObstruction.lean:103}
(generic form
\lean{numerator-divisor height bound}{AdelicHeightObstruction.lean:77}).
...
\]
\lean{upper-reset dyadic-band escape criterion}{HalfCylinderMiddleCarryLowerBound.lean:4566}.
...
\lean{critical-index characterization of dyadic-band escape}{HalfUpperResetCriticalBand.lean:108}
(seam specialisation
\lean{critical-band characterization of upper-reset escape}{HalfUpperResetCriticalBand.lean:883}).
