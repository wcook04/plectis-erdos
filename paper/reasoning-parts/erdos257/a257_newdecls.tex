...
\]
\end{prop}
(\lean{seamMiddleCoordinate\_not\_safe\_iff\_three\_cells}{HalfCylinderMiddleCarryLowerBound.lean:4400},
...
(\lean{seamMiddleCell\_four\_mul\_floorZ\_le}{HalfCylinderMiddleCarryLowerBound.lean:4758}, \ev{Lean}),
...
(\lean{seamMiddleCell\_scaledRationalRemainder\_le}{HalfCylinderMiddleCarryLowerBound.lean:4783},
...
$4k<\mathrm{abovePulse}$ (\lean{seamRightPulseLeak\_iff\_distanceCell}{HalfCylinderMiddleCarryLowerBound.lean:4818},
...
(\lean{seamPureHalfPrefixRemainder}{HalfCylinderMiddleCarryLowerBound.lean:4848}), is given an exact
case-split closed form (\lean{seamPureHalfPrefixRemainder\_eq\_ite}{HalfCylinderMiddleCarryLowerBound.lean:4854},
...
\lean{seamPureHalfPrefixRemainder\_le\_iff\_twoSided}{HalfCylinderMiddleCarryLowerBound.lean:4972} (\ev{Lean}).
...
\lean{seamUpperReset\_band\_iff\_successorRemainder\_avoids}{HalfCylinderMiddleCarryLowerBound.lean:5085}
(\ev{Lean}) rewrites the reset-charge band as a successor-remainder avoidance; the identity
\lean{upperResetCharge\_dyadicDistance\_add\_abovePulse}{HalfCylinderMiddleCarryLowerBound.lean:5106}
(\ev{Lean}) rescales it by a factor of $4$; and
\lean{seamUpperReset\_band\_of\_overshoot\_band}{HalfCylinderMiddleCarryLowerBound.lean:5130} (\ev{Lean})
...
(\lean{seamUpperResetDyadicBandEscape\_at\_thirteen}{HalfCylinderMiddleCarryLowerBound.lean:5163},
...
(\lean{exists\_infinite\_support\_half\_of\_cofinalCylinderStages}{SuffixCylinderTerminalOnlyBridge.lean:303},
...
(\lean{exists\_infinite\_positive\_support\_half\_of\_cofinalCylinderStages}{SuffixCylinderTerminalOnlyBridge.lean:313},
...
(\lean{UniversalMersenneSubseriesIrrationality}{ErdosProblems/Erdos257/HalfCounterexampleFrontier.lean:35}) and gives it a
...
(\lean{exists\_rational\_half\_counterexample\_of\_terminalScaledVanishing}{ErdosProblems/Erdos257/HalfCounterexampleFrontier.lean:40},
\ev{Lean}), hence refutes $\mathrm{U257}$ outright
(\lean{not\_universal\_of\_terminalScaledVanishing}{ErdosProblems/Erdos257/HalfCounterexampleFrontier.lean:48}, \ev{Lean}). The
...
\]
for every finite $F$
(\lean{finiteErdosSum\_ne\_one\_div\_twenty\_one}{ErdosProblems/Erdos257/HalfCounterexampleFrontier.lean:1041}, \ev{Lean},
