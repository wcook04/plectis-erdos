...
escape of Problem~\ref{prob:escape} holds.
  The statement is checked in Lean: \lean{cofinal_escape_of_finite_truncation}{ErdosProblems/Erdos251/PaperTailBoundsR7.lean:261}.
\end{proposition}
...
$\sum_{j\ge1}a_{N+j}2^{-j}$ equals the integer $U_N$.
  The statement is checked in Lean: \lean{bounded_recurring_values_countermodel}{ErdosProblems/Erdos251/PaperBoundedCarryR7.lean:179}.
\end{proposition}
