...
\author{Will Cook}
\date{July 2026; revised September 2026}
...
\noindent Corollary~\ref{res:originalbounded} is an ordinary transfer of the
integer-state theorem below, proved in Section~\ref{sec:transfer}.  The analytic transfer is separate from the linked Lean theorem.
The separate public Lean release
\href{https://github.com/wcook04/plectis-erdos-lean/blob/52f29ad173b04e3bac941b3663f2b9aebe5de0bb/PalomarCorpus/E243/Challenge.lean#L116}{\texttt{wcook04/plectis-erdos-lean}}
at commit \texttt{52f29ad1} states Corollary~\ref{res:originalbounded}
itself, with the defect bounded above from some index onward, as
\texttt{original\_coordinate\_bounded\_defect} in
\texttt{PalomarCorpus/E243/Challenge.lean} and proves it.  That repository's
...
and applies the
\lword{Erdos243/ReciprocalTailRigidity.lean}{2265}{boundedNegativePart_eventually_zero}{bounded-negative-part rigidity},
...
The identities below are algebraic consequences of Koizumi's state recurrence
\cite[Lemmas~2--4, pp.~10--12]{koizumi2025}.  In his coordinates the absorption
of Theorem~\ref{res:absorb} is his Lemma~3 \cite[p.~10]{koizumi2025}, and the
nonnegative-error descent is his Proposition~1(2) \cite[p.~14]{koizumi2025},
which he attributes to Badea \cite[Corollary~2.2, p.~316]{badea1993}.  The
conventions here are those of the formalisation.
...
and the
\lword{Erdos243/ReciprocalTailRigidity.lean}{1769}{sylvesterDefect_mul_nextTailState}{defect identity}.
...
\lword{Erdos243/ReciprocalTailRigidity.lean}{2221}{centeredState_zero_absorbing}{absorption of a vanishing centred state}
and
\lword{Erdos243/ReciprocalTailRigidity.lean}{1837}{centeredState_eventually_zero}{stabilisation of the nonnegative error}.
...
\lword{Erdos243/ReciprocalTailRigidity.lean}{1781}{sylvesterNext_eq_of_centered_zero}{local rigidity step}
and the
...
\lword{Erdos243/ReciprocalTailRigidity.lean}{983}{reducedStep_coprime_currentFactor}{step coprimality},
the
\lword{Erdos243/ReciprocalTailRigidity.lean}{1010}{reducedTail_pairwiseCoprime}{pairwise coprimality},
and the
\lword{Erdos243/ReciprocalTailRigidity.lean}{1024}{reducedTail_wholeModulusAvoidance}{whole-modulus avoidance}.
...
\lword{Erdos243/ReciprocalTailRigidity.lean}{1630}{tailGcd_eventuallyConstant_of_cofinally_boundedNegative}{gcd stabilisation}.
...
\lword{Erdos243/ReciprocalTailRigidity.lean}{1060}{no_eventuallyBoundedRise_reducedTail}{eventual reduced exclusion}.
With normalised vanishing the same obstruction is the
\lword{Erdos243/ReciprocalTailRigidity.lean}{1748}{no_cofinallyBoundedNegative_of_normalizedVanishes}{exclusion from normalised vanishing}.
...
The LCM coordinates below also appear in Bado's preprint of September 2026:
with his denominator parameter equal to $q$, his $M_{n-1}$, $\Delta_{n-1}$,
$K_{n-1}$, $u_n$ and $g_n$ are the $L_n$, $M_n$, $U_n$, $V_n$ and $\rho_n$
defined here, and his~(19) is the update $\rho_nU_{n+1}=U_n-V_n$
\cite[Prop.~7.1 and (16)--(20), pp.~6--7]{bado2026}; the contraction at a
reuse step is his~(34) \cite[p.~9]{bado2026}.
...
\href{https://github.com/wcook04/plectis-erdos/blob/f4e61ed8a6941571310049e22dc239baa1b04e12/lean/ErdosProblems/Erdos243/PaperCompleteR7/LcmDefect.lean#L49}{the original-coordinate LCM bounded defect}.
...
\href{https://github.com/wcook04/plectis-erdos/blob/eccd8afc6db3c02a2265d0601b727d6c5e4467d5/lean/ErdosProblems/Erdos243/WeightedRecordOctupleCriteria.md\#8-rising-factorial-cubic-profiles-and-the-cubic-rate-irrationality-r08}
...
would force its degree to equal $\lambda$. These rates fall outside $1+o(1/n)$, the rate at which
...
\end{problem}
\noindent The canonical necessary profile is ordinary in this note, and Lean
checks it as
\href{https://github.com/wcook04/plectis-erdos/blob/f4e61ed8a6941571310049e22dc239baa1b04e12/lean/ErdosProblems/Erdos243/PaperCompleteR7/Frontier.lean#L151}{the canonical frontier profile},
from the rational reciprocal sum and the quadratic growth limit.
...
$F(X)=\sum_{u_j\le X}w_j$. Then $\liminf_{X\to\infty}F(X)/X=0$ if and only if
...
\lword{Erdos243/ReciprocalTailRigidity.lean}{2352}{eventuallyBoundedNegativePart_eventually_zero}{eventual bounded-negative rigidity}.
Lean also checks the endpoint that carries that theorem to the original
denominators, as
\href{https://github.com/wcook04/plectis-erdos/blob/f4e61ed8a6941571310049e22dc239baa1b04e12/lean/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L2412}{the bounded-negative-part recurrence theorem},
and the canonical analytic transfer of Corollary~\ref{res:lcmbounded}, as
\href{https://github.com/wcook04/plectis-erdos/blob/f4e61ed8a6941571310049e22dc239baa1b04e12/lean/ErdosProblems/Erdos243/PaperCompleteR7/LcmDefect.lean#L49}{the original-coordinate LCM bounded defect}.
The global weighted, polynomial and
slow-negative arguments are ordinary proofs; the scalar finite-mass proof
is printed in full above. The auxiliary source guide, the
\lword{Erdos243/ReciprocalTailRigidity.lean}{350}{no_eventuallyConstantNegative_orbit}{eventual constant exclusion}
and the
\lword{Erdos243/ReciprocalTailRigidity.lean}{796}{no_eventuallyPeriodicNegative_orbit}{eventual periodic exclusion},
primitive feedback, finite certificates and unsuccessful global
...
of Section~\ref{sec:transfer} and is not a checked statement.  The periodic exclusion
...
original analytic problem.  The ordinary canonical-tail transfer is proved in
...
evidence and not a proof; the Lean-checked
...
\bibitem{erdosproblems} T.~F. Bloom,
  ...
  ``last edited 21 January 2026'').  The record labels the problem open and
  cites \textup{[ErGr80, p.~64]} and \textup{[Er88c, p.~105]}.
\end{thebibliography}
