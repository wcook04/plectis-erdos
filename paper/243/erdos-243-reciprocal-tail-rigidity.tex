...
numerator.  The Chinese remainder theorem then produces a block of
...
\end{theorem}
The eventual form follows by shifting past the centring and lower-bound
thresholds; its exact source is linked in the formal-scope paragraph below.
\end{samepage}
...
\end{problem}
\noindent The canonical necessary profile is ordinary in this note.
\nolinkurl{PaperCompleteR7/Frontier.lean} is not in this checkout.
