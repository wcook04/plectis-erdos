...
integer-state theorem below, proved in Section~\ref{sec:transfer}.  There is
no module \texttt{PaperCompleteR7/ProductDefect.lean} in this checkout.
...
\end{theorem}
Eventual strict centring, a bounded negative part, and normalised vanishing
