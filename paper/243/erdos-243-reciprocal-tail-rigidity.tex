...
Clear the rational reciprocal tail as $C_n/D_n$.  On a Sylvester tail,
...
state hypotheses after a finite shift. The nonnegative-error case, Badea's criterion~\cite{badea1993} in Koizumi's coordinates, is
...
$t+i$ inside a window of $B$ consecutive integers. Matchings of a set of
integers to distinct multiples in an interval are the subject of
...
requires \cite[pp.~4--5]{vandoornlitang2026}.
...
kind that tend to zero, as in the quantitative form stated as Lemma~3.4 of
Koizumi and Yokoi~\cite[p.~13]{koizumiyokoi2026}, applied there to values of
$q$-series. At the cubic rate these forms grow: since $a_nx_n\to1$, the identity
...
\href{https://github.com/wcook04/plectis-erdos/blob/eccd8afc6db3c02a2265d0601b727d6c5e4467d5/lean/ErdosProblems/Erdos243/LcmDefectCriterionReduction.md}
...
\bibitem{koizumiyokoi2026} J.~Koizumi and A.~Yokoi,
  \href{https://arxiv.org/abs/2608.26918}
  {\emph{Ap\'ery-type approximations and irrationality measures for certain
  $q$-series}}, preprint arXiv:2608.26918v1, 2026.
