...
The same three declarations on an exact reciprocal-tail orbit, with denominator dynamics and normalised vanishing, are
\lword{Erdos243/SparseResetRecovery.lean}{378}{tail_growth_le_one_add_negativeRelativeMass}{the exact-orbit growth bound},
\lword{Erdos243/SparseResetRecovery.lean}{488}{eventually_zero_of_summable_negativeRelativeMass}{vanishing from summable exact-orbit negative mass},
and
\lword{Erdos243/SparseResetRecovery.lean}{510}{sylvesterNext_eventually_of_summable_negativeRelativeMass}{the exact-orbit Sylvester recurrence from summable negative mass}.
