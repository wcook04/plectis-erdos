...
\path{FactorialGapPlateauCore.lean}.  \path{FactorialZeroPlateau.lean} is the
default-root duplicate of that family and is not the isolation source.
Companion-orbit rationality is in \path{CompanionOrbitRationality.lean}; the
unconditional correction \eqref{eq:companion-wrap} is in
\path{CompanionConstantCarryLaw.lean}.
