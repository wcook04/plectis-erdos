...
an asymptotic cancellation theorem.  Bounding the reduced
...
That stronger assertion has not been shown to follow from rationality of
$\Ser$ alone; it would require an extra small-tail hypothesis such as
$d_N(\Ser-H_N)<1$.
...
(\texttt{sharp\_radius\_satisfies\_square\_log\_constraint} is not in this checkout)\\
