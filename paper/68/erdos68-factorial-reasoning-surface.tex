...
\cite{bloom}, which lists the problem as open.
...
Lean checks it as
\href{https://github.com/wcook04/plectis-erdos/blob/0b500c7cf8e8bb7ae343484378df02f277fb8194/lean/ErdosProblems/Erdos68/PaperCompleteLiminf.lean#L42}{common denominator growth liminf}.  The finite-block
inequality has a separate Lean source,
...
Its two ingredients are Lemmas~\ref{long68:res:product-lcm} and~\ref{long68:res:gap-gcd}, and it
...
The direction of denominator control matters.  Write $H_N=A_N/Q_N$ in lowest
terms.  Under the hypothetical identity $\Ser=a/q$, with $a\in\Z$ and
$q\ge1$, positivity of the tail gives
\[
 qQ_N(\Ser-H_N)=aQ_N-qA_N\in\Z_{>0}.
\]
...
\href{https://github.com/wcook04/plectis-erdos/blob/f36a98bf3d3e6f65f1074e3b800e3293d5b8a51a/ErdosProblems/Erdos68/PaperCompleteExisting.lean\#L156-L168}{checked global complementary criterion}.
...
note rests on the retained GMP receipt with its source, backend, payload and
receipt digests; \S\ref{long68:sec:finite} records that a byte-identical
regeneration of that receipt with the current driver is outstanding and
describes the separate replay through $4000$.  The full range is external
...
An elementary terminal-block argument gives a lower bound of order $N^{3/2}\log N$ for the lcm of factorial-gap denominators. The displayed bound has an ordinary proof. An older, weaker multiplicity-based route is historical context only. Lean checks the bound as \href{https://github.com/wcook04/plectis-erdos/blob/0b500c7cf8e8bb7ae343484378df02f277fb8194/lean/ErdosProblems/Erdos68/PaperCompleteLiminf.lean#L42}{common denominator growth liminf}. The finite-block inequality has a separate Lean source.

\textbf{Authority and reach.} Lean kernel plus paper argument.

\textbf{Exact boundary.} The LCM asymptotic has an ordinary paper proof and is checked in Lean. The Comparator entry for this bound belongs to the separate public release \texttt{wcook04/plectis-erdos-lean}. The bound does not decide irrationality.
