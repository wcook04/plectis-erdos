...
\noindent The divisibility $g\mid j!/i!-1$ is the case $P=-1$ of the relation
...
$(n+h)!+P(n+h)$ in the proof of Lemma~5 of~\cite{luca-shparlinski}, and Lai
uses it for a common prime-power divisor at display~(2.5) of~\cite{lai}.
...
which have integer coefficients, meet the irrationality criterion quoted
in~\cite[Lemma~2.1]{lai-lupu-sprang}: nonzero values whose $p$-adic size,
