...
is not kernel-checked.  The associated asymptotic Lean files are proof
candidates and are not being cited as kernel verification.  The finite-block
...
carry the asymptotic deduction, and the asymptotic Lean files are proof
candidates rather than kernel verification.
...
and are not kernel-checked; the associated asymptotic Lean files are proof
candidates.  The finite-block inequality is the separate Lean source
