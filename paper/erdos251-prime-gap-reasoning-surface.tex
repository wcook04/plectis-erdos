...
$g_n=p_{n+1}-p_n$.  The polynomial bound $p_n\le1250(n+1)^4$ gives summability
of the prime and gap terms.  Summation by parts, with the endpoint retained,
yields
\[
...
The rescaled tails satisfy $T_{N+1}=2T_N-g_{N+1}$.  For any real recurrence
with integer digits,
\[
 T_{N+h}=2^hT_N-
...
There is an exact finite obstruction.  Two adjacent $h$-shifts in $(-1,1)$
...
$N=2$; its cofinal occurrence is not proved.  The quadratic example
$g_n=2(n^2+4n+2)$, $T_n=2(n+4)^2$ shows that positivity, parity, polynomial
growth, unboundedness, and nonperiodicity cannot force this mechanism.  A
checked recurrence and integral-shift obstruction make this an exact
countermodel, not a heuristic comparison.  A second example has finite sum
...
but that fact alone is insufficient.  Problem~\#251 remains open: the exact
unproved input is cofinal nonintegrality, or a prime-gap estimate strong enough
to imply the adjacent-small-mismatch condition.
\end{abstract}

\begin{paperresult}{Exact reduction and missing input}
\textbf{Reduction.} Summation by parts identifies the prime series with two
plus the dyadic prime-gap series, so their irrationality questions are
equivalent.  Tail rationality is equivalent to one integral shift and to one
diagonal LCM-tail integrality.  \textbf{Finite obstruction.} Adjacent small
shifts with unequal gaps cannot both be integral.  \textbf{Open boundary.}
The polynomial countermodel proves that positivity, evenness, strict growth,
and nonperiodicity do not force the required shift escape.  No result here
proves cofinal smallness or nonintegrality for the actual prime gaps.
\end{paperresult}
...
\emph{Lean-checked} marks a statement accepted by the pinned kernel.  The modifier
...
\begin{theorem}[\href{https://github.com/wcook04/plectis-erdos/blob/b488fcff983e2db53239938b1b2867999c7b4959/research_corpus/Erdos251/problem/OrderLatticeDiagonal.lean\#L153}{lcm-diagonal criterion}]\label{res:lcmdiagonal}
...
\begin{theorem}[\href{https://github.com/wcook04/plectis-erdos/blob/b488fcff983e2db53239938b1b2867999c7b4959/research_corpus/Erdos251/problem/AffineShiftEscape.lean\#L113}{signed two-window normal form}]\label{res:signedwindow}
...
\href{https://github.com/wcook04/plectis-erdos/blob/b488fcff983e2db53239938b1b2867999c7b4959/research_corpus/Erdos251/problem/AffineCylinderCollapse.lean\#L91}{pointwise affine identity},
its \href{https://github.com/wcook04/plectis-erdos/blob/b488fcff983e2db53239938b1b2867999c7b4959/research_corpus/Erdos251/problem/AffineCylinderCollapse.lean\#L162}{cofinal form},
and the \href{https://github.com/wcook04/plectis-erdos/blob/b488fcff983e2db53239938b1b2867999c7b4959/research_corpus/Erdos251/problem/AffineCylinderCollapse.lean\#L308}{fixed-lattice equivalence}.
...
The \href{https://github.com/wcook04/plectis-erdos/blob/e2a9177a386c2567a46979c2c7f065c4a839a367/ErdosProblems/Erdos251/BoundedPerturbationCountermodel.lean#L163}{construction}
and its \href{https://github.com/wcook04/plectis-erdos/blob/e2a9177a386c2567a46979c2c7f065c4a839a367/ErdosProblems/Erdos251/BoundedPerturbationCountermodel.lean#L179}{invariant-property consequence}
are kernel checked: a property shared by every admissible perturbation cannot
by itself force irrationality. The perturbed digits need not remain prime gaps.
...
\href{https://github.com/wcook04/plectis-erdos/blob/e2a9177a386c2567a46979c2c7f065c4a839a367/ErdosProblems/Erdos251/PolynomialGapSeriesValue.lean#L89}{checked rational-value theorem}.

The formal construction checks the
\href{https://github.com/wcook04/plectis-erdos/blob/b488fcff983e2db53239938b1b2867999c7b4959/research_corpus/Erdos251/problem/PrimeGapDyadicTail.lean\#L1596}{recurrence},
\href{https://github.com/wcook04/plectis-erdos/blob/b488fcff983e2db53239938b1b2867999c7b4959/research_corpus/Erdos251/problem/PrimeGapDyadicTail.lean\#L1632}{strict growth},
\href{https://github.com/wcook04/plectis-erdos/blob/b488fcff983e2db53239938b1b2867999c7b4959/research_corpus/Erdos251/problem/PrimeGapDyadicTail.lean\#L1654}{integrality of every shift},
and \href{https://github.com/wcook04/plectis-erdos/blob/b488fcff983e2db53239938b1b2867999c7b4959/research_corpus/Erdos251/problem/PrimeGapDyadicTail.lean\#L1644}{exclusion of adjacent differences of size two}.
...
trigger, and integral shifts, is also Lean-checked.  Paper-level are the modular
rewriting by $D_{h,N,L}$, the finite-approximation inference, the positive
carry countermodel above, the identification of the concrete tail
$\mathcal T$ with the checked recurrence, and the real form of the small-shift
