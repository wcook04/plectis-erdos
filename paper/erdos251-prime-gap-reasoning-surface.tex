...
Theorem~\ref{long251:res:polignacfail} recurring gap values differing by $2$ in every
...
\eqref{long251:eq:smallpair} contain the complete infinite continuation.  Nor does
...
\subsection{A weaker recurrence-level target}\label{long251:sec:xr-divisorhit}
