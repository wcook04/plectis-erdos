...
\textbf{Reader position.} 5 of 71; display band: front door.  Formal editorial disposition: promote.  These are separate classifications.
...
\textbf{Reader position.} 12 of 71; display band: major result.  Formal editorial disposition: merge.  These are separate classifications.
...
\textbf{Result-atom population.} 10 of 682 public coordinates. The public atom catalog groups them under this family.
...
\textbf{Reader position.} 28 of 71; display band: mechanism.  Formal editorial disposition: merge.  These are separate classifications.
...
\textbf{Reader position.} 46 of 71; display band: frontier.  Formal editorial disposition: hold.  These are separate classifications.
...
\textbf{Reader position.} 52 of 71; display band: frontier.  Formal editorial disposition: hold.  These are separate classifications.

\textbf{Reader entry.} Unboundedness, irregularity, and free carry identities do not by themselves control the fractional tail needed for irrationality.
...
\textbf{Authority and reach.} Lean kernel plus authored synthesis; coefficient-only barrier; novelty and significance unassessed.

\textbf{Exact boundary.} CoefficientOnlyNoGo checks the exact finite partial-sum identity and the two non-eventual-periodicity statements. It does not assert the infinite limit of the synthetic countermodel, identify its coefficient stream with actual prime gaps, establish a prime-gap tail bridge, prove \#251 irrationality, or make novelty, priority, significance, or external-review claims.
...
\textbf{Reader position.} 61 of 71; display band: technical support.  Formal editorial disposition: merge.  These are separate classifications.
