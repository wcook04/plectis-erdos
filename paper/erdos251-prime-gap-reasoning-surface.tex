...
\]
Every rational number equal to $\Pi$, and hence every rational equal to $S$,
...
The exact remaining input is a free-pair condition.  Put
...
\begin{paperresult}{Denominator floor, exact criterion, and open boundary}
...
\paragraph{Outline.}
Section~\ref{sec:denominator-floor} records the two denominator exclusions, the
free-pair criterion that is equivalent to the target, the measurement of the
event that criterion consumes, and the exact remaining prime-theoretic
obligation.  Section~\ref{sec:diagonal-collapse} then gives the strongest exact
...
The strongest statements available on this problem restrict the answer itself.
Both are exclusions of rational values, and both leave irrationality open.
