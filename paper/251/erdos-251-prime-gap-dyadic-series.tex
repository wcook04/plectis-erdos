...
(\lword{Erdos251/PrimeGapDyadicTail.lean}{1157}{carryPartialSum_natCast_eq}{finite endpoint};
\lword{Erdos251/PrimeGapDyadicTail.lean}{1163}{carryCoeff_natCast_not_eventually_periodic}{coefficient nonperiodicity}).
The actual prime gaps are also not eventually periodic
(\lword{Erdos251/PrimeGapDyadicTail.lean}{1023}{primeGap0_not_eventually_periodic}{prime-gap nonperiodicity}),
but that fact alone is insufficient. The polynomial comparison below is a
synthetic countermodel, not a prime-gap construction.
...
dyadic series is. The named equivalence still takes a summability hypothesis
which this checkout discharges; neither side is proved irrational.
\end{corollary}
...
\item \lref{Erdos251/PrimeGapDyadicTail.lean}{1157}{carryPartialSum_natCast_eq}
\item \lref{Erdos251/PrimeGapDyadicTail.lean}{1163}{carryCoeff_natCast_not_eventually_periodic}
