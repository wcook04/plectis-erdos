...
The identities used above are the Lean-checked elementary core; the
explicit spacing and block-law estimates in this paragraph are ordinary
mathematics. There is no separately published companion file
...
and block-law transfer are ordinary proofs, given in the Construction
paragraph of that proposition; they are not Lean- or Comparator-verified.
There is no separately published companion file
\texttt{SparseRationalisation.md}.  End-to-end sparse candidate sources in
