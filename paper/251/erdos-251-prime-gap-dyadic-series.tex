...
weight; its elementary pair identities are checked in Lean, while the sparse
scheduling argument is ordinary mathematics.  The simpler positive even word
...
\texttt{SparseRationalisationCore.lean}.  The explicit three-coordinate schedule, upper Banach density, and
block-law transfer are ordinary proofs, given in that proposition and in
the companion record, subsection ``Paired corrections and cumulative
congruences''; they are not Lean- or Comparator-verified.  End-to-end sparse candidate sources in
the repository are labelled UNRUN and are not presented as checked theorems.
