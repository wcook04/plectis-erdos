...
%
% This is the only copy of the shared preamble.  The eight short notes, the
% long records assembled from paper/reasoning-parts other than #249 and #257
% (which carry their own preambles), and the synthesis paper include it with
% \input{problem-note-preamble}; paper/Makefile builds from this directory
% with the directory on the tectonic search path.
%
...
% roots under lean/, and the declarations cited under the statements were
% written after it, so a second immutable pin, \ledgercommit, carries them.
% The note printed under each statement is generated.  Do not edit a
% \leannote by hand.
% ---------------------------------------------------------------------------
