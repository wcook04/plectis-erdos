...
% Storage prefix inside the pinned snapshot. The nesting commit moved the
% corpus under lean/ without changing module identity; a note pinned at a
% nested commit sets \renewcommand{\sourceprefix}{lean/} so its links resolve,
% while a note pinned at a historical root-layout commit leaves it empty.
% scripts/check_problem_note_sources.py enforces the pairing.
\newcommand{\sourceprefix}{}
...
\newcommand{\mref}[3]{\href{\repobase/\sourceprefix#1\#L#2}{\leanlabel{#3}}}
\newcommand{\mword}[4]{\href{\repobase/\sourceprefix#1\#L#2}{#4}}
\newcommand{\mloc}[2]{\href{\repobase/\sourceprefix#1\#L#2}{Lean source}}
