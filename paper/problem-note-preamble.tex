...
% State the shared evidence boundary once; each note states its exact open
% remainder beside the relevant mathematics.
\newcommand{\statusboundary}{%
  \emph{Status.} The original problem remains open. Statements marked as
  Lean-checked refer to the linked propositions accepted by the pinned kernel,
  with no \texttt{sorry}, added axioms, or unchecked evaluation. The note
  states the remaining mathematical obligations explicitly.
...
\newcommand{\externalreviewobject}[3]{%
  ...
  {formalisation manifest} and the commit-bound CI receipt record the checked
  statements and verification results.
  \end{quote}}
