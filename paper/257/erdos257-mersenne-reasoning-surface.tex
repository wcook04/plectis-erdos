...
revision and follows the status recorded in the supplied material.
Some supplied files are uncompiled handoff drafts; the tag alone is not
a claim that they were accepted by the kernel.  No fresh compilation
of those sources was performed for this editorial revision.  \ev{Cert} identifies a reported exact finite computation.
...
the mathematics.  No fresh Lean build or independent verification of every
proof is claimed.  Neither the universal problem nor either rational-target
question is resolved in this paper.
...
The proof above is an ordinary argument.  The two declarations cited in this
paragraph concern different hypotheses and do not verify its averaging steps.
The release-snapshot source for the weighted conclusion is identified after
Theorem~\ref{thm:257-mixed-supports}; that source is not a fresh build of the
proof printed here.  For comparison, the older pinned corpus contains the
...
cover conclusion in
\href{https://github.com/wcook04/plectis-erdos-lean/blob/52f29ad173b04e3bac941b3663f2b9aebe5de0bb/ErdosProblems/Erdos257/PaperCompleteR8/PositiveCoverReturn.lean#L241}{the positive-cover conclusion}
and for the weighted and mixed conclusions in
\href{https://github.com/wcook04/plectis-erdos-lean/blob/52f29ad173b04e3bac941b3663f2b9aebe5de0bb/ErdosProblems/Erdos257/PaperCompleteR8/WeightedReturn.lean#L98}{the weighted and mixed conclusions}.
...
Lemma~\ref{lem:sqrt-witness}; these derivations are ordinary arguments,
not separately supplied formal theorems.  For (a), membership gives
...
lie in an internal gap.  The linked half-target declarations are
special cases, not a fresh formal verification of this proof.
\ev{Math}
\end{obs}
...
\]
This function is periodic in $x$ with period $Q_D$, and
