...
Theorem~\ref{thm:257-mixed-supports} does not establish strict enlargement
over both individual classes.  No separation between the two classes is
proved here: neither a weighted support with no strengthened cover nor a
support with such a cover but no finite weighted mass is constructed.  The theorem also leaves universal irrationality and the quantitative
and prime-power thinning claims open.
