...
\maketitle
\noteprovenance
The source annotations in this note deliberately name two immutable revisions. Links produced by
the standard note macros use \texttt{\commitshort}; across this note and its long reasoning
surface, fourteen paper-local coordinates link revision \texttt{f36a98bf3d3e}. These families are audited separately; a historical aggregate
reference count is not asserted to be an exact inventory of this PDF.
...
The two criteria below use different controls on the same positive
displacement.  The estimates named in this section are not independently
checkable from the files in this checkout: the cited supplements and
\texttt{MixedSupportSynchronisation.md} are absent from the public
packet.  The statements are retained as claimed extensions, not as
results of this release.
...
sharper rational-phase lower bound are referred to an analytic supplement
that is not in this checkout; no positive density of $A$ is required.
