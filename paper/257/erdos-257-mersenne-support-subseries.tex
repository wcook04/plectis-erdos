...
\renewcommand{\commit}{e060dcf7fff1e5d09f80cf755297c9cc93dd5ad7}
\renewcommand{\commitshort}{e060dcf7fff1}
\renewcommand{\sourceprefix}{lean/}
\hypersetup{
...
The reciprocal-summable theorem is also checked end to end by the Lean
kernel in this checkout; the weighted and mixed criteria have ordinary
proofs whose analytic steps are not Lean theorems.  Universal
...
Theorem~\ref{res:reciprocal-support} is checked by the Lean kernel in this
checkout as the
\mword{Erdos249257/AllBaseReciprocalSupportIrrationality.lean}{395}{irrational_erdosSupportSeries_of_summable_reciprocal}{reciprocal-summable support theorem},
with the base an integer at least~2, the support infinite and the reciprocal
support terms summable; its base-two case is the
\mword{Erdos249257/ReciprocalSupportIrrationality.lean}{1013}{irrational_erdosSupportSeries_two_of_summable_reciprocal}{binary reciprocal-summable theorem}.
The ordinary proof printed below is independent of the formal one.  The
separate public Lean release
...
states the same theorem at commit \texttt{52f29ad1} as
\texttt{irrational\_supportPowerSeries\_of\_summable\_reciprocal} in
\texttt{PalomarCorpus/E257/Challenge.lean} and proves it under
\texttt{Solutions/PalomarCorpus/E257}; that repository's Linux replay of
Palomar's Comparator stage accepted the entry with the Lean kernel and with
NanoDa
...
Theorem~\ref{res:reciprocal-support} is checked in this checkout as
\texttt{AllBaseReciprocalSupportIrrationality.lean}, cited at the theorem;
the filenames \texttt{SignedFinitePeriodNoncollapse.lean} and
