...
finitely many $B_C$.  Each clause $C$ is nonempty.  A subset of $E$
...
criterion with $P=E$ proves the claimed irrationality.  For example,
the three clauses $\{2,3\}$, $\{2,5\}$, $\{3,5\}$ give precisely the
three minimal witnesses $\{2,3\}$, $\{2,5\}$, $\{3,5\}$.
