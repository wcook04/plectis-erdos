...
The weighted and cover arguments, the mixed theorem, the cost
separations, and the prime-power thinning argument refer to ordinary
proofs that are not linked in this public checkout
...
Those extensions are therefore not independently assessable here and are
not promoted as results of this release.
