...
The nearby Lean theorem
\texttt{irrational\_erdosSupportSeries\_pairwise\_coprime}
...
the separate Lean theorem
\texttt{irrational\_erdosSum\_full\_support}.  Arbitrary infinite support
remains open.
...
Finite-period noncollapse has a Lean counterpart
\texttt{finite\_period\_noncollapse\_rat\_den} in
\texttt{Erdos249257/CertificateKernel.lean}.  Full-support irrationality and
pairwise-coprime summable-reciprocal support are Lean in the same module.
