...
These results have ordinary proofs; their analytic steps are not end-to-end
Lean theorems.  Universal
...
weighted criterion and its combination with positive divisor covers.
...
Erd\H{o}s stated Theorem~\ref{res:reciprocal-support}, with its all-base
quantifier, and printed a proof only for pairwise coprime
supports~\cite[p.~222]{erdos1968}; the history is recalled below.
...
\href{https://github.com/wcook04/plectis-erdos-lean/blob/52f29ad173b04e3bac941b3663f2b9aebe5de0bb/PalomarCorpus/E257/Challenge.lean#L713}{\texttt{wcook04/plectis-erdos-lean}}
states Theorem~\ref{res:reciprocal-support} at commit \texttt{52f29ad1} as
\texttt{irrational\_supportPowerSeries\_of\_summable\_reciprocal} in
\texttt{PalomarCorpus/E257/Challenge.lean}, with the base an integer at
least~2, the support infinite and the reciprocal support terms summable, and
proves it under \texttt{Solutions/PalomarCorpus/E257}.  That repository's
...
The checked proof is a later counterpart, identified separately rather than
attributed to the checkpoint of this note.
The nearby
...
with $E$ the primes and $s=\infty$~\cite[p.~4]{duverneytachiya}.
...
strictly larger class and an explicit reciprocal-divergent host.
Theorem~\ref{res:mixed-supports} combines weighted supports and positive
covers by producing a common small displacement.  Later
sections keep the quantitative, prime-power and stronger
...
The later quantitative, prime-power and cost-separation claims
...
Since every weight exceeds its tail, Hornich's theorem, as proved by
...
are not in this checkout.  The separate public Lean release
\href{https://github.com/wcook04/plectis-erdos-lean/blob/52f29ad173b04e3bac941b3663f2b9aebe5de0bb/PalomarCorpus/E257/Challenge.lean#L512}{\texttt{wcook04/plectis-erdos-lean}}
at commit \texttt{52f29ad1} states both equivalences, with the same window
$[K,K+2\lfloor\sqrt K\rfloor+12)$, as
\texttt{mem\_iff\_greedyBinaryDefect\_cofinal\_repairs} and
\texttt{mem\_iff\_greedyBinaryDefect\_sqrt\_windows} in
\texttt{PalomarCorpus/E257/Challenge.lean} and proves them; the replay receipt
is cited at Theorem~\ref{res:reciprocal-support}.
...
The residue-class, odd-support, eventually periodic and periodic-weight
declarations listed in the appendix are formal proofs of statements that
follow from the periodic theorem of Luca and
Tachiya~\cite[Theorem~A, p.~139, and Example~2, p.~140]{lucatachiya2017}.
The statement of Problem~\ref{res:problem} has been formalised before, as a
conjecture with an unfilled proof, in the \emph{Formal Conjectures}
collection~\cite{formalconjectures257}.  That collection proves the Lambert
identity for the full-support value and states its irrationality, the 1948
theorem of Erd\H{o}s, with proof \texttt{sorry}.  Its role here is
statement-level prior art; no theorem in this note is derived from it, and the
full-support statement it leaves unproved is the checked
\mword{Erdos249257/CertificateKernel.lean}{8328}{irrational_erdosSum_full_support}{full-support theorem}
cited above.
...
than attributed to that checkpoint.  One such later counterpart is the checked
theorem \texttt{irrational\_supportPowerSeries\_of\_summable\_reciprocal} of
the public Lean release \texttt{wcook04/plectis-erdos-lean} at commit
\texttt{52f29ad1}, cited at Theorem~\ref{res:reciprocal-support}.
...
reciprocal-divergent host, the mixed theorem~\ref{res:mixed-supports}, and
the prime-incidence calculation also have complete ordinary proofs here.  They have
no end-to-end Lean counterpart in this checkout.  The separate public Lean
release \texttt{wcook04/plectis-erdos-lean} at commit \texttt{52f29ad1} states
both clauses of Theorem~\ref{res:weighted-support} as
\texttt{divisibilityWeightedClaim}, a reciprocal-divergent weighted host as
\texttt{exists\_weighted\_not\_strengthened\_host}, and
Theorem~\ref{res:mixed-supports} for a strengthened positive cover host as
\texttt{mixedSupportClaim}, all in \texttt{PalomarCorpus/E257/Challenge.lean},
and proves them; the replay receipt is cited at
Theorem~\ref{res:reciprocal-support}.  The quantitative criterion,
the stronger claimed support \(A^\star\) separating the two cover costs,
and prime-power thinning instead refer to ordinary proofs that
...
and the analytic proof supplement).
