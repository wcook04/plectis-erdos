...
independent human review.  Those arguments concern finite
functionals, not a comparison of the infinite-support irrationality
classes.  No separation between the weighted supports of
Theorem~\ref{res:weighted-support} and the cover supports of
Theorem~\ref{thm:variable-fractional-cover} is proved here.
