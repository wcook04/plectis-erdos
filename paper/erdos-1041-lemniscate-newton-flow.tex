...
the regular pentagon.  The exact degree-five statement that would close that
residual is recorded, but is not proved.  This note therefore separates a
genuine degree-five target, surviving carriers, and certified failures of
tempting selection rules rather than presenting a uniform list of partial
estimates.
