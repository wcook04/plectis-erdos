...
supplies the spanning-tree decomposition used in the final proof.  The forum
discussion did not locate the issue, but the local three-ended saddle
construction is invalid as written; the exact defect and possible repairs are
recorded in Section~\ref{sec:gap}.  This is a proof gap, not a counterexample to
the proposition.  Pendyala's independent June 2026
...
Unrestricted proof of \cite[Theorem~1, p.~1]{march2026} & Proof gap & Proposition~12 uses a false three-ended local saddle block; its statement is not refuted and may be repairable. \\
