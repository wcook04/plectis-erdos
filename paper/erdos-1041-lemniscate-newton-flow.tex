...
June 2026 preprint proves the degree-four case.  The current public frontier
is more specific than this dynamical diagnosis alone: near a Fekete
configuration, radial deficits can be removed from the containment problem,
while a degree-five analysis isolates rapid nearly-simultaneous merging near
the regular pentagon.  Its exact envelope is already explicit: a critical
value at most $1/M_5$, where
\[
...
remaining degree-five statement is therefore a universal selection assertion
at this threshold, not a further constant chase; it is recorded below but not
proved.  This note therefore separates a genuine degree-five target,
surviving carriers, and certified failures of tempting selection rules rather
than presenting a uniform list of partial estimates.
...
The formal route is explicit: Newton-value decay is checked at
...
These are finite dynamical and stability interfaces, not the missing global
topology or length-$2$ gluing argument.
