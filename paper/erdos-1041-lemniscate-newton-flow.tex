...
conversion from the squared estimate to a strict length bound are also
ordinary arguments.  No corresponding Lean declaration is supplied by the
pinned corpus; the symbolic replay is not a kernel-checked proof of the
analytic theorem or its scalar consequences.
