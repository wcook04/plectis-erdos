...
$\sum_{a}\gamma(a)/(b^a-1)$ is irrational.  Theorem~A in Luca and
Tachiya's later open note restates their earlier signed theorem in the exact
...
Neither statement by itself verifies the broader eventual-rational wording
formerly attached here, so the eventual nonnegative rational claim above
rests on the checked theorem.  By \ref{res:weight} the weight $\Aw$ is
