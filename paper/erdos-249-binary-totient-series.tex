...
form for the dyadic totient kernel, proves level rank $2^e+1$, derives the
...
{\footnotesize\emph{Checked:}
\mword{Erdos249257/TotientCarryKernelRigidity.lean}{285}{not_irrational_totientSeries_implies_unbounded_carryRank_unconditional}{the barrier},
...
is not claimed.
{\footnotesize\emph{Checked:}
\mword{Erdos249257/CertificateKernel.lean}{16213}{irrational_tsum_totient_div_pow_two_of_gap_certificate_supply}{the supply implication}.
...
\]
at
\lword{Erdos249/FiniteEulerSieve.lean}{30}{muSqEulerFactor_one}{$s=1$}
and
\lword{Erdos249/FiniteEulerSieve.lean}{38}{muSqEulerFactor_two}{$s=2$}.
On the prime-power divisor-sum row,
\[
  \sigma_p(1)-2\sigma_p(0)=p-1
\]
(\lword{Erdos249/FiniteEulerSieve.lean}{46}{sigmaPrimePow_firstDiff}{first difference}),
and for every $e\ge0$,
\[
  \sigma_p(e+2)-2\sigma_p(e+1)+\sigma_p(e)
    =p^{e+1}(p-1)
\]
(\lword{Erdos249/FiniteEulerSieve.lean}{53}{sigmaPrimePow_secondDiff}{second difference}).
...
\lword{Erdos249/PeriodMultipleEscape.lean}{359}{ApFullDepthEscape}{ApFullDepthEscape}.
...
\lword{Erdos249/PeriodMultipleEscape.lean}{368}{irrational_totient_series_of_apFullDepthEscape}{the checked consumer};
