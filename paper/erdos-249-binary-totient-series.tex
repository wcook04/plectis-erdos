...
primes only.  The statement below is a paper proof; it is \emph{not} formalised,
and no Lean declaration in this release asserts it.
...
\item The $k$-kernel rank statement of Theorem~\ref{thm:kkernelrank} is
  independent of the irrationality problem and settles nothing about it.  It is
  a paper proof, not formalised, and it carries no prior-art verdict: its
  independence input is Martin's Theorem~1, and no source was located for the
  rank, basis, or normal form themselves.
\end{enumerate}
