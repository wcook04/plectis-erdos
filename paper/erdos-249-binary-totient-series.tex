...
{\footnotesize\emph{Checked:}
\mword{Erdos249257/CertificateKernel.lean}{18324}{tsum_totient_div_pow_two_ne_int_div_of_den_le_79639646646701375323355774875831053}{exclusion},
\mword{Erdos249257/CertificateKernel.lean}{18337}{tsum_totient_div_pow_two_ne_ratCast_of_den_le_79639646646701375323355774875831053}{reduced-denominator form},
...
{\footnotesize\emph{Checked:}
\mword{Erdos249257/CertificateKernel.lean}{18398}{tsum_primWeight_div_two_pow_sub_one_eq_totient_series}{identity},
...
{\footnotesize\emph{Checked:}
\mword{Erdos249257/CertificateKernel.lean}{12764}{irrational_ratWeightSeries_eventuallyPeriodic}{the periodic theorem}.}
...
is not claimed.
{\footnotesize\emph{Checked:}
\mword{Erdos249257/CertificateKernel.lean}{15978}{irrational_tsum_totient_div_pow_two_of_gap_certificate_supply}{the supply implication}.
...
$\tau$ & $1.6066951\ldots=\EB$ & $g\equiv1$ & The Erd\H{o}s--Borwein constant;
  ...
  (\mword{Erdos249257/CertificateKernel.lean}{8288}{irrational_erdosBorwein_series}{checked}) \\
...
(\mword{Erdos249257/CertificateKernel.lean}{18387}{tsum_moebius_div_two_pow_sub_one_eq_half}{checked})
and $\sum_{d\ge1}\ph(d)/(2^d-1)=2$
(\mword{Erdos249257/CertificateKernel.lean}{18382}{tsum_totient_div_two_pow_sub_one_eq_two}{checked}).
...
(\mword{Erdos249257/CertificateKernel.lean}{18407}{totient_series_eq_half_add_moebius_mersenne_square}{checked})
...
\]
(\mword{Erdos249257/CertificateKernel.lean}{18510}{totient_series_eq_half_add_visible_coprime_pairs}{checked}),
...
(\mword{Erdos249257/CertificateKernel.lean}{15939}{tsum_totient_div_pow_two_ne_int_div_of_totient_gap_certificate}{checked}).
...
(\mword{Erdos249257/CertificateKernel.lean}{18525}{tsum_visible_coprime_pairs_ne_int_div_of_den_le_39819823323350687661677887437915526}{checked}),
...
The current pinned source strengthens this historical list to every
$t\le82$, with no gaps
(\lword{Skip/LadderT67.lean}{71264}{exists_diagonalKill_le_82}{checked}).
The theorem through $t=82$ supplies no instance at $t=83$ and therefore does
not discharge the cofinal quantifier.
...
\item The reformulations of \ref{res:equivalences} convert irrationality
  ...
  certificates.  Finite instances are checked --- every $t\le82$, including
  the historical $28$-scale bank of Section~\ref{sec:frontier} --- and the
  unbounded family is not.
