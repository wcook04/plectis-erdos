...
\renewcommand{\commit}{e45d6a35a72c412491efaaffc2dc79761b3644d0}
\renewcommand{\commitshort}{e45d6a35a72c}
\hypersetup{
...
relation normal form, and exact finite-level rank $2^e+1$, followed by a
...
remain adjacent source evidence.  Full-kernel infinite-dimensionality is
...
no rationality-to-finite-rank bridge.  The remaining inventory includes the
...
\lword{Erdos249/TotientStrictPrimeEscape.lean}{262}{naturalPivotPointEscape_of_naturalPrimeTailOrbitStrictGap}{a positive adaptive truncation budget}
follows, and then
\lword{Erdos249/TotientStrictPrimeEscape.lean}{301}{irrational_totient_series_of_naturalPrimeTailOrbitStrictGap}{$\Stot$ is irrational}.
...
\lword{Erdos249/TotientStrictPrimeEscape.lean}{208}{naturalPrimeTailOrbitStrictGap_iff_initial_phase}{initial-phase equivalence}.
...
gap is impossible
\lword{Erdos249/TotientStrictPrimeEscape.lean}{252}{not_naturalPrimeTailOrbitStrictGap_of_dyadic_root}{dyadic-root obstruction}.
...
The
\lword{Erdos249/CyclotomicAnchoredKill.lean}{1666}{exists_unbounded_binaryCyclotomicSupport_with_periodLock_of_not_irrational}{checked conditional support/period no-go}
makes that limitation exact.  If $\Stot$ were rational, its eventual integral
tail-period law would supply some $h>0$, while the actual binary cyclotomic
layers would still have unbounded prime divisors on the same $h$-ray.
...
\lword{Erdos249/PeriodMultipleEscape.lean}{354}{ApFullDepthEscape}{ApFullDepthEscape}.
...
\lword{Erdos249/PeriodMultipleEscape.lean}{363}{irrational_totient_series_of_apFullDepthEscape}{the checked consumer};
