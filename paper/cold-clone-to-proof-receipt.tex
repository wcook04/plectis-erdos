...
to answer. It can show whether the layers present at that revision helped a
reader find and interpret the mathematics already there. It does not by itself
show that those layers shortened the work of producing a later result, because
