...
\begin{abstract}
A large formal library can be mechanically exact and still be difficult to
enter. This paper describes a repository architecture that separates
first-contact comprehension from proof checking. At the audited revision, a
cold clone exposes a six-line tour, a map of ten mathematical programmes, five
explicit open propositions, reviewed public claims, and an elaborated
reference graph joined to source coordinates. These committed projections
require no Lean build and state both their omissions and their authority
boundaries. The underlying inventory contains 1,019 Lean modules and 153,253
declarations. At least 503 modules and 8,171 declarations are generated
certificate shards; they count as formal source, not as separate mathematical
claims.
