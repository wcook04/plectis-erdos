...
lcm-diagonal criterion, the quadratic polynomial-shift countermodel, and the
signed-window plus affine/fixed-lattice circularity family.  Public Lean-source
and portfolio registration of the last family remain separate release steps.}
...
Theorem~\ref{res:lcmdiagonal} and
Proposition~\ref{res:polynomialcountermodel} are the exact statements exposed
by the two existing Comparator packages.  A third package exposes
Theorems~\ref{res:signedwindow} and~\ref{res:affinecollapse}.  The displayed
proofs are self-contained ordinary proofs; public registration of the latter
source-current Lean family remains pending.
