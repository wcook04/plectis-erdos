...
\hypersetup{
  pdftitle={An exact prime-to-gap identity, a denominator floor and a free-pair criterion for Erdős Problem 251},
...
\title{An Exact Prime-to-Gap Identity for the\\Prime-Index Dyadic Series}
\subtitle{Erd\H{o}s Problem~\#251: the unconditional identity, a denominator
floor, and a free-pair criterion, with the recurrence-level statements checked
in Lean~4}
\author{Will Cook}
\date{July 2026}
