...
\renewcommand{\commit}{68e71c820d33ad2c5a6a51fec6c6b4394c53416f}
\renewcommand{\commitshort}{68e71c8cbaf4}
\hypersetup{
...
\]
the
\lword{Erdos251/PrimeGapDyadicTail.lean}{108}{prime0DisplayedPartialSumQ_eq_two_mul}{factor-of-two
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{98}{dyadicPartialSumQ}{dyadic partial
sum} and the
\lword{Erdos251/PrimeGapDyadicTail.lean}{118}{dyadicDifferencePartialSumQ}{dyadic
difference sum} of $P$.
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{135}{dyadicPartialSumQ_eq_start_add_differences}{summation-by-parts
...
\noindent Formalised as the
\lword{Erdos251/PrimeGapDyadicTail.lean}{169}{prime0_dyadic_summation_by_parts}{prime-gap
summation by parts}, using the
\lword{Erdos251/PrimeGapDyadicTail.lean}{158}{primeGapPartialSumQ}{gap partial
sum} and the
\lword{Erdos251/PrimeGapDyadicTail.lean}{153}{primeGap0_cast}{gap cast
...
$p_n\le p_{n+1}$, the
\lword{Erdos251/PrimeGapDyadicTail.lean}{149}{prime0_mono_step}{monotonicity
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{199}{primeGapDyadicTerm_eq}{dyadic
...
(\lword{Erdos251/PrimeGapDyadicTail.lean}{358}{prime0_le_polynomial}{polynomial bound},
\lword{Erdos251/PrimeGapDyadicTail.lean}{378}{summable_primeDyadicTerm}{summability}).
...
recurrence}, the
\lword{Erdos251/PrimeGapDyadicTail.lean}{546}{tailShift}{shift}, and
\lword{Erdos251/PrimeGapDyadicTail.lean}{577}{RatIntegral}{integrality}.
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{649}{dyadicTailBlock}{tail block}.
...
\noindent Formalised as the
\lword{Erdos251/PrimeGapDyadicTail.lean}{655}{tail_iterate_eq_pow_mul_sub_block}{iterated
block identity} and the
\lword{Erdos251/PrimeGapDyadicTail.lean}{669}{tailShift_eq_scaled_sub_block}{scaled
shift identity}.  The shift also obeys the recurrence in its own right,
$\sigma_h(N+1)=2\sigma_h(N)-(g_{N+h+1}-g_{N+1})$, the
\lword{Erdos251/PrimeGapDyadicTail.lean}{565}{tailShift_succ}{shift step
identity}.
...
\noindent Formalised as the
\lword{Erdos251/PrimeGapDyadicTail.lean}{803}{tailShift_integral_iff_scaledTail}{integral-shift
criterion}, on the
\lword{Erdos251/PrimeGapDyadicTail.lean}{679}{ratIntegral_sub_int_iff}{integer-shift
...
\noindent Formalised as the
\lword{Erdos251/PrimeGapDyadicTail.lean}{878}{tailShift_integral_totient_of_odd_den}{totient
shift} and the
\lword{Erdos251/PrimeGapDyadicTail.lean}{697}{ratIntegral_totientMultiplier_of_odd_den}{Euler
...
\noindent Formalised as the
\lword{Erdos251/PrimeGapDyadicTail.lean}{889}{tailShift_integral_succ}{one-step
propagation} and the
\lword{Erdos251/PrimeGapDyadicTail.lean}{901}{tailShift_integral_add}{propagation
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{831}{rationalPrimeGapTailShift_eventuallyIntegral_of_den_eq}{fixed-denominator
theorem}, and the quantified conclusion is the
\lword{Erdos251/PrimeGapDyadicTail.lean}{854}{rationalPrimeGapTailShift_eventuallyIntegral}{eventual
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{529}{rationalPrimeGapTailState_recurrence}{recurrence},
and the bridge from a hypothetical rational value to that state as
\lword{Erdos251/PrimeGapDyadicTail.lean}{511}{exists_rationalPrimeGapTailState_representation_of_not_irrational}{the
rational-tail representation}.  The abstract real-recurrence formulation of
Theorem~\ref{res:escape-irrational} is the elementary paper-level
contrapositive of this checked actual-tail mechanism; it is not separately
registered as a Lean declaration.
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{982}{tailShift_not_both_integral_of_small_pair_of_digit_ne}{adjacent
small-shift obstruction}; its quantified form is the
\lword{Erdos251/PrimeGapDyadicTail.lean}{1009}{not_eventuallyIntegralTailShift_of_cofinal_small_mismatch}{cofinal
small-mismatch theorem}; and the actual-prime-gap specialisation is the
\lword{Erdos251/PrimeGapDyadicTail.lean}{1116}{primeGapTailShift_not_eventuallyIntegral_of_cofinal_small_mismatch}{prime-gap
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{54}{exists_primeGap0_gt}{unboundedness
of the actual gaps} and the conclusion as
\lword{Erdos251/PrimeGapDyadicTail.lean}{1026}{primeGap0_not_eventually_periodic}{non-eventual
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{1131}{carryCoeff}{carry coefficient}.
...
\noindent Formalised as the
\lword{Erdos251/PrimeGapDyadicTail.lean}{1139}{carryPartialSum_eq}{carry
telescoping identity}, on the
\lword{Erdos251/PrimeGapDyadicTail.lean}{1135}{carryPartialSum}{carry partial
...
the
\lword{Erdos251/PrimeGapDyadicTail.lean}{1182}{natCarryCoeff_cast}{natural-carry
cast}.
...
\lword{Erdos251/PrimeGapDyadicTail.lean}{511}{exists_rationalPrimeGapTailState_representation_of_not_irrational}{tail representation}).
...
(\lword{Erdos251/PrimeGapDyadicTail.lean}{854}{rationalPrimeGapTailShift_eventuallyIntegral}{checked}).
...
$\Pi$.  This all-shifts form is exact and sufficient, but stronger than
...
scaled-tail state and its recurrence, the eventual-integral-shift theorem,
and the prime-specific local small-mismatch theorem are Lean-checked.  The
abstract real-recurrence contrapositive, the modular rewriting by
$D_{h,N,L}$, the finite-approximation observation, and the positive carry
countermodel above are paper-level direct calculations.
The missing statements are the multiple-in-shift lemma used by
Problem~\ref{prob:divisor-hit}, a prime-gap tail domination sharp enough for a
certificate, and a cofinal anti-concentration or adjacent-mismatch theorem.
No cited prime-distribution estimate is claimed to supply those statements.
...
zero-based primes & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{37}{prime0}\\
zero-based gaps & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{41}{primeGap0}\\
first gap value & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{44}{primeGap0_zero}\\
second gap value & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{48}{primeGap0_one}\\
unbounded actual prime gaps & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{54}{exists_primeGap0_gt}\\
dyadic partial sum & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{98}{dyadicPartialSumQ}\\
displayed normalisation & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{103}{prime0DisplayedPartialSumQ}\\
factor-of-two identity & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{108}{prime0DisplayedPartialSumQ_eq_two_mul}\\
dyadic difference sum & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{118}{dyadicDifferencePartialSumQ}\\
partial-sum step & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{121}{dyadicPartialSumQ_succ}\\
difference-sum step & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{126}{dyadicDifferencePartialSumQ_succ}\\
summation by parts & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{135}{dyadicPartialSumQ_eq_start_add_differences}\\
monotonicity step & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{149}{prime0_mono_step}\\
gap cast identity & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{153}{primeGap0_cast}\\
gap partial sum & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{158}{primeGapPartialSumQ}\\
prime-gap summation by parts & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{169}{prime0_dyadic_summation_by_parts}\\
prime dyadic term & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{180}{primeDyadicTerm}\\
displayed prime dyadic term & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{185}{primeDisplayedDyadicTerm}\\
prime-gap dyadic term & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{189}{primeGapDyadicTerm}\\
infinite factor-of-two identity & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{193}{primeDisplayedDyadicTerm_eq_two_mul}\\
gap discrete derivative & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{199}{primeGapDyadicTerm_eq}\\
...
shift & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{546}{tailShift}\\
shift step identity & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{565}{tailShift_succ}\\
integrality & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{577}{RatIntegral}\\
tail block & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{649}{dyadicTailBlock}\\
iterated block identity & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{655}{tail_iterate_eq_pow_mul_sub_block}\\
scaled shift identity & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{669}{tailShift_eq_scaled_sub_block}\\
integer-shift invariance & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{679}{ratIntegral_sub_int_iff}\\
Euler multiplier & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{697}{ratIntegral_totientMultiplier_of_odd_den}\\
integral-shift criterion & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{803}{tailShift_integral_iff_scaledTail}\\
totient shift & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{878}{tailShift_integral_totient_of_odd_den}\\
one-step propagation & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{889}{tailShift_integral_succ}\\
propagation to every later index & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{901}{tailShift_integral_add}\\
rational actual-tail state & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{489}{rationalPrimeGapTailState}\\
rational actual-tail recurrence & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{529}{rationalPrimeGapTailState_recurrence}\\
hypothetical-rational tail representation & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{511}{exists_rationalPrimeGapTailState_representation_of_not_irrational}\\
power-of-two/odd denominator scaling & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{725}{ratIntegral_scaled_of_den_eq_pow_two_mul_odd}\\
multiplier at the two-adic exponent & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{758}{ratIntegral_multiplier_tail_at_twoExponent}\\
fixed-denominator eventual shift & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{831}{rationalPrimeGapTailShift_eventuallyIntegral_of_den_eq}\\
eventual integral shift & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{854}{rationalPrimeGapTailShift_eventuallyIntegral}\\
adjacent small-shift obstruction & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{982}{tailShift_not_both_integral_of_small_pair_of_digit_ne}\\
cofinal small-mismatch theorem & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{1009}{not_eventuallyIntegralTailShift_of_cofinal_small_mismatch}\\
prime gaps not eventually periodic & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{1026}{primeGap0_not_eventually_periodic}\\
actual-prime-gap specialisation & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{1116}{primeGapTailShift_not_eventuallyIntegral_of_cofinal_small_mismatch}\\
carry coefficient & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{1131}{carryCoeff}\\
carry partial sum & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{1135}{carryPartialSum}\\
carry telescoping identity & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{1139}{carryPartialSum_eq}\\
natural carry coefficient & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{1179}{natCarryCoeff}\\
natural-carry cast & \lrefx{Erdos251/PrimeGapDyadicTail.lean}{1182}{natCarryCoeff_cast}\\
\end{tabular}
\fi
