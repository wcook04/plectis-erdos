...
second example has finite sum $-n/2^n$ and non-eventually-periodic coefficients
...
No result here proves the required cofinal smallness or nonintegrality for the
actual prime gaps.
\end{paperresult}
