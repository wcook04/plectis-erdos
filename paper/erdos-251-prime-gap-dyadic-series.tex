...
actual prime gaps are unbounded, and gives a nonperiodic rational countermodel
to a tempting coefficient-only route.}{These results expose the missing
...
series, with the summability hypothesis retained.}
...
For release review, the selected Comparator surface is exact: the declaration
\texttt{exists\_primeGap0\_gt} states $\forall M:\mathbb N,\ \exists n,\ M<
\mathit{primeGap0}(n)$, and
\texttt{irrational\_tsum\_primeDyadicTerm\_iff\_primeGap} states, under
$\operatorname{Summable}(\mathit{primeDyadicTerm})$, the equivalence between
irrationality of the prime-term and prime-gap-term sums.  The summability
hypothesis is retained; these structural rows do not prove the open
irrationality claim for Problem~\#251.
