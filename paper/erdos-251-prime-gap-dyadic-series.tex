...
\hypersetup{
  pdftitle={A denominator floor and a free-pair criterion for the prime-gap dyadic series},
...
\title{A Denominator Floor and a Free-Pair Criterion for the Prime-Gap
Dyadic Series}
\subtitle{Erd\H{o}s Problem~\#251, with the recurrence-level statements checked
in Lean~4}
\author{Will Cook}
\date{July 2026}
