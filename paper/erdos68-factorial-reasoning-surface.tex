...
also checks the \lword{Erdos68/FactorialZeroPlateau.lean}{106}{factorialGrid_plateau}{factorial plateau theorem}: if $H<G\le \Ser$, if $n!G$ is
...
\]
Lean proves the \lword{Erdos68/PrimeZeroBranch.lean}{5557}{factorialGapRepeatedBirthAmplificationModulus_dvd_succ_den}{divisibility $A_n\mid v_{n+1}$}
and, when $A_n>1$, the
\lword{Erdos68/PrimeZeroBranch.lean}{5572}{predecessorGapNumeratorNat_mod_repeatedBirthAmplificationModulus_ne_zero}{nonzero numerator projection}
...
\lword{Erdos68/FactorialZeroPlateau.lean}{1352}{sq_dvd_double_strictFacTop_factorialGapPrefix_iff}{doubled-prime criterion} is
\[
 p^2\mid Z_{2p}
 \quad\Longleftrightarrow\quad
 \begin{cases}
