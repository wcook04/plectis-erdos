...
\end{equation}
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompletePrimePole.lean}{118}.
\end{theorem}
...
$g\le j!/i!-1<j^{\,j-i}$.
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteGcdSegment.lean}{28}.
\end{lemma}
...
\end{equation}
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteGcdSegment.lean}{73}.
\end{lemma}
...
\[
 ...
 \ \ge\ \frac{2\sqrt2}{3}.
\]
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteLiminf.lean}{42}.
\end{theorem}
...
\begin{equation}\label{eq:unit-window}
 ...
 \iff 1+\varepsilon_m<m\Delta_m\le2+\varepsilon_m .
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteExisting.lean}{79}.
\end{equation}
Moreover
\begin{align}
 \Ser\in\Q
...
instances of \eqref{eq:finite-escape} therefore imply $\Ser\notin\Q$.
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteExisting.lean}{104}.
\end{proposition}
...
at every $m\ge3$, so the boundary returns the irrationality of $e$.
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteExisting.lean}{125}.
\end{theorem}
...
\begin{equation}\label{eq:factor-split}
 ...
 (2p+1)C_pq<K_p .
 \end{cases}
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteSupplementary.lean}{59}.
\end{equation}
...
is at least $2d$.
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteSupportedBands.lean}{25}.
\end{theorem}
...
$R(t)=o(t^3)$.
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteExisting.lean}{236}.
\end{theorem}
...
\]
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteLiminf.lean}{54}.
\end{corollary}
...
\begin{equation}\label{eq:doubled-prime}
 ...
 b_{2p}=1+p\ \hbox{and}\ p\mid2Z_{2p-1}-1 .
  The statement is checked in Lean; see the \lloc{Erdos68/PaperCompleteSupplementary.lean}{127}.
 \end{cases}
\end{equation}
