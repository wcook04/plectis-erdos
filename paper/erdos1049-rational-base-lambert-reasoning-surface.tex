...
We prove exact obstructions to several approximation methods at \(t=3/2\)
and a conditional reduction of the number of rows needed to cancel endpoint
residues.
...
fails an exact exponential growth bound.  The unresolved step is an actual
approximation family combining primitive coefficients, a nonzero remainder,
and decay faster than height growth.  No irrationality theorem at \(3/2\)
is proved.
\end{abstract}
