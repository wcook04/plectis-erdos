...
in the totient estimate.  Only the limit enters Theorem~\ref{long1049:res:region}.
...
\clearpage
\section{Complete result-family map}\label{long1049:sec:erdos-1049-complete-family-map}
