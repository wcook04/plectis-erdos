...
under proof abundance. It separates six things that are often confused:
...
theorem. Lean checks the formal statement in the source, not whether that
statement captures the intended mathematics or whether the paper describes it
...
status of a mathematical statement. Among the systems compared in
Section~\ref{sec:related}, none exhibits this complete composition. This is a
...
mathematical pressure with discrete, inspectable commitments.
...
human judgement. This is the same limit encountered in assurance cases: a
formal notation can record an asserted support relationship without proving
that the evidence is true or sufficient for the top claim \cite{gsn}.
