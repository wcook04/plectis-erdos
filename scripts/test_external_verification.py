...
class ExternalVerificationContractTest(unittest.TestCase):
    def test_projection_and_statement_isolation_are_current(self) -> None:
        ...
        self.assertEqual(len(packet["main_results"]), 30)
        self.assertEqual(
        ...
        self.assertIn("<summary>Contribution families (11)</summary>", human)
        self.assertIn("<summary>Technical registry and Comparator routing (11)</summary>", human)
        self.assertIn("## Comparator interface appendix", human)
        self.assertIn("<summary>Show all 30 statement-isolated interfaces</summary>", human)
