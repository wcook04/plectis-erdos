...
class ExternalVerificationContractTest(unittest.TestCase):
    def test_projection_and_statement_isolation_are_current(self) -> None:
        ...
        self.assertEqual(len(packet["main_results"]), 21)
        self.assertEqual(
        ...
        self.assertEqual(len(unregistered), 16)
        self.assertTrue(all(
        ...
        self.assertIn("<summary>Show all 21 statement-isolated interfaces</summary>", human)
