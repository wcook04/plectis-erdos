...
| The corpus itself | Twelve-thousand-plus declarations of exact no-gos, counterexamples, finite certificates, and progress theorems on two problems | `Erdos249257/` |
