...
Conjectures crosswalk](../verification/FORMAL_CONJECTURES_CROSSWALK.md). It binds each of the
...
- Entire checked corpus: 1,446 modules, 159,108 declarations, 155,895 theorem-like declarations, and 8,171 manifest-marked generated-certificate declarations (a classification floor, not the generated share). The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
