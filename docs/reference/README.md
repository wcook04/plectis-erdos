...
| Corrections to earlier descriptions of formal results | [Truth audit](TRUTH_AUDIT.md) | Trace the historical correction, then return to the current claim or source. |
