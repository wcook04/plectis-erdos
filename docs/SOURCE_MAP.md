...
#257 support results (the coprimality-free reciprocal-summable theorem in
`Erdos249257/AllBaseReciprocalSupportIrrationality.lean` and the full-support
theorem), then the conditional actual-LCM and first-harmonic
...
| #257 | `python3 scripts/query_corpus.py --route erdos_257` · reviewed return: `python3 scripts/query_corpus.py --route erdos257_half_story` | [`AllBaseReciprocalSupportIrrationality.lean`](../lean/Erdos249257/AllBaseReciprocalSupportIrrationality.lean) · [`MersenneSubseriesRigidity.lean`](../lean/ErdosProblems/Erdos257/MersenneSubseriesRigidity.lean) | [paper note](papers/full-text/erdos-257-mersenne-support-subseries.md) · [TeX source](../paper/257/erdos-257-mersenne-support-subseries.tex) |
