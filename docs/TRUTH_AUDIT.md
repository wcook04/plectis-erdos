...
The graph contains 1,105 authored statement nodes above 4,841 exact source-structural families. The views overlap and are not a partition of either tier.
