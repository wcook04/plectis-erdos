...
- Entire checked corpus: 1,019 modules, 153,238 declarations, 151,028 theorem-like declarations, and 8,171 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
