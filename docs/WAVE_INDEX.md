...
- Entire checked corpus: 992 modules, 151,761 declarations, 149,812 theorem-like declarations, and 8,171 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
