...
- Entire checked corpus: 667 modules, 13,322 declarations, 12,162 theorem-like declarations, and 2,925 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
