...
- Entire checked corpus: 668 modules, 13,327 declarations, 12,168 theorem-like declarations, and 2,925 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
