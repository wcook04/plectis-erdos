...
- Entire checked corpus: 689 modules, 13,820 declarations, 12,540 theorem-like declarations, and 2,925 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
