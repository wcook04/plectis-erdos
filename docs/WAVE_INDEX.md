...
- `CertificateKernel.lean` (0.85 MiB, 19,231 lines, 845 declarations; 519 theorems and 275 lemmas): the assembled microkernel and headline interfaces.
...
- Entire checked corpus: 1,013 modules, 153,123 declarations, 150,934 theorem-like declarations, and 8,171 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
