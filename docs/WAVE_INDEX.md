...
- `CertificateKernel.lean` (0.83 MiB, 18,950 lines, 836 declarations; 510 theorems and 275 lemmas): the assembled microkernel and headline interfaces.
...
- Entire checked corpus: 991 modules, 151,755 declarations, 149,807 theorem-like declarations, and 8,171 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
