...
- Entire checked corpus: 653 modules, 12,921 declarations, 11,784 theorem-like declarations, and 2,925 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
