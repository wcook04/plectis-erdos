...
- Entire checked corpus: 994 modules, 152,215 declarations, 150,178 theorem-like declarations, and 8,171 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
