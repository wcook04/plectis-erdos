...
- `remaining_open.erdos_1049_irrationality` — Determine whether F(t) = ∑_{n≥1} 1/(tⁿ − 1) is irrational for every rational t > 1. F(31/4) and its positive powers are settled by an ordinary Zudilin specialization that Lean checks; the 3/2 approximant with remainder control and the universal assertion remain open.
...
two roots currently expose 1,340 modules and
157,378 declarations across #68, #243, #249,
