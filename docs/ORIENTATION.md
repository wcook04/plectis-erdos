...
- `remaining_open.universal_257_all_infinite_supports` — Prove irrationality for every infinite support A. The theorem here settles every A with summable reciprocals; the regime sum 1/a = infinity is open.
...
two roots currently expose 1,126 modules and
155,018 declarations across #68, #243, #249,
