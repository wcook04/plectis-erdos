...
The registry contains `291` curated sources across `22` registered papers and `1771` Lean library files.
...
- Lean candidates awaiting review: `637` (`3` direct URL/DOI/arXiv rows; `1513` surname/key rows; categories may overlap).
...
- Lean lexical candidates awaiting review: `637`
