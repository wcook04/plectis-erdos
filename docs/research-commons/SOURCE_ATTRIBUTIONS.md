...
The registry contains `291` curated sources across `22` registered papers and `1811` Lean library files.
...
- Lean candidates awaiting review: `661` (`3` direct URL/DOI/arXiv rows; `1537` surname/key rows; categories may overlap).
...
- Lean lexical candidates awaiting review: `661`
