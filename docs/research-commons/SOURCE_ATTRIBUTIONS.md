...
The registry contains `196` curated sources across `21` registered papers and `1274` Lean library files.

Source review states: `bibliography_only`: `107`; `existing_source_closure`: `28`; `external_claim_unverified`: `2`; `implemented_advice`: `3`; `source_verified`: `56`.
