...
Plectis is an AI-assisted mathematical research system. This repository is its public proof-bearing corpus: exact propositions, separate statement interfaces, papers, replay instructions, and explicit open boundaries.
...
Read the [problem papers](../README.md#problem-papers) for mathematical motivation, proof ideas, attribution, and the current frontier. Use this packet when you want to audit the exact public statements and replay path.
