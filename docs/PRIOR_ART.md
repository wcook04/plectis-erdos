...
| S. Fan, comment on Erdős Problem #269, [erdosproblems.com forum, thread 269](https://www.erdosproblems.com/forum/thread/269), 26 June 2026 | #269 | Prior public disclosure of the two-prime case: the same two-channel factorisation, the same Hecke–Mahler reduction, and the same transcendence conclusion, with follow-up comments there extending it to arbitrary coprime pairs. Dated 26 June 2026; this note was first released publicly on 22 July 2026, so Fan's disclosure is earlier by 26 days. The argument here was developed independently, which explains the overlap but does not affect priority. | Priority record. This release claims no priority for the two-prime result, and the note's two-prime theorems are not Lean declarations. "Same factorisation and conclusion" is the claim made here; establishing "first public proof" would require a broader priority search than has been done. |
