...
| docs/methodology.json changes | Repository check | only when rule semantics changed | Regenerate docs/METHODOLOGY.md and the corpus descriptor. Rules route review; they do not decide mathematics. |
