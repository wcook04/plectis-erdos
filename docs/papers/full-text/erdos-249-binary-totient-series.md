...
> **Contribution.** The paper gives an explicit basis and relation normal form for the dyadic totient kernel, exposes the squared-Lambert first-gcd-moment identity and a sharp producer-independent squared-Mersenne enclosure, proves level rank $`2^e+1`$, derives the all-base rank $`k^e+1`$ from Martin plus explicit reductions, and checks a finite denominator exclusion together with its first failing certificate scale.
>
...
Each *Checked* line below links the relevant declarations at commit `9e231ce4371f`. The bracketed tags reproduce the public status recorded by the claim registry; where no registry row owns the cited declarations, the text says so rather than assigning a neighbouring status.
...
6.  <span id="res:gcdmoment" label="res:gcdmoment"></span> <span class="smallcaps">\[proved here\]</span> **Squared Lambert layers expose a first gcd moment.** The two exact identities
    ``` math
...
7.  <span id="res:squareenclosure" label="res:squareenclosure"></span> <span class="smallcaps">\[proved here\]</span> **A sharp squared-Mersenne diagonal enclosure.** For the diagonal tail difference $`R_{2H}-R_H`$, let
    ``` math
...
|:---|:---|:---|:---|
| $`\tau`$ | $`1.6066951\ldots=E`$ | $`g\equiv1`$ | The Erdős–Borwein constant; irrational \[erdos1948, theorem on p. 63\]; formalised here in the Lambert form $`\sum_{d\ge1}(2^d-1)^{-1}`$ ([checked](https://github.com/wcook04/plectis-lean-erdos249-257/blob/9e231ce4371fcda607f81c4520d29b16dcb4482e/Erdos249257/CertificateKernel.lean#L8335)) |
...
The hypothesis [asks](https://github.com/wcook04/plectis-lean-erdos249-257/blob/9e231ce4371fcda607f81c4520d29b16dcb4482e/ErdosProblems/Erdos249/TotientStrictPrimeEscape.lean#L157) for cofinally many primes $`p`$ at which the first tail-orbit exponential has real part strictly below $`9/10`$. Granting it, [a positive adaptive truncation budget](https://github.com/wcook04/plectis-lean-erdos249-257/blob/9e231ce4371fcda607f81c4520d29b16dcb4482e/ErdosProblems/Erdos249/TotientStrictPrimeEscape.lean#L166) follows, and then [$`S`$ is irrational](https://github.com/wcook04/plectis-lean-erdos249-257/blob/9e231ce4371fcda607f81c4520d29b16dcb4482e/ErdosProblems/Erdos249/TotientStrictPrimeEscape.lean#L205). The $`9/10`$ hypothesis is weaker than the earlier $`4/5`$ hypothesis, but no instance of this cofinal hypothesis is proved. Section <a href="#sec:frontier" data-reference-type="ref" data-reference="sec:frontier">8</a> states the sharper form in which this hypothesis is now available.
...
```
([first difference](https://github.com/wcook04/plectis-lean-erdos249-257/blob/9e231ce4371fcda607f81c4520d29b16dcb4482e/ErdosProblems/Erdos249/FiniteEulerSieve.lean#L44)), and for every $`e\ge0`$,
``` math
