...
Equivalent formulation <a href="#res:canonicalmersenne" data-reference-type="ref" data-reference="res:canonicalmersenne">8</a> carries no mark and is proved in Lean; the link follows its proof.
...
```
This proves Theorem <a href="#thm:kkernelrank" data-reference-type="ref" data-reference="thm:kkernelrank">1</a>.

The relation to the earlier CRT argument and the alternative proof from Martin’s theorem are discussed in Appendix <a href="#app:sources" data-reference-type="ref" data-reference="app:sources">7</a>.
...
<a id="a-finite-denominator-exclusion"></a>
