...
The certificate is decidable at each $`t`$, and is kernel-checked at the $`28`$ listed scales between $`t=1`$ and $`t=64`$ ([list](https://github.com/wcook04/plectis-lean-erdos249-257/blob/599f7e50a15b288f27f9b57ece16fdd396cb6d76/Erdos249257/DiagonalPincerCertificatesT64.lean#L1933), [verification](https://github.com/wcook04/plectis-lean-erdos249-257/blob/599f7e50a15b288f27f9b57ece16fdd396cb6d76/Erdos249257/DiagonalPincerCertificatesT64.lean#L1967)). Later work extends the checked band to every $`t\le82`$; that module postdates this note’s pinned snapshot, so the claim registry, rather than a source link here, records the wider band. The theorem through $`t=82`$ supplies no instance at $`t=83`$ and does not discharge the cofinal quantifier.
...
2.  The lcm-diagonal and clean cyclotomic-anchor statements are exact equivalent formulations. Their finite certificates are checked instances, not evidence for the missing cofinal quantifier.

3.  Full-depth period-multiple escape and the four first-harmonic pivot bounds are stronger sufficient producers. Failure of either would refute only that route.
