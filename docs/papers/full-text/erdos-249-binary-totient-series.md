...
For every $`e\ge1`$, the dyadic sections of Euler’s totient through level $`e`$ have rational rank $`2^e+1`$. The two zero-residue sections and the odd-residue sections form a basis, and two families of scalar reductions generate every relation. Divisibility makes an evaluation matrix diagonal modulo a prime, with nonzero diagonal entries. The [dyadic rank $`2^e+1`$](https://github.com/wcook04/plectis-erdos/blob/99f4bf47422abbd8757cbb22b50ba079d764d3a7/Erdos249257/TotientMahlerDefect.lean#L1084) holds for $`e\ge1`$. The all-base rank $`k^e+1`$ is the [rank transferred from linear independence](https://github.com/wcook04/plectis-erdos/blob/99f4bf47422abbd8757cbb22b50ba079d764d3a7/Erdos249257/TotientKernelConditional.lean#L215), using Martin’s external independence; Coons owns non-$`k`$-regularity of $`\varphi`$, equivalently infinite-dimensionality for integer-valued sequence modules. A separate ordinary argument treats bounded-residue series $`A_m`$. Finite Farey exclusion and Lean diagonal certificates through $`t\le 82`$ are finite; neither $`t=83`$ nor an unbounded family is supplied. Separately, $`\sum_{n\ge1}(\varphi(n)\bmod m)2^{-n}`$ is irrational for every $`m\ge3`$, with a complete rationality classification at dyadic moduli. For $`S=\sum_{n\ge1}\varphi(n)2^{-n}`$, one nonintegral tail shift forces full-depth certificates in every sufficiently late pair of multipliers. Irrationality is equivalent to an explicit central-residue gap for every prospective denominator; its arithmetic supply remains open.
...
1.  <span id="res:rank" label="res:rank"></span> <span class="smallcaps">\[unconditional progress\]</span> **Exact finite-level rank.** Theorem <a href="#thm:kkernelrank" data-reference-type="ref" data-reference="thm:kkernelrank">2</a> is the coordinate statement: every totient $`k`$-kernel truncation has rank $`k^e+1`$. The dyadic case is the [exact finite-truncation rank](https://github.com/wcook04/plectis-erdos/blob/99f4bf47422abbd8757cbb22b50ba079d764d3a7/Erdos249257/TotientMahlerDefect.lean#L1084); the all-base form is [the same count from an independent family](https://github.com/wcook04/plectis-erdos/blob/99f4bf47422abbd8757cbb22b50ba079d764d3a7/Erdos249257/TotientKernelConditional.lean#L215), and is not a Lean theorem without Martin’s hypothesis.
