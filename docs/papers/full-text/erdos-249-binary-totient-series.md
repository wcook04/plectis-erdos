...
Allouche and Shallit introduced $`k`$-regular sequences \[allouche-shallit\]. Coons proved that $`\varphi`$ is not $`k`$-regular \[coons, Thm. 3.2\]. Martin’s Theorem 1 makes the ratios of totients on any prescribed finite list of pairwise nonproportional affine forms with integer coefficients and positive slopes arbitrarily separated; this implies their linear independence \[martin-phi-inequalities, Thm. 1\]. Section <a href="#sec:rank" data-reference-type="ref" data-reference="sec:rank">1.1</a> gives a direct determinant proof tailored to the sections used here. The basis theorem gives the exact finite-level normal form. Wong \[wong2015\] proved least-residue irrationality when the denominator base and modulus are the same integer $`k>2`$; Section <a href="#sec:family" data-reference-type="ref" data-reference="sec:family">2</a> fixes base two and classifies dyadic observables. The original question appears in Erdős and Graham \[erdosgraham1980, p. 61\].
