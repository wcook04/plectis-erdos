...
| Critical-value budget through degree five | Ordinary theorem; scalar Lean companion | $`\sum_j|f(c_j)|^{1/n}\le(n-1)R`$ for $`2\le n\le5`$; the reflected-derivative comparison is checked in Lean; the complete finite-point inequalities remain ordinary proofs, and neither controls inverse-ray length. |
...
The identity <a href="#eq:abel-control-polygon" data-reference-type="eqref" data-reference="eq:abel-control-polygon">[eq:abel-control-polygon]</a> is checked as [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/AbelControlPolygon.lean#L123), the constant-term bound as [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/AbelControlPolygon.lean#L258), the radial estimate as [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/AbelControlPolygon.lean#L219), and their combination with the metric budget as [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/AbelControlPolygon.lean#L330). Example <a href="#ex:sextic-spoke" data-reference-type="ref" data-reference="ex:sextic-spoke">3</a> is checked as [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/AbelControlPolygon.lean#L555). What the kernel proves is the pair of radial inequalities and the bound $`|\zeta_1|+|\zeta_2|<2`$ on the sum of the two radii. Assembling those into a single rectifiable path object, and the passage to the one-dimensional Hausdorff measure used by the upstream statement of the problem, are ordinary steps taken here. Prior art for the trinomial conclusion was searched on 2 September 2026 and none was located; the argument is short enough that it should be assumed known until a source settles the question.
...
This is exactly the statement selected as [the formal Chebyshev endpoint](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ExternalVerification1041SolvedFamilies/Solution.lean#L74). It is the kernel-facing alternation endpoint, not yet the geometric theorem.
...
This is the exact finite conclusion selected as [the formal two-tail selector](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ExternalVerification1041SolvedFamilies/Solution.lean#L24). It selects two distinct indices. It does not assert that the corresponding complex root values are distinct.
...
This is exactly [the formal cubic safe-spoke theorem](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ExternalVerification1041SolvedFamilies/Solution.lean#L14).
...
```
and Lean checks the [exact primitive](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/research_corpus/Erdos1041/QuarticQuotientFiberCase.lean#L37)
``` math
...
**Theorem 23** (critical-value budget in degrees two through five). *Let $`f`$ be monic of degree $`2\le n\le5`$, with roots in a disk of radius $`R`$. If $`c_1,\ldots,c_{n-1}`$ are its critical points counted with multiplicity, then
``` math
\begin{equation}
...
(3-Q)(3+Q-|s|^2+E_2)=9-\Delta,
 ...
 \Delta=\frac12\sum_{i<j}(|c_i|^2-|c_j|^2)^2
          +QE_2+(3-Q)|s|^2\ge0.
```
Thus $`S\le3`$. Equality forces equal moduli and $`QE_2=0`$, hence all three points are zero; conversely the zero configuration attains equality. The bound comes from this defect identity. It is not obtained by separately maximising the pairwise factors.
...
N(z)=-\frac{f(z)}{f'(z)} .
```
Let $`I`$ be an interval, let $`z\colon I\to\mathbb C`$ be differentiable with $`f'(z(t))\ne0`$ and $`z'(t)=N(z(t))`$ throughout $`I`$, and put $`w(t)=f(z(t))`$.
...
**Corollary 26** (ray separation). *If a solution as above runs on a compact interval and its two endpoint values are nonzero, those values lie on the same oriented ray from $`0`$. Consequently, if two critical values lie on distinct positive rays, no finite Newton-flow connection joins the corresponding critical points.*
...
```
([](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L287)). A constant translation cannot separate initially equal critical values.
...
- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L34)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L38)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L50)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L64)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L77)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L80)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L84)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L92)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L107)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L127)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L130)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L147)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L152)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L162)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L179)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L197)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L230)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L257)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L287)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L325)

- [](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/NewtonFlowRaySeparation.lean#L334)
...
For the translated cubic and quartic quotient families $`f(z)=P((z-h)^q)`$ the metric theorems are ordinary; the kernel checks the cyclic-fibre mean square and the quotient-disk bridge. The fibre norm identity is [fibre mean square](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/CyclicFiberMeanSquare.lean#L21), the strict unit bound is [fibre unit bound](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/CyclicFiberMeanSquare.lean#L37), the quotient roots land in the open disk by [quotient disk bridge](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/CyclicFiberMeanSquare.lean#L60), and the composition vanishes on the fibre by [fibre zero identity](https://github.com/wcook04/plectis-lean-erdos249-257/blob/1da2a504f8d8aa3cdc2cf686ec48bc8a67457984/ErdosProblems/Erdos1041/CyclicFiberMeanSquare.lean#L73).
...
**Reader position.** 7 of 93; display band: front door. Formal editorial disposition: split. These are separate classifications.

**Reader entry.** This family gathers the strongest geometric bridges, solved regimes, and sharp obstructions around the search for a short contained root-to-root path.
...
**Result-atom population.** 51 of 704 public coordinates. The public atom catalog groups them under this family.
...
**Reader position.** 13 of 93; display band: major result. Formal editorial disposition: split. These are separate classifications.

**Reader entry.** Exact Newton transport supports a large collection of connector, capacity, allocation, and local-atlas results that must ultimately be split by mechanism.
...
**Result-atom population.** 95 of 704 public coordinates. The public atom catalog groups them under this family.
...
<a id="critical-value-mean-budget"></a>

## Critical value mean budget

**Reader position.** 30 of 93; display band: major result. Formal editorial disposition: promote. These are separate classifications.

**Reader entry.** For monic f of degree 2 \<= n \<= 5 with roots in any radius-R disk, sum_j \|f(c_j)\|^(1/n) \<= (n-1)R, counting critical multiplicities, sharply. In every degree FP\_(n-1) implies the budget: the reflected derivative and maximum modulus give \|f(c_j)\| \<= product_k \|1-conj(c_j)c_k\| in the unit disk, radial contraction handles the boundary, and concavity supplies exponent 1/n. FP1-FP4 settle degrees two through five.

For monic f of degree 2 \<= n \<= 5 with roots in any radius-R disk, sum_j \|f(c_j)\|^(1/n) \<= (n-1)R, counting critical multiplicities, sharply. In every degree FP\_(n-1) implies the budget: the reflected derivative and maximum modulus give \|f(c_j)\| \<= product_k \|1-conj(c_j)c_k\| in the unit disk, radial contraction handles the boundary, and concavity supplies exponent 1/n. FP1-FP4 settle degrees two through five.

**Authority and reach.** Ordinary paper and research-note proofs; scalar Lean support is not a formalization of this theorem; ordinary proved auxiliary theorem; novelty unassessed.

**Exact boundary.** The reflected-derivative inequality is Lean-checked; the finite-point argument remains an ordinary proof, and Comparator replay of the reflected inequality is pending. The budget bounds critical values, not path lengths or hub selection. FP_m remains open here for m \>= 5; the radial family attains equality.
...
<a id="low-critical-path-certificate"></a>

## Low critical path certificate

**Reader position.** 31 of 93; display band: major result. Formal editorial disposition: promote. These are separate classifications.

**Reader entry.** For any squarefree monic complex polynomial of degree at least two, minimum critical-value modulus at most 13/25 guarantees a rectifiable path of length below two between distinct roots inside its open unit lemniscate, with no root-location restriction. The proof combines hyperbolic root separation, a first-merger Green-function lower bound, and an area-growth contradiction; a portable exact rational certificate validates the threshold.

For any squarefree monic complex polynomial of degree at least two, minimum critical-value modulus at most 13/25 guarantees a rectifiable path of length below two between distinct roots inside its open unit lemniscate, with no root-location restriction. The proof combines hyperbolic root separation, a first-merger Green-function lower bound, and an area-growth contradiction; a portable exact rational certificate validates the threshold.

**Authority and reach.** Ordinary analytic proof plus exact rational computational certificate; ordinary restricted metric theorem with exact rational certificate.

**Exact boundary.** The sufficient small-critical-value condition is not proved for every unit-disk root configuration, so this does not solve the general problem. The analytic chain and certificate are not Lean formalized. Public source: research_corpus/Erdos1041/LowCriticalPathCertificate.md; replay: experiments/erdos1041_low_critical_path_certificate.py.
...
**Reader position.** 42 of 93; display band: mechanism. Formal editorial disposition: split. These are separate classifications.

**Reader entry.** Ray separation explains why certain Newton and straight-spoke connectors fail and identifies curvature, grouping, or compensation as the necessary alternatives.
...
**Result-atom population.** 19 of 704 public coordinates. The public atom catalog groups them under this family.
...
**Reader position.** 67 of 93; display band: frontier. Formal editorial disposition: split. These are separate classifications.

**Reader entry.** A local gap in a claimed proof is paired with exact component-capacity tools and a selector counterexample that clarify what a repair would have to overcome.
...
**Reader position.** 75 of 93; display band: frontier. Formal editorial disposition: split. These are separate classifications.

**Reader entry.** Finite searches, exact counterexamples, and rigorous local connector charts map the boundary between failed global heuristics and provable subcases.
...
**Reader position.** 84 of 93; display band: technical support. Formal editorial disposition: split. These are separate classifications.

**Reader entry.** Small translations avoid finitely many collision lines, providing a clean genericity tool while later wall results retain their separate metric obligations.
