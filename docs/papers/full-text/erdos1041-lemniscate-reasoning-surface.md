...
The problem numbering follows Bloom’s Erdős problem catalogue \[bloom\]. A degree-seven counterexample to the unrestricted assertion has been reported to the author. Its proof is not reproduced or independently verified in this revision. We therefore refer to the displayed assertion as the historical question, not as an assertion that the unrestricted bound remains open. The original source is Problem 5 on printed p. 139 of Erdős–Herzog–Piranian \[ehp1958, Problem 5, p. 139\]; the preceding paragraph records the known input that one component of the lemniscate contains at least two zeros.
