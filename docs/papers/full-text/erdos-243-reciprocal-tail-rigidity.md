...
Write $`\operatorname{def}(a,a')=a'-\operatorname{syl}(a)`$ for the deviation of the next term from the Sylvester successor, the [Sylvester defect](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L53).
...
Formalised as the [local rigidity step](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L1781). The hypothesis $`C_{n+1}\ne0`$ is not removable: at $`C_{n+1}=0`$ the identity gives no information about $`a'`$.
...
Formalised as the [shifted consecutive multiples](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L833).
...
```
The checked [tail-height estimate](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L2164) and normalised vanishing make $`|E_n|`$ subexponential in $`n`$.
...
```
the [forced numerator](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/FiniteHorizonResidue.lean#L22), and the divisor is $`n+2`$. The orbit survives a step when that division is exact, giving a survival predicate, the [survival predicate](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/FiniteHorizonResidue.lean#L74). Example <a href="#ex:shape" data-reference-type="ref" data-reference="ex:shape">11</a> is the forced orbit from $`a=3`$ read this way: $`\operatorname{num}(0,3)=6`$ is divisible by $`2`$ and gives $`a_1=3`$, while $`\operatorname{num}(1,3)=13`$ is not divisible by $`3`$, so the orbit stops there. Deciding survival by iteration is expensive because the orbit grows doubly exponentially, and it is unnecessary: survival over a finite horizon depends on the initial value only through a factorial residue.
...
Formalised as the [factorial residue reduction](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/FiniteHorizonResidue.lean#L133), over the [shrinking-modulus transport](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/FiniteHorizonResidue.lean#L96), the [polynomial congruence](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/FiniteHorizonResidue.lean#L26), and the [exact-division cancellation](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/FiniteHorizonResidue.lean#L42); the modulus identifications are the [ascending-factorial form](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/FiniteHorizonResidue.lean#L58) and the [factorial value at the initial index](https://github.com/wcook04/plectis-lean-erdos249-257/blob/8757777b0e944daaa526d3632023be962d204463/ErdosProblems/Erdos243/FiniteHorizonResidue.lean#L68).
