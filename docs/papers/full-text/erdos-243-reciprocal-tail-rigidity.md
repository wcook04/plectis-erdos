...
Write $`\operatorname{def}(a,a')=a'-\operatorname{syl}(a)`$ for the deviation of the next term from the Sylvester successor, the [Sylvester defect](https://github.com/wcook04/plectis-lean-erdos249-257/blob/63a7f05c17da22556344c74f871bbf34f0c1ede6/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L53).
...
Formalised as the [local rigidity step](https://github.com/wcook04/plectis-lean-erdos249-257/blob/63a7f05c17da22556344c74f871bbf34f0c1ede6/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L1781). The hypothesis $`C_{n+1}\ne0`$ is not removable: at $`C_{n+1}=0`$ the identity gives no information about $`a'`$.
...
Formalised as the [shifted consecutive multiples](https://github.com/wcook04/plectis-lean-erdos249-257/blob/63a7f05c17da22556344c74f871bbf34f0c1ede6/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L833).
...
```
The checked [tail-height estimate](https://github.com/wcook04/plectis-lean-erdos249-257/blob/63a7f05c17da22556344c74f871bbf34f0c1ede6/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L2164) and normalised vanishing make $`|E_n|`$ subexponential in $`n`$.
...
The [pinned formal-source revision](https://github.com/wcook04/plectis-lean-erdos249-257/tree/63a7f05c17da22556344c74f871bbf34f0c1ede6) contains the Lean sources, the fixed toolchain, and the library manifest used in the verification. This manuscript provides navigation rather than proof authority.
