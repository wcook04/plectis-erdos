...
At the local arithmetic level, we also isolate the exact mechanism that a reduced two-step orbit must obey. The cancellation factors survive in a non-autonomous second-order recurrence, and a separate feedback identity shows exactly when a square-residue calculation is realised by the next multiplier. These are structural interfaces, not a termination theorem.
...
> **Contribution.** The paper develops the exact centred-state recurrence, proves zero-state absorption, excludes constant and periodic negative magnitudes, and conditionally excludes both the cofinally bounded-negative branch and the finite normalised-negative-mass branch.
>
> **Relation to the open problem.** The two recovery criteria retain their respective positivity, dynamics, centring, normalised-vanishing, boundedness, and summability hypotheses. The mixed-sign and unbounded-negative regimes keep Problem #243 open.
>
> **Executable review object.** Comparator selects the eventually periodic negative-orbit obstruction, the conditional exclusion of a cofinally bounded negative state, and the exact finite-negative-mass recovery interface [summable negative-mass recovery](https://github.com/wcook04/plectis-lean-erdos249-257/blob/c55323931665f57dcf4600a674696e2ee10042bc/ErdosProblems/Erdos243/SparseResetRecovery.lean#L175). The latter is a conditional state-system implication, not a prime-specific producer or an unconditional \#243 endpoint; the missing summability of the canonical orbit remains explicit. The repository’s external-verification job compares these exact Lean propositions with separately declared challenge statements and an axiom budget, then asks Lean’s kernel to check the submitted proofs. The [formalisation manifest](https://github.com/wcook04/plectis-lean-erdos249-257/blob/main/formalization.yaml) and the commit-bound CI receipt record that check; they do not assess novelty, significance, or whether the original problem is solved.

For release review, the selected Comparator rows are exact. The declaration `no_eventuallyPeriodicNegative_orbit` excludes a positive-period, positive-drift negative orbit under $`2\le a_n`$, $`0<e_{N+n}<a_{N+n}`$, the displayed denominator and centred-state recurrences, and the eventual period and phase-drift equations. The declaration `no_cofinallyBoundedNegative_of_normalizedVanishes` excludes a cofinally bounded negative magnitude under positivity, bounded rise, the same recurrences, normalised vanishing, and the cofinal negative-state relation. The source-current `negative_mass_recovery` row adds the distinct criterion obtained from summability of $`\sum_n(-E_n)_+/C_n`$, with exact declarations `eventually_zero_of_summable_negativeRelativeMass` and `sylvesterNext_eventually_of_summable_negativeRelativeMass`. It assumes the displayed dynamics, positivity, strict centred step, normalised vanishing, and summability; it supplies no canonical-orbit summability or prime-specific producer. These are conditional exclusions only; mixed-sign and unbounded-negative regimes remain outside their conclusions.
...
The *Formal Conjectures* collection contains a mathematically equivalent unproved declaration, up to its zero-based indexing  \[formalconjectures243\]. Its summand is $`\mathbb{Q}`$-valued, so Lean’s `Summable` hypothesis asserts the existence of a sum in $`\mathbb{Q}`$; the finite indexing shift changes that sum only by a rational prefix. The declaration therefore does encode the rationality premise, but its proof is `sorry`. We use it as statement-level prior art, not as proof authority; the development below is independent of it. What is machine-checked below concerns the state system rather than the analytic problem: the exclusion of constant and periodic negative magnitudes, the bounded-rise barrier of Theorem <a href="#res:barrier" data-reference-type="ref" data-reference="res:barrier">18</a>, and the two conditional endpoints (Theorems <a href="#res:bounded" data-reference-type="ref" data-reference="res:bounded">23</a> and <a href="#res:mass" data-reference-type="ref" data-reference="res:mass">25</a>), each stated with the exact hypotheses that separate it from Problem #243. No claim of priority is made for anything below.
...
| Eventual vanishing forces the recurrence | Proved here | Theorem <a href="#res:eventual" data-reference-type="ref" data-reference="res:eventual">10</a>. |
| Zero is absorbing | Proved here | Theorem <a href="#res:absorb" data-reference-type="ref" data-reference="res:absorb">11</a>, under strict centring. |
| Nonnegative $`E`$ | Proved here | Theorem <a href="#res:descent" data-reference-type="ref" data-reference="res:descent">12</a>, by descent. |
| Constantly negative $`E`$ | Excluded here | Theorem <a href="#res:constant" data-reference-type="ref" data-reference="res:constant">14</a>, at any magnitude and scale. |
| Periodic negative magnitude | Excluded here | Theorem <a href="#res:periodic" data-reference-type="ref" data-reference="res:periodic">15</a>, in the regime $`e_n<a_n`$ and with positive drift $`M>0`$. |
| Coprime-modulus barrier | Proved here | Theorem <a href="#res:barrier" data-reference-type="ref" data-reference="res:barrier">18</a>. |
| Bounded negative part | Excluded here; conditional | Theorem <a href="#res:bounded" data-reference-type="ref" data-reference="res:bounded">23</a>; see its hypotheses. |
| Normalised vanishing alone | Gcd changes are sparse | Proposition <a href="#res:gcdsparse" data-reference-type="ref" data-reference="res:gcdsparse">22</a>; arbitrarily late finite constant blocks, not eventual constancy. |
| Finite normalised negative mass | Excluded here; conditional | Theorem <a href="#res:mass" data-reference-type="ref" data-reference="res:mass">25</a>, Section <a href="#sec:mass" data-reference-type="ref" data-reference="sec:mass">9</a>; normalised vanishing remains an input. |
| Factorial residue reduction | Proved here; superseded for its original purpose | Theorem <a href="#res:residue" data-reference-type="ref" data-reference="res:residue">33</a>, Appendix <a href="#app:residue" data-reference-type="ref" data-reference="app:residue">12</a>. |
...
| Unbounded, divergent-mass negative excursions | Necessary conditions proved here; orbit-level case open | Section <a href="#sec:open" data-reference-type="ref" data-reference="sec:open">10</a>: Proposition <a href="#res:frontier" data-reference-type="ref" data-reference="res:frontier">27</a> gives conditions any counterexample must satisfy, not a separate open problem; Problem <a href="#res:excursions" data-reference-type="ref" data-reference="res:excursions">28</a> is the surviving orbit-level obstruction. |
| Erdős–Straus criterion; Duverney | Proved elsewhere | Cited, not formalised; the Erdős–Straus hypothesis is implied by that of Theorem <a href="#res:descent" data-reference-type="ref" data-reference="res:descent">12</a>. |
...
Write $`\operatorname{def}(a,a')=a'-\operatorname{syl}(a)`$ for the deviation of the next term from the Sylvester successor, the [Sylvester defect](https://github.com/wcook04/plectis-lean-erdos249-257/blob/c55323931665f57dcf4600a674696e2ee10042bc/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L53).
...
Formalised as the [local rigidity step](https://github.com/wcook04/plectis-lean-erdos249-257/blob/c55323931665f57dcf4600a674696e2ee10042bc/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L1781). The hypothesis $`C_{n+1}\ne0`$ is not removable: at $`C_{n+1}=0`$ the identity gives no information about $`a'`$.
...
This is the [two-step primitive recurrence](https://github.com/wcook04/plectis-lean-erdos249-257/blob/c55323931665f57dcf4600a674696e2ee10042bc/ErdosProblems/Erdos243/DynamicCancellation.lean#L268). Its hard point is not a formal induction: it keeps both changing cancellation factors visible. Thus it is stronger than a one-step congruence, but it is not an autonomous recurrence and cannot by itself force $`a_1=a^2-a+1`$.
...
These three identities do not manufacture the hypotheses of the orbit. In particular, they do not prove that cancellation is eventually absent, that the curvature has one sign, or that the feedback gate is met cofinally; the global mixed-sign and unbounded-negative regimes of Problem #243 remain open.
...
Formalised as the [shifted consecutive multiples](https://github.com/wcook04/plectis-lean-erdos249-257/blob/c55323931665f57dcf4600a674696e2ee10042bc/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L833).
...
Assembling the previous section gives Theorem <a href="#res:bounded" data-reference-type="ref" data-reference="res:bounded">23</a>, the endpoint of the barrier argument. Theorem <a href="#res:mass" data-reference-type="ref" data-reference="res:mass">25</a> in the next section is a second endpoint under a different finiteness hypothesis, and neither theorem contains the other. Theorem <a href="#res:mass" data-reference-type="ref" data-reference="res:mass">25</a> assumes no orbit structure, only the state recurrence with $`C_n>0`$, so it is not a special case of Theorem <a href="#res:bounded" data-reference-type="ref" data-reference="res:bounded">23</a>; conversely hypothesis (5) below does not imply finite *normalised negative mass*, by which we mean convergence of $`\sum_n(-E_n)_+/C_n`$, where $`x_+=\max(x,0)`$, since a constant negative part $`-b`$ gives $`C_n\sim bn`$ and hence a divergent sum. The hypotheses of Theorem <a href="#res:bounded" data-reference-type="ref" data-reference="res:bounded">23</a> are listed in full, because two of them are analytic inputs that are assumed here rather than derived from the growth condition of Problem <a href="#res:problem" data-reference-type="ref" data-reference="res:problem">1</a>.
...
\end{equation}
```
This is the [repair-entropy conservation law](https://github.com/wcook04/plectis-lean-erdos249-257/blob/c55323931665f57dcf4600a674696e2ee10042bc/ErdosProblems/Erdos243/RepairEntropy.lean#L48).
...
```
The checked [tail-height estimate](https://github.com/wcook04/plectis-lean-erdos249-257/blob/c55323931665f57dcf4600a674696e2ee10042bc/ErdosProblems/Erdos243/ReciprocalTailRigidity.lean#L2164) and normalised vanishing make $`|E_n|`$ subexponential in $`n`$.
...
The [pinned formal-source revision](https://github.com/wcook04/plectis-lean-erdos249-257/tree/c55323931665f57dcf4600a674696e2ee10042bc) contains the Lean sources, the fixed toolchain, and the library manifest used in the verification. This manuscript provides navigation rather than proof authority.
