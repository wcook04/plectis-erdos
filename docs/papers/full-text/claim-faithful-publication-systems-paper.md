...
Problem-sized worlds join formal declarations, experiments, sources, failed mechanisms, and open obligations. Separate graphs record formal dependencies, mathematical meaning, and public claims. A compiled entry packet states the endpoint, claim ceiling, omissions, and context-budget overflow. The implemented architecture connects scoped research changes, checks, and reviewed public wording without transferring authority between them. The related-work section compares it with neighbouring systems along stated dimensions and claims no priority.
...
The public Lean repository contains papers, claims, navigation, and release checks that a fresh clone can inspect. Problem 257 has a Lean-checked finite-prime weighted criterion: a convergent base-two weighted mass makes its subseries irrational at every integer base at least two, even for some supports with divergent reciprocal sum. Arbitrary infinite supports remain open. A finite certificate for Problem 249 does not settle its unbounded question. The degree-seven example due to `ani` refutes the total-variation formulation of 1041; its correspondence with the historical curve-length question remains unreviewed. The other programmes are not claimed solved. This is a prototype, not a validated multi-user service: by 14 September 2026, no completed external cold-clone use or accepted contribution was recorded.
...
| What may the project say, and what remains open? | [`docs/claims.json`](https://github.com/wcook04/plectis-erdos/blob/402497d8e1ae025518ee34190664e8f67aa40f93/docs/claims.json) and [`docs/methodology.json`](https://github.com/wcook04/plectis-erdos/blob/402497d8e1ae025518ee34190664e8f67aa40f93/docs/methodology.json) |
...
| How can I navigate without reading the whole corpus? | [`docs/ORIENTATION.md`](https://github.com/wcook04/plectis-erdos/blob/402497d8e1ae025518ee34190664e8f67aa40f93/docs/ORIENTATION.md) and [`scripts/query_corpus.py`](https://github.com/wcook04/plectis-erdos/blob/402497d8e1ae025518ee34190664e8f67aa40f93/scripts/query_corpus.py) |
...
| What does the local review selection qualify? | [`PALOMAR_QUALIFICATION.md`](https://github.com/wcook04/plectis-erdos/blob/402497d8e1ae025518ee34190664e8f67aa40f93/docs/verification/PALOMAR_QUALIFICATION.md) and [`docs/PALOMAR_RESULT_SHOWCASE.json`](https://github.com/wcook04/plectis-erdos/blob/402497d8e1ae025518ee34190664e8f67aa40f93/docs/PALOMAR_RESULT_SHOWCASE.json) |
| Which papers exist and what question does each answer? | [`docs/papers/README.md`](https://github.com/wcook04/plectis-erdos/blob/402497d8e1ae025518ee34190664e8f67aa40f93/docs/papers/README.md) |
