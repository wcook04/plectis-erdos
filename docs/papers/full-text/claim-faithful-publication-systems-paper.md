...
Computation supplies finite evidence; Lean verifies that a proof establishes the formal statement written in the source; Comparator checks selected propositions and their axiom boundary. These checks do not establish intended meaning, novelty, importance or external acceptance.

The public repository is a self-contained output whose Lean source, claim record, papers, navigation, and release checks can be inspected from a fresh clone. A worked example follows a finite certificate for Erdős Problem 249 and shows why a checked finite range cannot become an unbounded conclusion. This is a working prototype rather than a validated multi-user service. As of 14 September 2026, the author had not recorded a completed external cold-clone use or an accepted external contribution. The 257 lane formalises the classical full-support irrationality theorem, but not the arbitrary-support question. The degree-seven example due to `ani` refutes the total-variation formulation of 1041; correspondence with the historical curve-length question remains unreviewed. For the other seven programmes, it does not claim a solution to any of them.
...
**Contribution.** The prototype keeps six authorities separate and makes every transition from conjecture to public wording carry its evidence and its limit. Problem-sized worlds join formal dependencies, mathematical interpretation, failed routes, and reviewed claims without treating any one graph as authority for the others. **Demonstration.** The mechanism is exercised on a self-contained public Lean corpus and an audited finite certificate for Erdős Problem 249. **Ceiling.** The 1041 total-variation formulation is refuted, but its historical correspondence remains unreviewed; the other seven target programmes remain unresolved here, and external use remains untested.
...
The [public repository studied here](https://github.com/wcook04/plectis-erdos) contains Lean source, papers, and release machinery around eight Erdős problem programmes. The degree-seven counterexample due to [`ani`](https://www.erdosproblems.com/forum/thread/1041#post-8861) is formalised in Lean here and refutes the total-variation formulation of Problem 1041. Its correspondence with the historical curve-length question has not had independent human review; the other seven target problems remain unresolved here. The repository also contains intermediate theorems, exact reformulations, conditional reductions, finite certificates, and no-go results. Private development explains the provenance; public claims rely only on the published evidence.
...
The same architecture handles other shapes of progress. Problem 257 separates the formalised classical full-support irrationality theorem, for every integer base at least two, from the stronger arbitrary-support statement that remains open. The cross-problem synthesis gives an exact rejection of $`189/388`$ at the seventeenth step of a Mersenne greedy test. This disproves a proposed stopping extrapolation, but finite survival still does not prove membership. Problem 68 has an exact carry-based equivalence but no theorem producing the required carries. Problem 251 has an exact series reformulation rather than an irrationality proof, and Problem 243 records a conditional recovery theorem whose premises remain part of the public claim. A counterexample or corrected statement, as in the 1041 lane, is also a first-class result. The publication rule is identical in every case: preserve the quantifiers, premises, and nearest stronger open statement.
...
| Question | Start here |
|:---|:---|
| How does the public repository fit together? | [`docs/ARCHITECTURE.md`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/docs/ARCHITECTURE.md) |
| What may the project say, and what remains open? | [`docs/claims.json`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/docs/claims.json) and [`docs/methodology.json`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/docs/methodology.json) |
| Where is the checked mathematics? | [`lean/Erdos249257.lean`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/lean/Erdos249257.lean) and [`lean/ErdosProblems.lean`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/lean/ErdosProblems.lean) |
| How can I navigate without reading the whole corpus? | [`docs/ORIENTATION.md`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/docs/ORIENTATION.md) and [`scripts/query_corpus.py`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/scripts/query_corpus.py) |
| What exactly does Comparator check? | [`docs/EXTERNAL_VERIFICATION.md`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/docs/EXTERNAL_VERIFICATION.md) and [`verification/comparator.json`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/verification/comparator.json) |
| What does the local review selection qualify? | [`PALOMAR_QUALIFICATION.md`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/docs/verification/PALOMAR_QUALIFICATION.md) and [`docs/PALOMAR_RESULT_SHOWCASE.json`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/docs/PALOMAR_RESULT_SHOWCASE.json) |
| Which papers exist and what question does each answer? | [`docs/papers/README.md`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/docs/papers/README.md) |
| Which checks gate a release? | [`scripts/check_release.py`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/scripts/check_release.py) and [`.github/workflows/lean.yml`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/.github/workflows/lean.yml) |
| How can work return with public credit? | [`CONTRIBUTING.md`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/CONTRIBUTING.md) and [`research-commons/CONTRIBUTIONS.md`](https://github.com/wcook04/plectis-erdos/blob/1d70482583cc9c662cd3b86f66d75c54bb405aa6/docs/research-commons/CONTRIBUTIONS.md) |
