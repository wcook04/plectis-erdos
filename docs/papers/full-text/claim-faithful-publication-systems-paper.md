...
Readers focused on the release design may skip Sections <a href="#sec:mathrole" data-reference-type="ref" data-reference="sec:mathrole">3.1</a>–<a href="#sec:formal-evidence" data-reference-type="ref" data-reference="sec:formal-evidence">3.2</a>; Section <a href="#sec:record" data-reference-type="ref" data-reference="sec:record">3.4</a> resumes with the reviewed record. Section <a href="#sec:picture" data-reference-type="ref" data-reference="sec:picture">2</a> shows the workflow; Sections <a href="#sec:trust" data-reference-type="ref" data-reference="sec:trust">4</a>–<a href="#sec:limits" data-reference-type="ref" data-reference="sec:limits">6</a> give its guarantees, observed failure, and limits.
...
The repair made the clause a required anchor. The current README passes and a false copy, the *boundary witness*, fails. This distinguishes one known false neighbour. The other nine edits were not rerun against the extended checklist, so there is no post-repair aggregate result.
...
The evidence marks a coverage boundary, not a reliability score. The edits were authored by the checker’s author; human review was omitted, and only five of seven relationship kinds were probed. Reader error, ordinary use, and transfer were not measured.
...
The systems contribution is an executable distinction: declaration inventory and routing can be exhaustive while statement-level interpretation and public claim review remain selective. The release gate preserves configured, reviewed boundaries and a negative fixture now catches one historically escaped strengthening. It does not establish semantic truth, complete selection of public claims, a detection rate, or transfer to another repository. A passing workflow says only that Lean accepted the formal proofs and the configured structural checks passed on the named revision.
