...
Say that $`x`$ and $`y`$ lie in the same *logarithmic cell* when $`\lfloor\log_b x\rfloor=\lfloor\log_b y\rfloor`$ for each of $`b=p,q,r`$: the [cell relation](https://github.com/wcook04/plectis-lean-erdos249-257/blob/0f41cf184ec7490b9713e7a7be681db1dd9e5084/ErdosProblems/Erdos269/ThreePrimeRunningLcm.lean#L163).
...
Formalised as the [short-interval uniqueness](https://github.com/wcook04/plectis-lean-erdos249-257/blob/0f41cf184ec7490b9713e7a7be681db1dd9e5084/ErdosProblems/Erdos269/ThreePrimeRunningLcm.lean#L509). The hypothesis is that the interval has multiplicative width at most $`b`$.
...
```
this is the [checked window identity](https://github.com/wcook04/plectis-lean-erdos249-257/blob/0f41cf184ec7490b9713e7a7be681db1dd9e5084/ErdosProblems/Erdos269/RestrictedFloorSum.lean#L480).
