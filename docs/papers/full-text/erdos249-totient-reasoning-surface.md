...
\mathrm{certifiedKill}(h,N,L)
  ...
  \;<\; 2^{L} - (N{+}h{+}L{+}2),
```
a decidable condition ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:66), [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:72)). The radius $`N{+}h{+}L{+}2`$ is exactly the crude tail bound coming from $`\varphi(m) \le m`$, so a certificate is sound: it forces $`R_{N+h} - R_N \notin \mathbb{Z}`$, and in fact certificates are *complete* for non-integrality ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmConeFlatness.lean:316)). The entire \#249 side of the programme therefore reduces to one obligation.
...
*Proof.* From $`c(n) \le n`$ one gets $`\lvert 2^{L}(R^{c}_{N+h} - R^{c}_{N}) - A_c(h,N,L)\rvert < N{+}h{+}L{+}2`$; this is the crude tail estimate, formalised for $`\varphi`$ at [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:198) and used there to prove [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:262). If $`R^{c}_{N+h} - R^{c}_{N} = k \in \mathbb{Z}`$ then $`2^{L}k \equiv 0 \pmod{2^{L}}`$ and $`A_c`$ lies within $`N{+}h{+}L{+}2`$ of $`2^{L}k`$, so $`A_c \bmod 2^{L}`$ lies within $`N{+}h{+}L{+}2`$ of $`0`$ or of $`2^{L}`$, contradicting $`\mathrm{Kill}_c`$. ◻
...
3.  **Multi-point enrichment.* Adding vertices, higher-order differences, or finite shift-polynomial combinations on the same ray buys nothing, because integrality transports affinely along every ray $`H \mapsto kH`$: the four-hit diamond $`\mathrm{Hit}(H) \wedge \mathrm{Hit}(pH) \wedge \mathrm{Hit}(qH)
      \wedge \mathrm{Hit}(pqH)`$ is equivalent to $`\mathrm{Hit}(H)`$ alone, with no primality used ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FullTargetPrimeAdjunctionNoGo.lean:196)).*
...
\forall h \ge 1\ \forall X_0\ \exists X, L : \quad
  ...
  \le \tfrac{21}{25}X .
```
It implies $`\mathrm{Irrational}(S)`$. <span class="sans-serif">coord:first-harmonic</span> <span class="sans-serif">scale:cofinal</span> <span class="sans-serif">\[Lean\]</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.lean:75) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.lean:83)

</div>

The real-part form suffices and is strictly weaker: it is enough that $`\sum_{N \in [X,2X)} \mathrm{windowFirstCos}(h,N,L) \le \tfrac{9}{10}X`$ ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicGap.lean:128), the elementary unconditional engine; the $`21/25 \to 9/10`$ bridge is [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.lean:53)). Unpacked, the required object is a constant-saving cancellation estimate for the dyadically weighted totient-difference exponential sum
``` math
\sum_{X \le N < 2X}
...
**Honest flag, and it is severe.** B6 partly indicts this route from inside. The most natural approach to the upper bound is dead ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:1051)), and what rationality actually buys — uniform eventual periodicity of the carry’s dyadic sections mod $`v`$ — provably does not promote to a $`\mathbb{Q}`$-rank bound (Proposition <a href="#prop:period-not-rank" data-reference-type="ref" data-reference="prop:period-not-rank">6</a>). So this survivor is genuinely coordinate-disjoint from everything else, which is its whole value, but its obvious approach is closed and the missing input is a rigidity theorem nobody has stated.
...
```
<span class="sans-serif">coord:mobius-mersenne</span> <span class="sans-serif">scale:uniform</span> <span class="sans-serif">\[Lean\]</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:105)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:binary-digit</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:358)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:carry-kernel-rank</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientCarryKernelRigidity.lean:284)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:dyadic-kernel-rank</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:51) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:900)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:binary-digit</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:327)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:cyclotomic</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CyclotomicProjectionOfShadow.lean:350) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CyclotomicProjectionOfShadow.lean:389)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:mobius-mersenne</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/MersenneShadowDenominatorGrowth.lean:60)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:mobius-mersenne</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/MersenneShadowDenominatorGrowth.lean:147)*
...
*<span class="sans-serif">scale:bounded</span> <span class="sans-serif">coord:p-adic</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SignedQMomentObstruction.lean:95) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SignedQMomentObstruction.lean:28)*
...
*<span class="sans-serif">scale:fixed</span> <span class="sans-serif">coord:other:binary-window</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18562)*
...
<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:binary-digit</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:57)
...
<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:other:binary-window</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:66)
...
<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:other:binary-window</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:72)
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:binary-digit</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:150)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:binary-window</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:79)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:binary-window</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:262)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:binary-window</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmConeFlatness.lean:316)*
...
<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:other:lcm-period-ray</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CarrySurvivorExtinction.lean:515) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CarrySurvivorExtinction.lean:81)
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:farey</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GapFareyBound.lean:51)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:n/a</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:5371)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:n/a</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:5792) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:5821)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:n/a</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:73) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:81)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:n/a</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveRationalGapSupply.lean:31)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:mobius-mersenne</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:121) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:50) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:72)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:mobius-mersenne</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:121)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:mobius-mersenne</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:105)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:mobius-mersenne</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:216)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:mobius-mersenne</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:235)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:probability</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:266)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:probability</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:349)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:stern-brocot</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:474)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:stern-brocot</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:525) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:560)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:cyclotomic</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RepunitMobiusNumerator.lean:205) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RepunitMobiusNumerator.lean:217) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RepunitMobiusNumerator.lean:234)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:cyclotomic</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RepunitMobiusNumerator.lean:320) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RadicalMobiusShadow.lean:101)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:mobius-mersenne</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RadicalMobiusShadow.lean:125) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RadicalMobiusShadow.lean:150)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:cyclotomic</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CyclotomicProjectionOfShadow.lean:299) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CyclotomicProjectionOfShadow.lean:310)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:cyclotomic</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimePowerJumpDynamics.lean:281) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimePowerJumpDynamics.lean:347)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:cyclotomic</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimePowerJumpDynamics.lean:310)*
...
*<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:mobius-mersenne</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18087)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:lcm-diagonal</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/JointExponentTransport.lean:36) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/JointExponentTransport.lean:71) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/JointExponentTransport.lean:124)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:support-divisor-counting</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CompositeDilationDefect.lean:30) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CompositeDilationDefect.lean:103) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CompositeDilationDefect.lean:119)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:lcm-window</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18613)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:lcm-window-multiplicative</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmDiagonalReduction.lean:208)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:lcm-cone</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18674)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:binary-window</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18729) (measured verdict: [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18762))*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:lcm-cone-menu</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18801)*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:carry-orbit</span> [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CarrySurvivorExtinction.lean:412) [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CarrySurvivorExtinction.lean:428)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitNonintegrality.lean:37)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:2107)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSeparation.lean:305)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:900,1260)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:2108,2121,1938,1991,2184-2235)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1678)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmShortKill.lean:54)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientFixedRankLcmAsymptotic.lean:256,267,275,291,307)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:766,829,875,845)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:906,973,1066)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:394)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmDiagonalReduction.lean:112)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18686)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18801,18812)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GapFareyBound.lean:176,225)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientCarryKernelRigidity.lean:284)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CarrySurvivorExtinction.lean:412,428)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:291,298,310)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:722,768)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:1703)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:1998,2045)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSeparation.lean:68)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSeparation.lean:141)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSign.lean:39,144)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSign.lean:211)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1187)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:844)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientFixedRankLcmAsymptotic.lean:519)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:77)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:224)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:384,553)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTwoAdicPulseBlock.lean:54,211,262,301,327)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientShiftedMobiusPulse.lean:535,112)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmShortKill.lean:18,27,35)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:79)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:358)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18674)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:51)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18056)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:5371,5792,5821)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18063-18087)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveRationalGapSupply.lean:31)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalPincerCertificates.lean:2842-2870)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GeometricCoprimality.lean:120,182,56)*
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSign.lean:172)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:251)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientFixedRankLcmAsymptotic.lean:462)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientParityCoboundaryCountermodel.lean:37,41,46,59)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientParityCoboundaryCountermodel.lean:637,359,487,194)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:342,320)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:266,307)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18729,18762)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveWeightCertificate.lean:30,54,111)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmFactorIdealPulseObstruction.lean:1-24,328)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TropicalCurvatureCarry.lean:137,69,115)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquareCRTCube.lean:285,294,303,311)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveDeterminantLift.lean:169,148)
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GreedyAchievementSet.lean:1720,1742-1744)
...
**Proposition 176** (Rigidity engine). *A real sequence $`d`$ with $`d(N{+}1)=2d(N)`$ and $`d(N)=o(2^N)`$ is identically zero. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GenericTailOrbitRigidity.lean:315) .*
...
= C_H \cdot \mathrm{mobiusSquareTail}(D)`$ for every $`H,D`$ — no residue split and no side condition on $`D`$ versus $`H`$. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:138) .*

</div>

<div class="prop">

**Proposition 179** (Sharp geometric tail bound). *$`|\mathrm{mobiusSquareTail}(D)| \le 4/\bigl(3(2^{D+1}-1)^2\bigr)`$. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:167) .*

</div>

<div class="obs">

*Observation 180* (Directed vs. symmetric enclosure). When the first nonzero Möbius channel past $`D`$ is known, its sign directs a one-sided interval half the width of the symmetric bound ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:313), <span class="sans-serif">\[Lean\]</span>, <span class="sans-serif">scale:uniform</span>, <span class="sans-serif">coord:other:squared-mersenne-tail</span>), and either enclosure composes with an integer-lattice separation hypothesis into a consumer theorem ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:426)). The separation hypothesis itself is exactly the remaining open content; the enclosure is real but does not supply it.
...
\mathrm{finiteForeignChannelIncrement}(H,s)`$, a literal finite-sum identity, not an estimate. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:829) .*
...
2\bigl(\mu(d)\lfloor(H{+}s)/d\rfloor\bigr)`$. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:941) .*
...
\sum_{i,j\in T}\|z_i-z_j\|^2`$. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PivotAntiReconstruction.lean:724) .*
...
\mathrm{residueIncrement}(d,H)`$. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/ActualForeignResidueProjection.lean:338) .*
...
\varphi(n)`$, with no case split at $`n=0,1`$. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GeometricCoprimality.lean:56) .*
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:57"><span class="smallcaps">Lean source</span></a></td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:150"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
<td style="text-align: left;"><span class="math inline">∀<em>N</em></span></td>
<td style="text-align: left;">binary-digit</td>
</tr>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:66"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:72"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
<td style="text-align: left;"><span class="math inline">∀<em>h</em> ∀<em>N</em> ∀<em>L</em></span></td>
<td style="text-align: left;">other-binary-window</td>
</tr>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:79"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:262"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmConeFlatness.lean:316"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:327"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:358"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CarrySurvivorExtinction.lean:515"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18613"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmDiagonalReduction.lean:208"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18674"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18729"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18801"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CarrySurvivorExtinction.lean:428"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GapFareyBound.lean:51"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:5371"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:5792"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:81"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:900"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientCarryKernelRigidity.lean:284"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveDeterminantLift.lean:169"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18063"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveWeightCertificate.lean:54"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveRationalGapSupply.lean:31"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:50"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:105"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:216"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
<td style="text-align: left;">unconditional</td>
<td style="text-align: left;">mobius-mersenne</td>
</tr>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:235"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
<td style="text-align: left;">unconditional</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:266"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:349"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GcdMomentCalculus.lean:474"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RepunitMobiusNumerator.lean:205"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RepunitMobiusNumerator.lean:320"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RadicalMobiusShadow.lean:125"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CyclotomicProjectionOfShadow.lean:299"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CyclotomicProjectionOfShadow.lean:350"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
<td style="text-align: left;"><span class="math inline">∀<em>r</em> (Squarefree <em>r</em>)</span></td>
<td style="text-align: left;">cyclotomic</td>
</tr>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/MersenneShadowCyclotomicNoncollapse.lean:809"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/MersenneShadowDenominatorGrowth.lean:147"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimePowerJumpDynamics.lean:281"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquaredMersenneDiagonalEnclosure.lean:72"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/JointExponentTransport.lean:71"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CompositeDilationDefect.lean:30"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SublogDivisorCoverage.lean:392"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CampbellShiftSynchronization.lean:488"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:43"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:100"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:298"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:1998"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitNonintegrality.lean:37"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSeparation.lean:68"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSeparation.lean:141"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:844"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientFixedRankLcmAsymptotic.lean:256"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientFixedRankLcmAsymptotic.lean:462"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientParityCoboundaryCountermodel.lean:37"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientShiftedMobiusForeignBridge.lean:52"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
<td style="text-align: left;"><span class="math inline">∀<em>N</em></span></td>
<td style="text-align: left;">cyclotomic</td>
</tr>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientShiftedMobiusPulse.lean:535"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
<td style="text-align: left;"><span class="math inline">∀<em>N</em></span></td>
<td style="text-align: left;">cyclotomic</td>
</tr>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientShiftedMobiusPulse.lean:112"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:77"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:224"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:266"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:766"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
<td style="text-align: left;"><span class="math inline">∀<em>h</em> <em>N</em> <em>L</em></span></td>
<td style="text-align: left;">seam-integer</td>
</tr>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GenericTailOrbitRigidity.lean:425"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GenericTailOrbitRigidity.lean:314"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GenericTailOrbitRigidity.lean:246"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GenericTailOrbitRigidity.lean:306"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:13606"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmFactorIdealPulseObstruction.lean:211"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GeometricCoprimality.lean:120"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/AdelicHeightObstruction.lean:120"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/RationalDenominatorSurvival.lean:17"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/AdelicHeightObstruction.lean:23"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SignedQMomentObstruction.lean:95"><span class="smallcaps">Lean source</span></a></td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/ResidualGaugeObstruction.lean:47"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/IncidenceQuotientHermitePade.lean:56"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">uniform</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GapFareyBound.lean:176"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18056"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LambertDiagonalEnclosure.lean:31"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TropicalCurvatureCarry.lean:137"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SupportDilationDifferences.lean:250"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:768"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:1703"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSign.lean:39"><span class="smallcaps">Lean source</span></a></td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSign.lean:172"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSign.lean:211"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmShortKill.lean:54"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:251"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1187"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1260"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1678"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientFixedRankLcmAsymptotic.lean:519"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientShiftedMobiusForeignBridge.lean:329"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:342"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LambertProjectedNumeratorGap.lean:23"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:13847"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:14255"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">bounded</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:404"><span class="smallcaps">Lean source</span></a></td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18562"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">fixed</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18762"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">fixed</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalPincerCertificates.lean:2842"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">fixed</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmShortKill.lean:18"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">fixed</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SquareCRTCube.lean:285"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">fixed</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:13898"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">fixed</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:394"><span class="smallcaps">Lean source</span></a></td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CarrySurvivorExtinction.lean:502"><span class="smallcaps">Lean source</span></a></td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmDiagonalReduction.lean:112"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18686"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18706"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18812"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.lean:83"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimeJumpWindow.lean:193"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitArithmetic.lean:2107"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSeparation.lean:305"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:2221"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientParityCoboundaryCountermodel.lean:637"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:384"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailCarryPeriod.lean:1066"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTwoAdicPulseBlock.lean:54"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
<td style="text-align: left;"><a href="https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTwoAdicPulseBlock.lean:327"><span class="smallcaps">Lean source</span></a></td>
<td style="text-align: left;">cofinal</td>
...
The canonical open obligation for \#249, proved in Part II to be sufficient ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean)), is the **249-supply** obligation:
``` math
...
**Definition 212** (Window discrepancy). [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:66). For $`h,N,L\in\mathbb N`$,
``` math
A_{h,N,L} \;=\; \sum_{j=0}^{L-1} \bigl(\varphi(N+h+1+j) - \varphi(N+1+j)\bigr)\cdot 2^{\,L-1-j}
  \ \in \mathbb Z .
```
This is the depth-$`L`$ truncation of $`2^L\cdot(R_{N+h}-R_N)`$, where $`R_N = \sum_{j\ge 1}\varphi(N+j)/2^j`$ is the local totient tail ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:57)).

</div>

<div class="defn">

**Definition 213** (Certified kill). [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:72).
``` math
\mathtt{certifiedKill}\ h\ N\ L \;:\Leftrightarrow\;
  (N{+}h{+}L{+}2) < A_{h,N,L}\bmod 2^L < 2^L - (N{+}h{+}L{+}2).
```
That is: the residue of $`A_{h,N,L}`$ modulo $`2^L`$ avoids the radius-$`(N{+}h{+}L{+}2)`$ neighbourhood of $`0`$. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:79) records the necessary room condition this forces: $`2(N{+}h{+}L{+}2) < 2^L`$.

</div>

<div class="defn">

**Definition 214** (First-harmonic real and complex characters). [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicGap.lean:27) and [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.lean:38):
``` math
...
**Definition 224** (The open producer). [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1325). <span class="sans-serif">\[Open\]</span>. <span class="sans-serif">scale:cofinal</span>.
``` math
...
1.  *[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1334) (<span class="sans-serif">\[Open\]</span>, <span class="sans-serif">scale:cofinal</span>):
    ``` math
...
5.  *[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1908) — the weakest of all five; treated separately as row TE-05-weakest below.*
...
**Theorem 238**. *[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18556) and [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18562) (shallower sibling [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTailPeriodKiller.lean:404)). <span class="sans-serif">\[Cert\]</span>. <span class="sans-serif">scale:fixed</span>.
``` math
...
7.96\times10^{34}`$ — is literally $`\mathrm{Irrational}(S)`$, so the target coordinate is right. What blocks promotion is proved on disk: [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/GapFareyBound.lean:225) establishes that the $`K=240`$ window bound is *sharp*, at exactly the mediant $`b{+}d`$, so re-running the same argument at the same window buys nothing further. Each new $`K`$ needs (i) a freshly committed $`2^K`$-scale totient residue $`V_K`$ and (ii) fresh continued-fraction convergents of $`V_K'/2^K`$, both hard-coded numerals in the current proofs. The growth of the bound $`b_K{+}d_K`$ is governed by the convergent denominators of the underlying constant, which stall at $`q_0`$ precisely if $`S=a/q_0`$: the growth law is equivalent in difficulty to \#249 itself.

</div>

<div class="obs">

*Observation 243* (A closed sub-route). [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveWeightCertificate.lean:30) and [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveWeightCertificate.lean:47), the corpus’s own attempt at strengthening this window refinement via a unit-modulo-odd-part criterion, prove a hard ceiling in [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveWeightCertificate.lean:54) and [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PrimitiveWeightCertificate.lean:111) (<span class="sans-serif">\[Lean\]</span>, <span class="sans-serif">scale:n/a</span>): at a prime-power denominator, the strengthening rescues at most *one* extra lattice point. That route is closed — it cannot be the source of a growth law.
...
**Theorem 245**. *[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTwoAdicPulseBlock.lean:54), [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTwoAdicPulseBlock.lean:211), [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTwoAdicPulseBlock.lean:262), [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientTwoAdicPulseBlock.lean:327). <span class="sans-serif">\[Lean\]</span>. <span class="sans-serif">scale:uniform</span> (the theorem is unconditional and holds for *every* $`K`$, $`H`$, $`B`$, not merely cofinally many). For every $`K\ge 2`$, every $`H>K`$, and every bound $`B`$, there are primes $`p>B`$ with a length-$`(K{-}1)`$ zero prefix and a terminal half-turn, giving
``` math
...
**Theorem 248** (Cofinal producer, fully proved). *[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:2437). <span class="sans-serif">\[Lean\]</span>. <span class="sans-serif">scale:cofinal</span> (proved, not open): $`\forall t_0\ \exists t\ge t_0`$ with $`\mathtt{periodLcm}\ t < \mathtt{periodLcm}(t{+}1)`$, witnessed by $`p{-}1`$ for any prime $`p>t_0`$. The power-of-two specialization [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:2495) shows the positions $`t=2^a{-}1`$ already suffice, so no position search is needed at all.*

</div>

<div class="defn">

**Definition 249** (The slack scalar and the open supply). [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:2453):
``` math
\mathtt{canonicalAdjacentSuffixCentralSlack}\ t = \min\bigl(d-2^{m-5},\ (2^m-2^{m-5})-d\bigr),
```
with $`m`$ the canonical adjacent-suffix depth and $`d`$ the residue at that depth. The open producers, both <span class="sans-serif">\[Open\]</span> <span class="sans-serif">scale:cofinal</span>, are [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:2488) (any strict jump) and [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:2495) (power-of-two positions), each asking $`0\le \mathtt{canonicalAdjacentSuffixCentralSlack}(t{+}1)`$ cofinally, and both compose to $`\mathrm{Irrational}(S)`$ at [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:2739) and [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:2746).

</div>

<div class="rem">

*Remark 250* (Census evidence only). <span class="sans-serif">\[Cert\]</span>, <span class="sans-serif">scale:fixed</span>. All $`40`$ strict jumps up to endpoint $`113`$ pass, closest margin $`\approx 0.000221`$ of the modulus at $`t=100`$; the power-of-two endpoints $`4,8,16,32`$ pass with slack fractions $`0.41,0.036,0.40,0.19`$. Census, not theorem. The structural handle nobody has used: $`\mathtt{periodLcm\_succ\_eq\_prime\_mul\_of\_strict\_jump}`$ ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:2134)) says a strict jump at $`t`$ means $`t{+}1=p^k`$ and $`\mathtt{periodLcm}(t{+}1) = p\cdot\mathtt{periodLcm}(t)`$ — so the required statement is a transfer lemma for how the adjacent-suffix residue at height $`H`$ moves under $`H\mapsto pH`$. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/DiagonalFreshLossBridge.lean:2460) already proves the slack is constant across each LCM plateau, so only jump indices matter.
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientParityCoboundaryCountermodel.lean:637) (sum computation [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientParityCoboundaryCountermodel.lean:359); non-periodicity [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientParityCoboundaryCountermodel.lean:487); exact parity match [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientParityCoboundaryCountermodel.lean:194)). <span class="sans-serif">\[Lean\]</span> <span class="sans-serif">scale:cofinal</span> <span class="sans-serif">coord:binary-digit</span>.
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SignedQMomentObstruction.lean:95), built from a fully generic rectangular Cauchy–Binet-style determinant-of-product expansion [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SignedQMomentObstruction.lean:28) (`hankelDet`/`truncatedMoment` defs at [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/SignedQMomentObstruction.lean:107,116)). <span class="sans-serif">\[Lean\]</span> <span class="sans-serif">scale:bounded</span> <span class="sans-serif">coord:p-adic</span>.
...
**(a) Route as conceived.** A “first-harmonic pivot” strategy for \#249 (via exponential/character-sum cancellation, [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.lean)) might try to certify a nonzero determinant or full-rank minor of a residual-weighted monomial matrix as sufficient evidence that a genuine phase reconstruction (as opposed to a degenerate locked configuration) has occurred.
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/ResidualGaugeObstruction.lean:94) (row-dependent relaxation [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/ResidualGaugeObstruction.lean:124); the column-gauge identity underlying it, $`\det(\mathrm{residualMonomialMatrix}) =
\det(\mathrm{phasePowerMatrix})\cdot\prod_j W(j)`$, is [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/ResidualGaugeObstruction.lean:47); a row-dependent relaxation still fails at [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/ResidualGaugeObstruction.lean:145)). <span class="sans-serif">\[Lean\]</span> <span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:first-harmonic-phase</span>.
...
| 249-supply | d4/d5, [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:900), [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientCarryKernelRigidity.lean:284) | coordinate_only | NOT_PROMOTABLE. The scale side of a second, independent open obligation (unbounded carry-kernel rank forced by rationality) is finished uniformly in $`e`$; the opposite (rationality-side rank upper bound) is missing, and one natural route to it is proved dead ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientMahlerDefect.lean:1051)). |
...
| 257-reset | E1, [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/HalfCylinderSeamLimit.lean:192) | coordinate_only | NOT_PROMOTABLE. Supplies an UPPER bound on the remainder (the ceiling half of the picture); the obligation needs a LOWER bound on the deviation magnitude — the two do not compose without an additional input. |
...
```
where $`D(h,N,L)=\sum_{j<L}\bigl(\varphi(N+h+1+j)-\varphi(N+1+j)\bigr)2^{L-1-j}`$. [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.\allowbreak lean:75), consumer [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.\allowbreak lean:83) . By Proposition <a href="#prop:transfer" data-reference-type="ref" data-reference="prop:transfer">271</a> the weaker real-part form with constant $`89/100`$ suffices.
...
\end{aligned}
```
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.\allowbreak lean:397), consumer [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.\allowbreak lean:405) . The decomposition is an exact identity, [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.\allowbreak lean:342) , and the supplier set at the canonical fibre is a membership equality with a shifted dyadic interval of primes, [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.\allowbreak lean:251) .
...
The corpus warns against the subset consumer [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicGap.\allowbreak lean:104) because a predicate quantifying existentially over subsets $`T\subseteq[X,2X)`$ is collapse-exposed: the proved collapse [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/PivotAntiReconstruction.\allowbreak lean:1775) works precisely by *choosing* $`T=\{N,N+1\}`$. That warning applies to a free $`T`$. It does not apply to a $`T`$ named in advance as a function of $`(h,X,L)`$, and the corpus already contains the right one:
``` math
T_{h,X,L}\;:=\;\mathrm{pivotFiber}(X,L,L-h,1)
  \;=\;\{\,N\in[X,2X)\ :\ N+h+1\ \text{prime}\,\},
```
a membership equality rather than a sampled surrogate ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/FirstHarmonicPivot.\allowbreak lean:251), <span class="sans-serif">\[Lean\]</span>). The proposal is to prove
``` math
\begin{equation}
\label{eq:primefibre}
...
```
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/LcmConeFlatness.lean:316) (wrapped as `totient_tail_window_kill_exists_iff_tail_diff_notMem_int` at [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/CertificateKernel.lean:18697)) (holds for all $`h,N`$) .
...
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitNonintegrality.lean:37) (an unconditional equivalence, not a supply) , where $`\mathrm{actualLcmTailOrbit}(a) := 2^H(2^H-1)S - (\mathrm{totientPrefix}(2H)-\mathrm{totientPrefix}(H))`$, $`H=H_{2^a}`$ ( [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmOrbitSeparation.lean:68)). *This is \#249 restated with nothing left over*: no auxiliary hypothesis, no scale caveat — cofinal non-integrality of this one sparse sequence at power-of-two heights is exactly Erdős \#249. Everything else in this subsection is an attempt to reach the right-hand side.
...
```
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1325) .
``` math
\mathrm{PowerTwoActualLcmTopEdgeResidueGapSupply} \Longrightarrow \mathrm{Irrational}(S).
```
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:2184) .
...
3.  $`\mathrm{PowerTwoActualFinalTopEdgeMagnitudeSupply}`$: the exact centered-lift restatement of (ii),
    ...
    ```
    [<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:1479) .
...
```
[<span class="smallcaps">Lean source</span>](https://github.com/wcook04/plectis-lean-erdos249-257/blob/e5fd26a6d1b1a346430205eab5385b4c9565d004/Erdos249257/TotientActualLcmTopEdgeStaircase.lean:844) , where the witness is $`\exists s,b,\ \mathrm{certifiedKill}(h,N{+}s,b{+}1) \vee
