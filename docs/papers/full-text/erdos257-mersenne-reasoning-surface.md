...
*Remark 10* (A recorded hazard). The natural sufficient condition via fractional split-mass is *not* necessary on real crossing cores: the fixture $`D = \{2,3\}`$, $`c = 5`$ is an explicit counterexample (). Any attack on the capacity socket that routes through fractional mass is already refuted. <span class="sans-serif">\[Lean\]</span>
...
*Proof.* By Lemma <a href="#lem:collapse-mech" data-reference-type="ref" data-reference="lem:collapse-mech">11</a>, $`2^{N+1}\delta = \operatorname{ihc}(A,N) - \mathrm{T}(N+1)`$. For the greedy support of $`1/2`$ one has $`x_G \le 1/2`$, hence $`\delta \ge 0`$ (). If $`\operatorname{ihc}(A,N) \le c\sqrt{N} + c'`$ for cofinally many $`N`$, then $`2^{N+1}\delta \le c\sqrt{N} + c'`$ along that sequence; since $`2^{N+1}`$ outgrows any $`\sqrt{N}`$ envelope and $`\delta \ge 0`$ is a fixed real, $`\delta = 0`$. Conversely $`\delta = 0`$ makes $`\operatorname{ihc}(A,N) = \mathrm{T}(N+1)`$ exactly, and the unconditional envelope of Lemma <a href="#lem:collapse-mech" data-reference-type="ref" data-reference="lem:collapse-mech">11</a> then *supplies* the strip for free. And $`\delta = 0`$ is exactly $`1/2 \in \mathcal{A}`$, by . ◻
...
*Forward directions are landed Lean (e.g. , , ). The reverse directions of (d) and (e) are derived here from Lemma <a href="#lem:sqrt-witness" data-reference-type="ref" data-reference="lem:sqrt-witness">13</a> and are *not* themselves landed Lean theorems. <span class="sans-serif">coord:half-carry / exact-row</span> <span class="sans-serif">scale:cofinal</span> <span class="sans-serif">\[Lean\]</span><span class="sans-serif">\[Math\]</span>*
...
**Proposition 15** (Local information is void; <span class="smallcaps">proved</span>). *(i) After $`L`$ common steps the endpoint residue mod $`2^L`$ of an affine binary orbit is *independent* of the initial carry: $`u(L) - v(L) = 2^L(u_0 - v_0)`$ (). (ii) No bounded or autonomous state summarising the history before position $`m`$ determines the tail after $`m`$: for a balanced-pulse family no decoder recovers the radius, and any finite state type needs cardinality at least $`\lfloor m/2 \rfloor + 2`$, unbounded in $`m`$ (). (iii) For any starting carry and any finite word of odd valuation-unit symbols at fixed precision $`u > 0`$, a compatible centred carry completion *exists* (), so fixed-precision local data never excludes anything. <span class="sans-serif">coord:carry</span> <span class="sans-serif">scale:uniform</span> <span class="sans-serif">\[Lean\]</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:cofinal</span><span class="sans-serif">coord:greedy-orbit</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:cofinal</span><span class="sans-serif">coord:seam-integer</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:two-channel-dyadic-cap</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:second-channel-phase</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:dedekind-cut</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:seam-integer</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:dyadic-boundary</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:mobius-mersenne</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:greedy-orbit</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:lcm-gap</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:dilation</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:periodic-sieve</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:signed-divisor-calculus</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:cyclotomic</span>*
...
<span class="sans-serif">\[Cert\]</span><span class="sans-serif">scale:fixed</span><span class="sans-serif">coord:regression-fixture</span>
...
<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:fixed</span><span class="sans-serif">coord:signed-divisor-calculus</span>
...
*<span class="sans-serif">\[Cited\]</span><span class="sans-serif">scale:fixed</span><span class="sans-serif">coord:mobius-mersenne</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:fixed</span><span class="sans-serif">coord:mobius-mersenne</span>*
...
<span class="sans-serif">\[Cert\]</span><span class="sans-serif">scale:fixed</span><span class="sans-serif">coord:seam-integer</span>
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:parity-irrationality</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:linear-algebra</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:rational-band</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:divisor-incidence</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:tail-transfer</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:denominator-algebra</span>*
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:uniform</span><span class="sans-serif">coord:p-adic</span>*
...
<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:n/a</span><span class="sans-serif">coord:binary-digit</span>
...
*<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:n/a</span><span class="sans-serif">coord:dedekind-cut</span>*
...
<span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:n/a</span><span class="sans-serif">coord:abstract-perturbed-greedy</span>
...
<span class="sans-serif">scale:cofinal</span> <span class="sans-serif">coord:mobius-mersenne</span>
...
*<span class="sans-serif">scale:cofinal</span> <span class="sans-serif">coord:other:topological-achievement-set</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:greedy-orbit</span>*
...
*<span class="sans-serif">scale:bounded</span> <span class="sans-serif">coord:binary-digit</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:dyadic-boundary</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:frozen-margin</span>*
...
*<span class="sans-serif">scale:cofinal</span> <span class="sans-serif">coord:other:sqrt-carry-growth</span>*
...
<span class="sans-serif">scale:fixed</span> <span class="sans-serif">coord:mobius-mersenne</span>
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:p-adic</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:geometric-series</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:mobius-inversion</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:cesaro-tail</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:common-multiple-forcing</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:divisor-envelope</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:mobius-centred-carry</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:summed-gap-mass</span>*
...
<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:other:lambert-bound</span>
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:lambert-bound</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:dyadic-scale</span>*
...
*<span class="sans-serif">scale:fixed</span> <span class="sans-serif">coord:other:dyadic-boundary</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:abstract-perturbed-greedy</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:reverse-carry-word</span>*
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:half-divisor</span>*
...
*<span class="sans-serif">scale:fixed</span> <span class="sans-serif">coord:other:meta-logical</span>*
...
*<span class="sans-serif">scale:bounded</span> <span class="sans-serif">coord:mobius-mersenne</span>*
...
<span class="sans-serif">scale:n/a</span> <span class="sans-serif">coord:other:rational-band</span>
...
*<span class="sans-serif">scale:uniform</span> <span class="sans-serif">coord:other:linear-algebra</span>*
...
**Definition 184** ($`\mathrm{HalfGreedyGovernedFrozenMarginProducer}`$). For every $`k`$ with $`\mathtt{mersenneWeight}(k+1)`$ exceeding the current greedy remainder, some $`J\le k+1`$ gives a nonnegative frozen margin ().
...
<tr>
<td style="text-align: left;">Smallest concrete exact row: support <span class="math inline">{2, 3, 6}</span> satisfies <span class="math inline">localPrefixQuotient = 2<sup>5</sup> − 1</span>. <span><span class="sans-serif">[Cert]</span></span></td>
...
<tr>
<td style="text-align: left;">One-point counter-model: the double-or-recycle transition shape alone, even seeded, is not cofinal. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:fixed</span></span></td>
...
<tr>
<td style="text-align: left;">The combined-residue-mass <span class="math inline"> ≤ 1</span> sufficient test for sharp capacity is not necessary: fixture <span class="math inline"><em>D</em> = {2, 3}</span>, <span class="math inline"><em>c</em> = 5</span>. <span><span class="sans-serif">[Cert]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:fixed</span></span></td>
<td style="text-align: left;"><span class="math inline"><em>D</em> = {2, 3}, <em>c</em> = 5</span></td>
<td style="text-align: left;"><span><span class="sans-serif">coord:mobius-mersenne</span></span></td>
</tr>
<tr>
<td style="text-align: left;">Exact residual fixture: <span class="math inline">$\tfrac12-W(\{2,3,6,7\})=\tfrac1{16002}$</span>. <span><span class="sans-serif">[Cert]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:fixed</span></span></td>
...
<tr>
<td style="text-align: left;">Closed-form Möbius–Lambert value <span class="math inline">∑<sub><em>d</em> ≥ 1</sub><em>μ</em>(<em>d</em>)/(2<sup><em>d</em></sup> − 1) = 1/2</span> (imported identity). <span><span class="sans-serif">[Cited]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:fixed</span></span></td>
<td style="text-align: left;">none (closed-form value)</td>
<td style="text-align: left;"><span><span class="sans-serif">coord:mobius-mersenne</span></span></td>
</tr>
<tr>
<td style="text-align: left;">The one natural negative-Möbius candidate support overshoots: <span class="math inline">1/2 &lt; ∑<sub><em>d</em> ∈ <em>N</em></sub>1/(2<sup><em>d</em></sup> − 1)</span> for <span class="math inline"><em>N</em> = {<em>d</em> ≥ 2 : <em>μ</em>(<em>d</em>) = −1}</span>. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:fixed</span></span></td>
...
<tr>
<td style="text-align: left;">Every exact row continues: doubles unboundedly, or recycles to some <span class="math inline"><em>c</em> ≤ <em>n</em></span>. <span><span class="sans-serif">[Lean]</span></span></td>
...
<tr>
<td style="text-align: left;">Every above-half bounded support recycles into a genuine exact row at some <span class="math inline">2<em>c</em> − 2</span> with <span class="math inline"><em>c</em> ≤ <em>n</em></span>. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:bounded</span></span></td>
...
<tr>
<td style="text-align: left;">(#249 cross-lane check) <span class="math inline">∑<em>φ</em>(<em>n</em>)/2<sup><em>n</em></sup></span> matches no rational whose denominator divides <span class="math inline">2<sup>14</sup>(2<sup><em>h</em></sup> − 1)</span>, for any <span class="math inline"><em>h</em> ≤ 16</span>. <span><span class="sans-serif">[Cert]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:bounded</span></span></td>
...
<tr>
<td style="text-align: left;">Master achievement/greedy-survival criterion. <span><span class="sans-serif">[Lean]</span></span></td>
...
<tr>
<td style="text-align: left;">Membership iff every actually-skipped rank survives. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
<td style="text-align: left;"><span class="math inline">∀<em>M</em>∈</span> skipped support</td>
<td style="text-align: left;"><span><span class="sans-serif">coord:greedy-orbit</span></span></td>
</tr>
<tr>
<td style="text-align: left;">Every crossing core is forced to be the canonical rational half-greedy prefix. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
<td style="text-align: left;"><span class="math inline">∀<em>c</em> ≥ 4 ∀<em>D</em></span> bounded <span class="math inline">[2, <em>c</em>)</span></td>
<td style="text-align: left;"><span><span class="sans-serif">coord:greedy-orbit</span></span></td>
</tr>
<tr>
<td style="text-align: left;">Theorem A payoff: reset <span class="math inline">$\sqrt{\ }$</span>-escape socket <span class="math inline">⇒</span> membership. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
...
<tr>
<td style="text-align: left;">Band-avoidance certified for every row <span class="math inline">13 ≤ <em>r</em> ≤ 31</span> (feeds the F5/Theorem A uniform hypothesis as an exhaustively-verified finite range). <span><span class="sans-serif">[Cert]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
<td style="text-align: left;"><span class="math inline">13 ≤ <em>r</em> ≤ 31</span>, exhaustive</td>
<td style="text-align: left;"><span><span class="sans-serif">coord:seam-integer</span></span></td>
</tr>
<tr>
<td style="text-align: left;">Critical-band-index reduction: a <span class="math inline">(<em>d</em> + 1)</span>-way check collapses to one nearest-boundary check. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
...
<tr>
<td style="text-align: left;">Parity kill: no finite support hits <span class="math inline">1/2</span> exactly. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
...
<tr>
<td style="text-align: left;">Erdős–Borwein irrationality at every integer base. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
<td style="text-align: left;"><span class="math inline">∀<em>b</em> ≥ 2</span></td>
<td style="text-align: left;"><span><span class="sans-serif">coord:mobius-mersenne</span></span></td>
</tr>
<tr>
<td style="text-align: left;">Erdős 1968: any infinite, pairwise-coprime, reciprocal-summable index set gives an irrational support series. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
<td style="text-align: left;"><span class="math inline">∀<em>b</em> ≥ 2 ∀<em>A</em></span> (infinite, coprime, summable)</td>
<td style="text-align: left;"><span><span class="sans-serif">coord:mobius-mersenne</span></span></td>
</tr>
<tr>
<td style="text-align: left;">Generic block-certificate engine (problem-agnostic): weighted-coefficient series is irrational given a per-precision divisibility/window certificate. <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
...
<tr>
<td style="text-align: left;">Finite greedy-prefix denominators are odd (source of the parity boundary exclusion, §<a href="#sec:four-coordinates" data-reference-type="ref" data-reference="sec:four-coordinates">8</a>). <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:uniform</span></span></td>
...
<tr>
<td style="text-align: left;">THE master open supply: exact rows recur at arbitrarily large endpoints, with no coherence required between witnesses. <span><span class="sans-serif">[Open]</span></span></td>
...
<tr>
<td style="text-align: left;">Payoff theorem consuming the row above: compactness of the achievement set forces <span class="math inline">1/2</span> itself to be achieved. <span><span class="sans-serif">[Lean]</span></span> (theorem proved; <em>hypothesis</em> open)</td>
<td style="text-align: left;"><span><span class="sans-serif">scale:cofinal</span></span></td>
...
<tr>
<td style="text-align: left;">Shortest known open target: the canonical rational half-greedy orbit itself has infinitely many positive skip events. <span><span class="sans-serif">[Open]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:cofinal</span></span></td>
...
<tr>
<td style="text-align: left;">Payoff theorem consuming the row above, with zero further combinatorial search once supplied. <span><span class="sans-serif">[Lean]</span></span> (theorem proved; hypothesis open)</td>
<td style="text-align: left;"><span><span class="sans-serif">scale:cofinal</span></span></td>
<td style="text-align: left;">given <span class="math inline">∀<em>N</em> ∃<em>c</em> ≥ <em>N</em>(…)</span></td>
<td style="text-align: left;"><span><span class="sans-serif">coord:greedy-orbit</span></span></td>
</tr>
<tr>
<td style="text-align: left;">Master half-branch dichotomy: membership iff the greedy skip set is infinite. <span><span class="sans-serif">[Lean]</span></span> (iff proved; both sides cofinal-shaped)</td>
<td style="text-align: left;"><span><span class="sans-serif">scale:cofinal</span></span></td>
<td style="text-align: left;">iff <span class="math inline">(skippedSupport).Infinite</span></td>
<td style="text-align: left;"><span><span class="sans-serif">coord:greedy-orbit</span></span></td>
</tr>
<tr>
<td style="text-align: left;">Seven-way classification hub: membership iff the seam word is not eventually right, iff unbounded terminal-false, iff cofinally many skipped ranks, <em>etc.</em> <span><span class="sans-serif">[Lean]</span></span></td>
<td style="text-align: left;"><span><span class="sans-serif">scale:cofinal</span></span></td>
...
*Observation 200* (oa-2 / deficit-side run law). <span class="sans-serif">\[Lean\]</span> . **Yields:** $`\forall k, s.\ 5 \le s \to \mathrm{rem}(s) \le 2^s \to 2^s \le 2^k(2^s -
...
*Observation 201* (rc-2 / affine excess recurrence). <span class="sans-serif">\[Lean\]</span> , , (recurrence ). **Yields:** for an R-run of length $`k`$ from row $`S`$: $`X_k + \mathrm{charge}_k = 4^k X_0`$ exactly, with $`X_j = \mathrm{rem}(S+j) - 2^{S+j}`$ and $`\mathrm{charge}_{j+1} = 4\,\mathrm{charge}_j
...
*Observation 204* (H4, PRIVATE / sharp fatal-gap test). <span class="sans-serif">\[Lean\]</span> , , , . **Yields:** writing the residual in lowest terms $`\rho=u/(2L)`$, $`u,L`$ odd, $`a := 2L -
...
*Observation 205* (F5b / linear-width band escape, rows 13–30). <span class="sans-serif">\[Lean\]</span> . **Yields:** at every upper reset row $`d`$, $`13 \le d \le 30`$, the reset charge $`E_d =
...
*Observation 206* (oa-3b / M-ancestor and R-run closure). <span class="sans-serif">\[Lean\]</span> , , . **Yields:** unconditional, uniform in $`s\ge5`$: a middle (M) branch forces $`s+1 \le
...
*Observation 210* (F4 / two-sided cell exclusion). <span class="sans-serif">\[Lean\]</span> , `.step`HalfCylinderMiddleCarryLowerBound.lean:3362, `.twoSided`HalfCylinderMiddleCarryLowerBound.lean:3413. **Yields:** excluding exactly three integer values of the middle coordinate ($`4\,\mathrm{rem}-\mathrm{belowPulse}-4 \notin \{-3,-2,-1\}`$) plus one right-pulse-leak bound propagates, by induction from a decide-checked row-5 base, the two-sided invariant $`\forall s
...
*Observation 211* (E1 / remainder ceiling). <span class="sans-serif">\[Lean\]</span> , (weaker cofinal route ). **Yields:** if $`\forall s \ge 6`$, $`\mathrm{rem}(s) < 2^{s+1}`$, then $`1/2 \in
...
*Observation 216* (Sharp-capacity fill, unconditional). <span class="sans-serif">\[Lean\]</span> , . **Yields:** for any $`c \ge 4`$ and any finite $`D \subseteq [2,c)`$ with $`\mathrm{localMersennePrefixValue}\,D < 1/2`$ and $`\mathrm{localBinarySuffix}\,D\,1\,(2c{-}2) <
...
*Observation 218* (Unconditional capacity, off by one bit). <span class="sans-serif">\[Lean\]</span> (word form line 228). **Yields:** unconditionally, $`\forall c \ge 4`$ and every below-half core $`D \subseteq [2,c)`$ with deficit $`< \mathrm{mersenneWeightRat}\,c`$: $`\mathrm{localBinarySuffix}\,D\,1\,(2c{-}2) <
...
*Observation 220* (Consecutive-skip precritical bound). <span class="sans-serif">\[Lean\]</span> (feeds , then lines 970/986). **Yields:** unconditional: if $`c \ge 6`$ and both rank $`c`$ and rank $`c{+}1`$ are skipped by the rational half-greedy orbit, then $`\mathrm{localBinarySuffix}(\mathrm{halfGreedyPrefixSupport}
...
*Observation 222* (Frozen margin, ineffective horizon). <span class="sans-serif">\[Lean\]</span> , (margin def line 1021, recurrence line 1036, monotonicity line 1094). **Yields:** at every dyadically safe rank $`k>0`$, $`\mathrm{greedyHalfFrozenMargin}\,k\,J \ge
...
*Observation 224* (Cofinal positive skips *is* the obligation). <span class="sans-serif">\[Lean\]</span> , , line 60; A5 , A6 (); positivity discharge . **Yields:** cofinally many positive rational-greedy skips $`\Rightarrow`$ `CofinalExactLocalMersenneHalfRows` $`\Rightarrow 1/2 \in
...
*Observation 225* (C4a / terminal-only strip, wrong locality). <span class="sans-serif">\[Lean\]</span> , , . **Yields:** cofinally many depths $`M`$ carrying a finite normalized word $`a`$ with $`|\mathrm{integerHalfCarry}(\mathrm{wordSupport}\,a)(M{-}1)| \le \mathrm{halfStripBound}\,M
...
*Observation 229* (NM-01 / the single certificate socket). <span class="sans-serif">\[Lean\]</span> (carry variant ). **Yields:** $`\forall b\ge2,\ \forall A\subseteq\mathbb N`$ (no infinitude, no structure hypothesis at all): if $`\forall q>0\ \exists N,K,L,C`$ with $`K\le L`$, $`b^r \mid
...
*Observation 230* (NM-02 / single-target to all-rational-targets, promotable). <span class="sans-serif">\[Lean\]</span> (forward ; reverse ). **Yields:** $`(1/2:\mathbb R)\in\mathrm{mersenneAchievementSet} \Leftrightarrow
...
*Observation 231* (NM-03 / target-free engine underneath a target-pinned corollary). <span class="sans-serif">\[Lean\]</span> ; engine . **Yields:** $`\forall A`$ finite with $`0\notin A`$: $`\mathrm{erdosSupportSeries}\,2\,A \ne
...
*Observation 235* (NM-07 / sunflower bouquet, unproved selector plus false class-existence). <span class="sans-serif">\[Lean\]</span> (selector def line 406; carry socket line 381; bouquet structure line 33). **Yields:** for $`A=`$ (finite exceptional set dividing $`Q`$) $`\cup \{\mathrm{core}_i \cdot
...
*Observation 238* (NM-10 / the load-bearing coordinate, iff over all $`A`$). <span class="sans-serif">\[Lean\]</span> (line 376); T7 . **Yields:** $`\forall A\subseteq\mathbb N`$ (no hypothesis at all): $`\mathrm{HasRationalValue}(\mathrm{erdosSupportSeries}\,2\,A) \Leftrightarrow \exists q{>}0\
...
*Observation 239* (NM-11 / carry unboundedness, tautological, dead end). <span class="sans-serif">\[Lean\]</span> , , . **Yields:** for every infinite $`A`$ and positive carry recurrence $`u(n{+}1)+v\cdot\mathrm{supportCoeff}\,A\,(c{+}n{+}1)=2u(n)`$: $`u`$ is unbounded, and $`1+v|F| \le
...
*Remark 245* (hbound is equivalent to the conclusion, greedy support only). and its packaged form take a hypothesis `hbound`: $`\forall N,\ \mathrm{mobiusCenteredHalfCarry}\,A\,N \le
...
*Remark 247* (CofinalPositiveHalfGreedySkips is literally the problem). Repeated here for emphasis from the 257-cofinal-rows entry above: once the positivity conjunct of is recognised as unconditionally free (odd-numerator/even-subtrahend parity plus greedy nonnegativity, discharged at ), the socket collapses to $`(\mathrm{greedyMersenneSkippedSupport}(1/2))`$.Infinite, proved by A6 () to be *equivalent* to $`1/2\in
...
**Corollary 262** (Mersenne specialisation). *For positive $`x:\mathbb Q`$: if $`2^r\mid x.\mathrm{num}.\mathrm{natAbs}`$ and $`x < 2/(2^n-1)`$, then $`2^r\cdot(2^n-1) < 2\cdot x.\mathrm{den}`$ — a numerator $`2`$-power lower bound plus a Mersenne-scale upper bound on $`x`$ together force a denominator lower bound, *without* introducing a global prefix LCM. (generic form ). A ready-made denominator-lower-bound tool for "synchronized tail" arguments on \#257’s Mersenne sums; composes directly with Lemma <a href="#lem:scalar-localization" data-reference-type="ref" data-reference="lem:scalar-localization">261</a> for a full numerator/denominator height-transport toolkit. <span class="sans-serif">coord:rational-denominator/height, Mersenne instance</span> <span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:n/a</span>*
...
E+2(d+j)\le 2^{d-j+1}`$ collapses the $`\forall j\in[0,d]`$ band-avoidance condition (formally $`d{+}1`$ separate inequalities) to checking exactly *one* nearest-boundary index $`j`$. Specialised to the concrete seam reset charge, $`\mathsf{SeamUpperResetCriticalBandEscape}`$ is proved logically *equivalent* to Definition <a href="#defn:band-escape" data-reference-type="ref" data-reference="defn:band-escape">263</a>’s socket. (seam specialisation ). Zero Mersenne/seam content in the core lemma — pure $`(d,E,j)`$ arithmetic over powers of 2. <span class="sans-serif">coord:dyadic-boundary, generic</span> <span class="sans-serif">\[Lean\]</span><span class="sans-serif">scale:n/a</span>*

</div>

<div id="cert:band-through-31" class="obs">

*Observation 265* (Rows 13 through 31 are unconditionally certified). $`\mathsf{seamUpperResetDyadicBandEscape\_through\_thirty}`$ verifies Definition <a href="#defn:band-escape" data-reference-type="ref" data-reference="defn:band-escape">263</a> by kernel computation of $`\mathrm{rem}(s)`$ for every row $`13\le s\le31`$ — e.g. row 14 gives $`\mathrm{rem}(14)=392`$, row 31 gives $`\mathrm{rem}(31)=4187487147`$ — with **zero** rows failing the band-avoidance test. . <span class="sans-serif">\[Cert\]</span><span class="sans-serif">scale:bounded</span>
...
```
are linearly independent over $`\mathbb{Q}`$. After deleting the rational $`n=1`$ term, squarefree support is therefore irrational at every base $`2^j`$. Among the integer bases, the cited theorem leaves the non-powers of two uncovered. This is cited mathematics, not formalised here. Proposition <a href="#prop:squarefree" data-reference-type="ref" data-reference="prop:squarefree">270</a> is a failure of two proof schemas on a value already known to be irrational.
...
<span class="sans-serif">\[Math, adversarially verified\]</span> (Survivor 7, composition-survivor pass). <span class="sans-serif">scale:cofinal</span>. <span class="sans-serif">coord:mobius-mersenne, greedy orbit</span>. This closes off what the source bank advertised as "the shortest known path" to a disproof (): there is no shortcut through it, because it is not shorter.
...
\end{align}
```
$`(\ast)`$ is proved unconditionally, uniform in $`c`$, no case split (, <span class="sans-serif">\[Lean\]</span>, <span class="sans-serif">scale:uniform</span>). $`(\ast\ast)`$ is exactly one bit sharper and, via (an unconditional iff), is *equivalent* to an exact row already crossing the integer half-target at $`c`$. The true unproved gap between $`(\ast)`$ and $`(\ast\ast)`$ is additive, not multiplicative: the proof of $`(\ast)`$ derives $`\mathtt{localBinarySuffix}<2^{c-2}+|D|`$ and discards $`|D|\le c-2`$; so what is actually open is the linear-width anti-concentration
``` math
