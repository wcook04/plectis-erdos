...
For Proposition <a href="#res:sparserationalisation" data-reference-type="ref" data-reference="res:sparserationalisation">1</a>, the pair identities, congruence buffer and abstract variable-alphabet filling are checked in `SparseRationalisationCore.lean`. The explicit three-coordinate schedule, upper Banach density, and block-law transfer are ordinary proofs, given in that proposition and in the companion record, subsection “Paired corrections and cumulative congruences”; they are not Lean- or Comparator-verified. End-to-end sparse candidate sources in the repository are labelled UNRUN and are not presented as checked theorems.
