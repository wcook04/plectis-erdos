...
Lean checks the factorial argument as [unboundedness of the actual gaps](https://github.com/wcook04/plectis-lean-erdos249-257/blob/3506d189a2660213ec0e53ee29360a464007b8a1/ErdosProblems/Erdos251/PrimeGapDyadicTail.lean#L57) and the conclusion as [non-eventual periodicity](https://github.com/wcook04/plectis-lean-erdos249-257/blob/3506d189a2660213ec0e53ee29360a464007b8a1/ErdosProblems/Erdos251/PrimeGapDyadicTail.lean#L1023). Combining nonperiodicity with eventual strict smallness of one positive shift would also exclude eventual integrality, but eventual smallness at every sufficiently large index is stronger than the cofinal adjacent-pair hypothesis in Theorem <a href="#res:smallpair" data-reference-type="ref" data-reference="res:smallpair">16</a> and is not asserted here.
...
**Reader position.** 12 of 71; display band: major result. Formal editorial disposition: merge. These are separate classifications.
...
**Result-atom population.** 10 of 682 public coordinates. The public atom catalog groups them under this family.
...
**Reader position.** 28 of 71; display band: mechanism. Formal editorial disposition: merge. These are separate classifications.
...
**Reader position.** 46 of 71; display band: frontier. Formal editorial disposition: hold. These are separate classifications.
...
**Reader position.** 52 of 71; display band: frontier. Formal editorial disposition: hold. These are separate classifications.

**Reader entry.** Unboundedness, irregularity, and free carry identities do not by themselves control the fractional tail needed for irrationality.
...
**Reader position.** 61 of 71; display band: technical support. Formal editorial disposition: merge. These are separate classifications.
