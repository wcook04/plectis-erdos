...
For every finite set $`P`$ of at least two primes, the sum of the reciprocals of the distinct running least common multiples of the $`P`$-smooth integers is irrational, as Erdős asserted in a 1973 letter that gives no proof. For two primes this follows from a Hecke–Mahler transcendence theorem; the new case is three or more primes. A rational value makes the tails of the sum, scaled by the running value, integers of one denominator, so the tails after a prime power $`t`$ and after $`tp^n`$ are equal for a good return $`n`$. Their words of primes differ by rearranging short runs, and equality forces an integer invariant to agree on every run. A point of the closed subtorus generated by the logarithmic flow that lies on exactly two coordinate walls, found by an Euler characteristic count, produces a run of two primes on which it differs. The proof is ordinary, refereed by a second reader, and has no Lean proof. For $`\{2,3,5\}`$ a separate proof, by five affine maps with disjoint images on dyadic blocks, is checked in Lean. A finite-state criterion of the same form, checked by exact computation, proves irrationality for every set of three primes at most $`31`$ and for $`292`$ of the $`330`$ sets of four primes at most $`31`$; it fails at every depth for $`\{2,3,5,7\}`$, where two different words of blocks have the same affine map. The same comparison of two tails proves that the sub-sum of the catalogue series over the powers of one prime is irrational. The reciprocal three-prime running-LCM kernel has nonsingular minors of every order: row and column rescaling leaves a two-valued matrix, and density supplies the required threshold pattern. For the rescaled matrix, we compute the rank of every finite restriction and the least uniform approximation error over all matrices of finite separated rank. For the repeated $`\{2,3,5\}`$ sum, we derive an integer-coefficient tail recurrence, determine exactly when a hypothetical rational denominator would clear, and prove a residue criterion equivalent to irrationality. The unproved step is to find such windows for every positive multiplier coprime to $`30`$ and after every prescribed start; the tails grow quadratically, and the finite-state argument has no counterpart there. We also give the full two-prime comparison, following Fan’s earlier Hecke–Mahler reduction, and identify the boundary terms that survive a proposed finite-difference cancellation.
...
```
is irrational, where $`[a_1,\ldots,a_n]`$ is the least common multiple \[erdosgraham1980, p. 65\]\[erdos1988, p. 106\]. The problem number is that of Bloom’s catalogue \[erdosproblems\].

Write $`\mathcal R_P`$ for the sum above and $`\mathcal D_P`$ for the sum in which each distinct running-LCM value contributes its reciprocal once. These differ because the running value can repeat. In a letter of 1 January 1973, Erdős called the irrationality of $`\mathcal R_P`$ a conjecture and wrote that he could show $`\mathcal D_P`$ to be irrational, without giving an argument \[erdos1974letter, p. 335\].
...
Ordinary proof in Section <a href="#long269:sec:distinct-all" data-reference-type="ref" data-reference="long269:sec:distinct-all">4.1</a>. It was found within this project on 26 September 2026 and independently refereed by a second reader, whose five small corrections are incorporated. It has no Lean proof, so Comparator does not apply. Theorem <a href="#long269:res:distinct-height-235" data-reference-type="ref" data-reference="long269:res:distinct-height-235">2</a> is its Lean-checked case.

For two primes the theorem follows from Theorem <a href="#long269:res:lead-two-prime" data-reference-type="ref" data-reference="long269:res:lead-two-prime">3</a> below, whose transcendence input is due to Loxton and van der Poorten and to Bugeaud and Laurent. The new case is $`|P|\ge3`$.
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-lead-two-prime">Lean†</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperCompleteR20/RealCutoffs.lean#L49">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-lcm-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-cell">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-cell-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperR7BasicAssembly.lean#L69">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-count-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/ThreePrimeRunningLcm.lean#L407">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-fibre-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperCompleteR20/RealBaseShortInterval.lean#L10">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-short-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperCompleteR20/RealCutoffs.lean#L285">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-drop-comparator">Comparator</a></p>
...
This section proves Theorems <a href="#long269:res:distinct-height-all" data-reference-type="ref" data-reference="long269:res:distinct-height-all">1</a> and <a href="#long269:res:distinct-height-235" data-reference-type="ref" data-reference="long269:res:distinct-height-235">2</a>, turns the dyadic argument into a criterion for every finite set of primes, and records the exact computations that apply the criterion to sets of three and four primes. The arguments prove irrationality only; they give no transcendence statement of the kind obtained for two primes in Section <a href="#long269:sec:two-prime" data-reference-type="ref" data-reference="long269:sec:two-prime">3</a>.
...
*Proof.* Let $`U_i`$ and $`U'_i`$ be the values of the suffixes starting at block $`i`$. Since $`\Pi(\sigma_i)=\Pi(\sigma'_i)`$, <a href="#long269:eq:word-shift" data-reference-type="eqref" data-reference="long269:eq:word-shift">[long269:eq:word-shift]</a> gives $`\Pi(\sigma_i)(U_i-U'_i)=f(\sigma_i)-f(\sigma'_i)+U_{i+1}-U'_{i+1}`$. If $`U_i=U'_i`$, the integer $`f(\sigma_i)-f(\sigma'_i)`$ equals $`U'_{i+1}-U_{i+1}\in(-1,1)`$, so both vanish. Induction from $`U_1=V(u)=V(u')`$ proves (i). For (ii), $`V(u)-V(u')=(U_{i_0}-U'_{i_0})/\Pi(\sigma_1\cdots\sigma_{i_0-1})`$. ◻
...
*Proof of Theorem <a href="#long269:res:distinct-height-all" data-reference-type="ref" data-reference="long269:res:distinct-height-all">1</a>.* Suppose $`\mathcal D_P=N/K`$. Fix $`p\in P`$ and an index $`k`$ with $`q_k=p`$. If $`|P|\ge4`$, fix $`a`$, $`b`$ and $`x`$ as in Lemma <a href="#long269:res:dp-two-walls" data-reference-type="ref" data-reference="long269:res:dp-two-walls">13</a>, and put $`\eta=\min(1/10,\ \min_{c\ne a,b}\operatorname{dist}(\theta_c(x),0))>0`$, distances being taken in $`\mathbb{R}/(\log c)\mathbb{Z}`$. Let $`\beta=\min_{q\ne p}\operatorname{dist}(\theta_{k,q},0)`$, which is positive because $`t_k`$ is a power of $`p`$. Choose $`T>0`$ such that $`2^\nu\ge K`$, where $`\nu`$ is the number of crossings of $`\theta_k`$ in $`(0,T]`$, and let $`g>0`$ be the least distance between two crossings of $`\theta_k`$ in $`[0,T+1]`$.
...
<a id="the-referees-corrections."></a>

#### The referee’s corrections.

The first write-up of this proof was checked step by step by a second reader, who found it correct and closed five small gaps, all incorporated above. The set $`U`$ must be defined by open conditions, including the strict inequality on $`\tau_a-\tau_b`$, since a prescribed value of that difference is a closed condition. The order of choices must be explicit: first $`a`$, $`b`$, $`x`$ and $`\eta`$, then $`k`$, $`T`$ and $`g`$, then $`n`$, which fixes $`\varepsilon`$ and $`D`$, then $`y`$, $`z`$ and $`U`$, and finally $`t^*`$. The faces of the arrangement in Lemma <a href="#long269:res:dp-two-walls" data-reference-type="ref" data-reference="long269:res:dp-two-walls">13</a> need the covering argument to be convex. For $`|P|\le3`$ the existence of a genuinely rearranged chain needs the density argument, and the $`i`$th $`q`$-crossing of $`\theta_k`$ corresponds to the $`i`$th $`q`$-crossing of $`\theta_m`$. And the form $`\theta_b-\theta_a`$ vanishes on the flow direction; it is nonzero on $`L`$ because $`L`$ is larger than the flow line.

<a id="why-the-two-walls-are-needed."></a>

#### Why the two walls are needed.

A shorter route would take, at a return of the orbit near the origin of $`T_0`$, the chain of crossings there. It fails when $`\dim T_0=2`$, which happens exactly when the numbers $`1/\log q`$ span a two-dimensional space over $`\mathbb{Q}`$; nothing known excludes this, and Baker’s theorem concerns linear forms in logarithms and says nothing about their reciprocals. In that case every small vector of $`L`$, in the coordinates $`\theta_q`$, has the form $`\alpha(1,\ldots,1)+\beta w`$ for one fixed $`w`$, so near the origin all the forms $`\theta_b-\theta_a`$ are proportional. The chain at such a return contains every prime of $`P`$, and the only rearrangement it can undergo is the full reversal. Full reversals can collide:
``` math
...
The blocks are the intervals $`(p^a,p^{a+1}]`$ for $`a\ge0`$. Put $`P_a=\operatorname{H}_P(p^a)`$ and
``` math
Y_a=P_a\sum_{t_k>p^a}\frac1{\operatorname{H}_P(t_k)} .
```
The *type* $`\tau_a`$ of block $`a`$ is the sequence $`(r_1,\ldots,r_v)`$ of the primes whose powers lie strictly inside the block, listed in increasing order of those powers; the empty sequence is written $`\varnothing`$.
...
Ordinary proof. Its case $`P=\{2,3,5\}`$ is checked in Lean as part of the proof of Theorem <a href="#long269:res:distinct-height-235" data-reference-type="ref" data-reference="long269:res:distinct-height-235">2</a>.
...
Take $`P=\{2,3,5\}`$. The possible types, written as words, are $`\varnothing`$, $`3`$, $`5`$, $`35`$ and $`53`$, and Lemma <a href="#long269:res:distinct-height-blocks" data-reference-type="ref" data-reference="long269:res:distinct-height-blocks">14</a>(ii) gives
``` math
\begin{array}{c|ccccc}
...
\end{array}
```
in increasing order, and consecutive intervals are separated by $`1/900`$, $`17/300`$, $`79/900`$ and $`1/180`$. Since $`Y_{a+1}\in I`$, the value $`Y_a`$ lies in $`G_{\tau_a}(I)`$ and in no other image. So $`Y_a`$ determines $`\tau_a`$, then $`Y_{a+1}=b_{\tau_a}Y_a-\mu_{\tau_a}`$, and by induction the whole word $`\tau_a\tau_{a+1}\cdots`$.

*Return.* Suppose $`\mathcal D_{\{2,3,5\}}=N/K`$ with integers $`N`$ and $`K\ge1`$. By Lemma <a href="#long269:res:distinct-height-blocks" data-reference-type="ref" data-reference="long269:res:distinct-height-blocks">14</a>(iii), every $`KY_a`$ is an integer in $`[3K/10,13K/15]`$. There are finitely many such integers, so $`Y_a=Y_{a'}`$ for some $`a<a'`$. Then $`\tau_{a+j}=\tau_{a'+j}`$ for every $`j\ge0`$, and the word $`(\tau_a)`$ is eventually periodic, with period $`\ell=a'-a`$.

*Contradiction.* Put $`\alpha=\log2/\log3`$, which is irrational. By Lemma <a href="#long269:res:distinct-height-blocks" data-reference-type="ref" data-reference="long269:res:distinct-height-blocks">14</a>(i), $`3^e`$ lies in block $`a`$ exactly when $`a\alpha<e<(a+1)\alpha`$, so block $`a`$ contains $`\lfloor(a+1)\alpha\rfloor-\lfloor a\alpha\rfloor`$ powers of $`3`$, a number recorded by $`\tau_a`$. Summing over one period, the number $`c=\lfloor(a+\ell)\alpha\rfloor-\lfloor a\alpha\rfloor`$ does not depend on $`a`$ once $`a`$ is large, hence $`\lfloor(a+n\ell)\alpha\rfloor=\lfloor
...
For $`\{2,3,5\}`$ a single interval contained every tail. For other sets the bound is allowed to depend on how recently each prime appeared. Put $`Q=P\smallsetminus\{p\}`$ and, for $`q\in Q`$, let $`g_q`$ be the integer with $`p^{g_q}<q<p^{g_q+1}`$. By Lemma <a href="#long269:res:distinct-height-blocks" data-reference-type="ref" data-reference="long269:res:distinct-height-blocks">14</a>(i), two consecutive blocks containing a power of $`q`$ have indices $`\lfloor f\log_pq\rfloor`$ and $`\lfloor(f+1)\log_pq\rfloor`$, which differ by $`g_q`$ or $`g_q+1`$.
...
Ordinary proof. Lean checks only the case $`P=\{2,3,5\}`$ with $`k=1`$ and the single interval used in Section <a href="#long269:sec:distinct-235" data-reference-type="ref" data-reference="long269:sec:distinct-235">4.3</a>.
...
Ordinary proof by Theorem <a href="#long269:res:distinct-height-criterion" data-reference-type="ref" data-reference="long269:res:distinct-height-criterion">15</a>, applied through an exact finite computation for each set; no Lean proof.
...
<a id="the-single-prime-sub-sums."></a>

#### The single-prime sub-sums.

The comparison of two tails does close on part of the catalogue series. For $`p\in P`$ put
``` math
...
Ordinary proof; no Lean proof. The `two_tail.py` program of the [distinct-height programs](https://github.com/wcook04/plectis-erdos/tree/10178c4df40cb27d83b5ebb1ec337dd588b82998/research/experiments/erdos269/distinct_height) also checks the identities in exact arithmetic on finite ranges.
...
Ordinary proof, given below. It was found within this project on 26 September 2026, in an attempt on $`\mathcal R_P`$, and independently refereed by a second reader, whose corrections are incorporated. It has no Lean proof, so Comparator does not apply. For $`|P|=2`$ the statement follows from a Hecke–Mahler transcendence theorem; the new case is $`|P|\ge3`$, for which we have not searched the literature.
...
*Proof.* For a word $`u`$ over $`P`$ put $`V_p(u)=\sum_{i:\,u_i=p}(u_1\cdots u_i)^{-1}`$, and for a finite word $`\sigma=\sigma_1\cdots\sigma_n`$ put $`f_p(\sigma)=\sum_{t:\,\sigma_t=p}\sigma_{t+1}\cdots\sigma_n`$. Then $`V_p(\sigma u)=(f_p(\sigma)+V_p(u))/\Pi(\sigma)`$. With $`y_k=V_p(q_{k+1}q_{k+2}\cdots)`$,
``` math
E_p=1+\sum_{k:\,q_k=p}\frac1{Q_k},\qquad
 Q_kE_p=Q_k+\sum_{j\le k,\ q_j=p}\frac{Q_k}{Q_j}+y_k .
```
In a suffix $`u`$ of $`q_1q_2\cdots`$ the $`j`$th letter $`p`$ sits at a prefix product at least $`p^j`$, strictly larger once a letter other than $`p`$ has occurred, so $`0<V_p(u)<1/(p-1)\le1`$. Hence, if $`E_p=N/K`$, every $`Ky_k`$ is an integer, and Lemma <a href="#long269:res:dp-blocks" data-reference-type="ref" data-reference="long269:res:dp-blocks">11</a> holds with $`V_p`$ and $`f_p`$ in place of $`V`$ and $`f`$, with the same proof. For a word of distinct primes in which $`p`$ occurs once, $`f_p`$ is the product of the letters after $`p`$; by unique factorisation, two orderings of one set of distinct primes containing $`p`$ have the same $`f_p`$ exactly when $`p`$ has the same followers in both.

Since $`\theta_p-\theta_q`$ is a nonzero linear form on $`L`$ for every $`q\ne p`$ (Section <a href="#long269:sec:distinct-all" data-reference-type="ref" data-reference="long269:sec:distinct-all">4.1</a>), there is $`v\in L`$ with $`|\theta_q(v)|\le1`$ for all $`q`$ and $`\theta_q(v)\ne\theta_p(v)`$ for all $`q\ne p`$. Write $`v_q=\theta_q(v)`$ and $`\mu=\min_{q\ne p}|v_p-v_q|>0`$.

Suppose $`E_p=N/K`$. Fix $`k`$ with $`q_k=p`$, define $`\beta`$, $`T`$, $`\nu`$ and $`g`$ as in the proof of Theorem <a href="#long269:res:distinct-height-all" data-reference-type="ref" data-reference="long269:res:distinct-height-all">1</a>, put $`\eta=1/10`$, and choose $`n`$ by Dirichlet’s theorem with $`\varepsilon=\max_q|\delta_q|<\min(\beta,g/2,\log2/(2|P|),\eta/4,\eta\mu/4)`$. Each $`\delta_q`$ with $`q\ne p`$ is nonzero. The steps *Chains* and *Equal tails* of that proof apply word for word, with $`y`$ in place of $`x`$: $`W(\theta_m)`$ is the concatenation of the chains of $`W(\theta_k)`$, each rearranged, $`y_k=y_m`$, and $`f_p(C)=f_p(C')`$ for every chain $`C`$ and its rearrangement $`C'`$.

Let $`b_0=\min_{q\ne p}|\delta_q|/|v_p-v_q|`$, so $`0<b_0\le\varepsilon/\mu<\eta/4`$. Let $`B=\{q\ne p:\delta_q<0\}`$, $`A_+=\{q\ne p:v_q<v_p\}`$ and $`A_-=\{q\ne p:v_q>v_p\}`$. The sets $`A_+`$ and $`A_-`$ partition the nonempty set $`P\smallsetminus\{p\}`$, so they differ, and one of them, $`A_s`$, differs from $`B`$. Put $`b=sb_0/2`$ and let $`z`$ be the point $`bv+\Theta(-\eta/2)`$ of $`T_0`$. Its $`q`$-crossings are the times $`\eta/2-bv_q+j\log q`$; put $`\tau_q=\eta/2-bv_q\in(3\eta/8,5\eta/8)`$, and note that the other $`q`$-crossings lie outside $`(-\eta/4,5\eta/4)`$. Moreover $`\tau_q-\tau_p=b(v_p-v_q)`$ is nonzero, has the sign of $`s(v_p-v_q)`$, and has absolute value at most $`|\delta_q|/2`$. Let $`U`$ be the set of $`\theta\in T_0`$ with no crossing in $`[-\eta/4,\eta/4]\cup[3\eta/4,5\eta/4]`$, a $`q`$-crossing $`\tau_q(\theta)`$ in $`(\eta/4,3\eta/4)`$ for every $`q\in P`$, and, for every $`q\ne p`$, $`\tau_q(\theta)-\tau_p(\theta)`$ of the sign of $`b(v_p-v_q)`$ and of absolute value less than $`|\delta_q|`$. Each condition is open, so $`U`$ is an open subset of $`T_0`$ containing $`z`$, and $`\theta_k+\Theta(t^*)\in U`$ for some $`t^*>T+2`$.

The crossings of $`\theta_k`$ near $`t^*`$ are then one crossing of each prime, each within $`|\delta_q|<\varepsilon`$ of the $`p`$-crossing, and every other crossing is more than $`\eta/2>2\varepsilon`$ away. So they form one chain $`C`$, in which the followers of $`p`$ are the primes of $`A_s`$. In $`C'`$ the $`q`$-crossing moves by $`-\delta_q`$ and the $`p`$-crossing stays, so $`q`$ follows $`p`$ exactly when $`\tau_q-\tau_p>\delta_q`$, that is, exactly when $`\delta_q<0`$. The followers of $`p`$ in $`C'`$ form $`B\ne A_s`$, so $`f_p(C)\ne f_p(C')`$, a contradiction. ◻

</div>

The two-wall lemma is not needed here: $`f_p`$ detects every rearrangement that changes the followers of $`p`$, and a passage near the origin offers such a change for one sign of $`b`$. For $`|P|=1`$, $`E_p=p/(p-1)`$ is rational, and the proof breaks exactly there, since $`P\smallsetminus\{p\}`$ is empty. The referee’s corrections were small: the two follower sets at the origin are complementary but one of them can be empty, the open set $`U`$ must carry the order and size conditions on $`\tau_q-\tau_p`$, and a larger chain threshold proposed in the first write-up is unnecessary. For $`P=\{2,3,5\}`$, $`p=2`$, $`t_k=2^{20}`$ and $`n=65`$, the first rearranged chain is $`(2,3)`$ against $`(3,2)`$ after $`131`$ letters, with $`f_2`$ equal to $`3`$ and $`1`$, and the difference of the two tails, computed exactly to $`300`$ letters, has $`\log_{10}|y_k-y_m|=-58.098`$.
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperR7BasicAssembly.lean#L102">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-rank-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperR7BasicAssembly.lean#L22">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-infinite-rank-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperR7FiniteCutRank.lean#L182">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-finite-cut-rank-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperR8UniformRank.lean#L321">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-uniform-rank-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-dyadic-alphabet">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-dyadic-alphabet-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperCompleteR20/LiteralTriangleReal.lean#L193">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-literal-triangle-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperR7ActualOrbit.lean#L132">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-actual-dichotomy-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperCompleteR20/BoundedLatticeCollision.lean#L56">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-all-scale-lattice-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-actual-cancellation">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-actual-cancellation-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-exact-denominator">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-exact-denominator-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperCompleteR20/EightScaleRigidity.lean#L77">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-pinning-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/ActualSharpTailMajorantR10.lean#L339">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-jump-constrained-bound-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/ResidueEscape.lean#L110">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-consumer-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-residue-limit">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-residue-limit-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperR7WindowResults.lean#L196">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-window-growth-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperR7WindowResults.lean#L267">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-no-bounded-length-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-strip-decomposition">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-strip-decomposition-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperCompleteR20/FixedBaseRecoding.lean#L154">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-res-fixed-base-recoding-comparator">Comparator</a></p>
...
This subsection returns to the distinct-height sum of Section <a href="#long269:sec:distinct" data-reference-type="ref" data-reference="long269:sec:distinct">4</a>, in which each height is counted once, at the jump where it first appears:
``` math
\mathcal D_{\{2,3,5\}}=1+
...
```
The bases $`b_a`$ in <a href="#long269:eq:dyadic-alphabet" data-reference-type="eqref" data-reference="long269:eq:dyadic-alphabet">[long269:eq:dyadic-alphabet]</a> come from the same prime-power jumps. This sum counts each height once; the repeated sum counts it once for every smooth integer at that height. Theorem <a href="#long269:res:distinct-height-235" data-reference-type="ref" data-reference="long269:res:distinct-height-235">2</a> proves $`\mathcal D_{\{2,3,5\}}`$ irrational by an elementary argument that gives no information about transcendence. For two primes, Section <a href="#long269:sec:two-prime" data-reference-type="ref" data-reference="long269:sec:two-prime">3</a> deduces the transcendence of $`\mathcal D_{\{p,q\}}`$ from one Hecke–Mahler value. A comparable statement at three primes would need a representation of the following kind.
...
The distinct-height sum is irrational for every finite set of at least two primes (Theorem <a href="#long269:res:distinct-height-all" data-reference-type="ref" data-reference="long269:res:distinct-height-all">1</a>), by an ordinary refereed proof; its case $`\{2,3,5\}`$ is checked in Lean (Theorem <a href="#long269:res:distinct-height-235" data-reference-type="ref" data-reference="long269:res:distinct-height-235">2</a>). The finite-state criterion of Theorem <a href="#long269:res:distinct-height-criterion" data-reference-type="ref" data-reference="long269:res:distinct-height-criterion">15</a> gives an independent proof for the sets in Corollary <a href="#long269:res:distinct-height-sets" data-reference-type="ref" data-reference="long269:res:distinct-height-sets">16</a> and cannot decide $`\{2,3,5,7\}`$ at any depth. For the catalogue sum, the sub-sums $`E_p`$ over the powers of one prime are irrational (Theorem <a href="#long269:res:single-prime-subsums" data-reference-type="ref" data-reference="long269:res:single-prime-subsums">18</a>). For the repeated $`\{2,3,5\}`$ sum, the coefficients, recurrence, quadratic bounds and denominator clearing are derived here from the original multiplicities. What remains is to exclude eventual integral reduced tails, equivalently to prove residue escape for every admissible denominator and beyond every prescribed starting index. The fixed-start residue formula explains these quantifiers, and the strip decomposition shows why absence of floor crossings alone does not give the required cancellation.
...
The two-prime deduction rests on the cited external value theorem, which the Lean proof of Theorem <a href="#long269:res:lead-two-prime" data-reference-type="ref" data-reference="long269:res:lead-two-prime">3</a> assumes; Fan posted that deduction first, on the erdosproblems.com forum \[fan2026comment\]. Theorem <a href="#long269:res:distinct-height-all" data-reference-type="ref" data-reference="long269:res:distinct-height-all">1</a> and Lemmas <a href="#long269:res:dp-integral-tails" data-reference-type="ref" data-reference="long269:res:dp-integral-tails">10</a>–<a href="#long269:res:dp-two-walls" data-reference-type="ref" data-reference="long269:res:dp-two-walls">13</a> have the ordinary proofs of Section <a href="#long269:sec:distinct-all" data-reference-type="ref" data-reference="long269:sec:distinct-all">4.1</a> and no Lean proofs; a formal proof would need Kronecker’s theorem on the closure of a line in a torus and the Euler characteristic count of Lemma <a href="#long269:res:dp-two-walls" data-reference-type="ref" data-reference="long269:res:dp-two-walls">13</a>. The proof of Theorem <a href="#long269:res:distinct-height-all" data-reference-type="ref" data-reference="long269:res:distinct-height-all">1</a> was found by an AI agent on 26 September 2026 and refereed by a second AI agent working independently, who re-derived every step and closed the five gaps listed there; it has had no human review. Theorem <a href="#long269:res:single-prime-subsums" data-reference-type="ref" data-reference="long269:res:single-prime-subsums">18</a> and Proposition <a href="#long269:res:single-prime-identities" data-reference-type="ref" data-reference="long269:res:single-prime-identities">17</a> have the ordinary proofs of Section <a href="#long269:sec:distinct-stop" data-reference-type="ref" data-reference="long269:sec:distinct-stop">4.6</a> and no Lean proofs; the theorem was refereed in the same way. Theorem <a href="#long269:res:distinct-height-235" data-reference-type="ref" data-reference="long269:res:distinct-height-235">2</a> is checked in Lean, as the remark below it states; Comparator has not yet compared it. Lemma <a href="#long269:res:distinct-height-blocks" data-reference-type="ref" data-reference="long269:res:distinct-height-blocks">14</a>, Theorem <a href="#long269:res:distinct-height-criterion" data-reference-type="ref" data-reference="long269:res:distinct-height-criterion">15</a> and Corollary <a href="#long269:res:distinct-height-sets" data-reference-type="ref" data-reference="long269:res:distinct-height-sets">16</a> have the ordinary proofs given in Section <a href="#long269:sec:distinct" data-reference-type="ref" data-reference="long269:sec:distinct">4</a>, the corollary together with an exact finite computation, and no Lean proofs. Every other theorem, proposition, lemma and corollary has a Lean proof of its whole statement, marked in the margin; Section <a href="#long269:sec:coverage" data-reference-type="ref" data-reference="long269:sec:coverage">[long269:sec:coverage]</a> states what the Lean proof of the two-prime theorem checks.
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/PaperCompleteR20/RealBoundDenominatorReduction.lean#L25">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-long-denominator-reduction-comparator">Comparator</a></p>
...
<p class="evidence-marks"><a href="https://github.com/wcook04/plectis-erdos/blob/4d41eaab40de87460b9049d84455ef18660b858e/lean/ErdosProblems/Erdos269/RestrictedFloorSum.lean#L645">Lean</a> · <a href="https://github.com/wcook04/plectis-erdos/blob/8f70dde4dd94fe468fbd995f5402c7e41685f1c7/evidence/erdos269-running-lcm-reasoning-surface.md#long269-long-windowconsumer-comparator">Comparator</a></p>
...
The values of the running least common multiple at the first ten integer cutoffs are tabulated in Section <a href="#long269:sec:lcm" data-reference-type="ref" data-reference="long269:sec:lcm">2</a>. They illustrate both parts of Proposition <a href="#long269:res:cell" data-reference-type="ref" data-reference="long269:res:cell">5</a>: the value is constant on $`\{5,6,7\}`$ and on $`\{9,10\}`$, and each change multiplies by a single prime, by $`2`$ at $`x=2,4,8`$, by $`3`$ at $`x=3,9`$ and by $`5`$ at $`x=5`$. Also $`\operatorname{L}(10)=8\cdot9\cdot5=360`$ is the least common multiple of the smooth numbers $`1,2,3,4,5,6,8,9,10`$.
...
| Distinct-height sums, every $`P`$ | Integrality of the scaled tails, rearranged chains at a return of the logarithmic flow, Kronecker’s theorem and an Euler characteristic count on a two-dimensional subtorus. Ordinary proof, refereed; no Lean proof. It stops for the repeated sums because their scaled tails are unbounded. |
| Single-prime sub-sums | The same two-tail comparison with the carry $`f_p`$ and a chain chosen near the origin of the torus; no two-wall lemma. Ordinary proof, refereed; no Lean proof. Says nothing about the whole repeated sum. |
...
Every theorem, lemma, proposition and corollary of this record has a Lean proof, except Theorem <a href="#long269:res:distinct-height-all" data-reference-type="ref" data-reference="long269:res:distinct-height-all">1</a>, Lemmas <a href="#long269:res:dp-integral-tails" data-reference-type="ref" data-reference="long269:res:dp-integral-tails">10</a>–<a href="#long269:res:dp-two-walls" data-reference-type="ref" data-reference="long269:res:dp-two-walls">13</a>, Theorem <a href="#long269:res:single-prime-subsums" data-reference-type="ref" data-reference="long269:res:single-prime-subsums">18</a>, Proposition <a href="#long269:res:single-prime-identities" data-reference-type="ref" data-reference="long269:res:single-prime-identities">17</a>, Lemma <a href="#long269:res:distinct-height-blocks" data-reference-type="ref" data-reference="long269:res:distinct-height-blocks">14</a>, Theorem <a href="#long269:res:distinct-height-criterion" data-reference-type="ref" data-reference="long269:res:distinct-height-criterion">15</a> and Corollary <a href="#long269:res:distinct-height-sets" data-reference-type="ref" data-reference="long269:res:distinct-height-sets">16</a>, whose proofs are ordinary proofs and, for the corollary, exact computations. Only the Lean proof of Theorem <a href="#long269:res:lead-two-prime" data-reference-type="ref" data-reference="long269:res:lead-two-prime">3</a> assumes an input. It verifies the reduction of that theorem to the transcendence of the Hecke–Mahler boundary sum at an irrational $`\theta\in(0,1)`$ and nonzero algebraic $`\beta,\alpha`$ with $`|\beta|<1`$ and $`|\beta||\alpha|^\theta<1`$, which is Theorem 1.1 of Bugeaud and Laurent \[bugeaudlaurent2023\] in the case $`\rho=0`$, due to Loxton and van der Poorten \[loxtonvdp1977, Theorem 8, p. 40\]. Lean does not prove that input; the Lean theorem assumes it. Everything the proof adds is checked: the running least-common-multiple identity, the selection of the single power of $`q`$ between consecutive powers of $`p`$, the factorisation of the repeated sum, the identification of the distinct running values, the telescoping identity, the boundary identity <a href="#long269:eq:hecke-mahler-boundary" data-reference-type="eqref" data-reference="long269:eq:hecke-mahler-boundary">[long269:eq:hecke-mahler-boundary]</a> expressing $`A`$ through the Hecke–Mahler sum, the irrationality of $`\log p/\log q`$, and each side condition verified before the value theorem is applied. The two identities expressing $`\mathcal D_{\{p,q\}}`$ and $`\mathcal R_{\{p,q\}}`$ as polynomials in $`A`$ are unconditional and carry no additional input.
