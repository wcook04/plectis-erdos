...
\large What public evidence can and cannot show about a private system}
\author{Will Cook}
\date{July 2026}
...
\cite[secs. 1.1, 4, 7.3, 11.9--11.15]{omgsacm2023}. Plectis is not an
implementation of that standard and makes no claim that the private system is
safe. Its validator applies a published rule and records a result; it neither
models nor independently justifies the evidential link from that result to the
prose claim.
