...
private theorem periodLcm_eq_source :
    ∀ t : ℕ, periodLcm t =
      Erdos249257.TotientTailPeriodKiller.periodLcm t
  | 0 => rfl
  | t + 1 => by
      simp only [periodLcm,
        Erdos249257.TotientTailPeriodKiller.periodLcm]
...
theorem actualLcmTailOrbit_eq_scaled_totientSeries_sub_prefix (a : ℕ) :
  ...
  simpa [actualLcmTailOrbit, actualLcmHeight, totientTail, totientPrefix,
    ...
    Erdos249257.TotientTailPeriodKiller.totientPrefix,
    periodLcm_eq_source] using
    Erdos249257.DiagonalFreshLossBridge.PowerTwoOddWindowAffine.actualLcmTailOrbit_eq_scaled_totientSeries_sub_prefix a
...
theorem irrational_totientSeries_iff_actualLcmOrbitNonintegralitySupply :
  ...
  simpa [PowerTwoActualLcmOrbitNonintegralitySupply,
    ...
    Erdos249257.DiagonalFreshLossBridge.PowerTwoOddWindowAffine.PowerTwoActualLcmOrbitNonintegralitySupply,
    Erdos249257.DiagonalFreshLossBridge.PowerTwoOddWindowAffine.actualLcmTailOrbit,
    Erdos249257.DiagonalFreshLossBridge.PowerTwoOddWindowAffine.actualLcmHeight,
    Erdos249257.TotientTailPeriodKiller.totientTail,
    periodLcm_eq_source] using
