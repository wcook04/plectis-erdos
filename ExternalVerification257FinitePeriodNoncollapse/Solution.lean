...
theorem finite_period_noncollapse_rat_den
  ...
  have hcop : Nat.Coprime b (finiteErdosSum F b).den := by
    simpa [finiteErdosSum,
      Erdos249257.finiteErdosSum] using
      Erdos249257.coprime_base_den_finiteErdosSum
        F b h0 hb
  refine ⟨hcop, ?_⟩
  simpa [finiteErdosSum,
      Erdos249257.finiteErdosSum] using
      Erdos249257.finite_period_noncollapse_rat_den
        F b hF h0 hb
...
theorem lcm_lt_den_finiteErdosSum
  ...
  simpa [finiteErdosSum,
      Erdos249257.finiteErdosSum] using
      Erdos249257.lcm_lt_den_finiteErdosSum
        F b hF h0 hb h2
