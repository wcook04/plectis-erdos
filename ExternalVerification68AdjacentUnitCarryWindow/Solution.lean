...
private theorem predecessorGap_eq_source (m : ℕ) :
    predecessorGap m = ErdosProblems.Erdos68.factorialGapPredecessorGap m := by
  rw [← ErdosProblems.Erdos68.factorialGapPredecessorGapRat_cast]
  norm_num [predecessorGap, ErdosProblems.Erdos68.factorialGapPredecessorGapRat,
    strictFacTopRat, factorialGapPrefix, ErdosProblems.Erdos68.strictFacTopRat,
    ErdosProblems.Erdos68.factorialGapPrefix]

private theorem stepCarry_eq_source (m : ℕ) :
    stepCarry m = ErdosProblems.Erdos68.factorialGapStepCarry m := by
  simp only [stepCarry, ErdosProblems.Erdos68.factorialGapStepCarry,
    predecessorGap_eq_source]

macro "source_simpa" t:term : tactic =>
  `(tactic| simpa [strictFacTopRat, factorialGapPrefix, predecessorScaled,
      predecessorNumerator, transitionNormalizer, windowDen, windowLower,
      windowState, windowOffset, stepCarry_eq_source,
      ErdosProblems.Erdos68.strictFacTopRat,
      ErdosProblems.Erdos68.factorialGapPrefix,
      ErdosProblems.Erdos68.factorialGapPredecessorScaledRat,
      ErdosProblems.Erdos68.factorialGapPredecessorGapNumerator,
      ErdosProblems.Erdos68.factorialGapPredecessorTransitionNormalizer,
      ErdosProblems.Erdos68.adjacentUnitCarryWindowDen,
      ErdosProblems.Erdos68.adjacentUnitCarryWindowLowerNum,
      ErdosProblems.Erdos68.adjacentUnitCarryWindowStateNum,
      ErdosProblems.Erdos68.adjacentUnitCarryWindowOffset] using $t)
